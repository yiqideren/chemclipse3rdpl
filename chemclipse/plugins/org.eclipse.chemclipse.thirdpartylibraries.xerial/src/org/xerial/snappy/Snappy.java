...
public class Snappy {
	 ...
	 * cost, use {@link #compress(byte[], int, int, byte[], int)} or {@link #compress(ByteBuffer, ByteBuffer)}.
	 * 
	 * @param input
	 *            the input data
	 ...
	 * written in C++. To avoid this type of crash, use {@link #isValidCompressedBuffer(byte[], int, int)} first.
	 * 
	 * @param input
	 *            input byte array
	 * @param inputOffset
	 ...
	 * @throws IOException
	 *             when failed to uncompress the given input. The error code is {@link SnappyErrorCode#PARSING_ERROR}
	 */
