 ...
 * 
 * Usage
 * First, import {@link org.xerial.snappy.Snappy} in your Java code: <code>
 * <pre>
 * import org.xerial.snappy.Snappy;
 * </pre>
 * </code> Then use {@link org.xerial.snappy.Snappy#compress(byte[])} and {@link org.xerial.snappy.Snappy#uncompress(byte[])}: <code>
 * <pre>
 ...
 * </p>
 * 
 * <h3>Stream-based API</h3> Stream-based compressor/decompressor SnappyOutputStream, SnappyInputStream are also available for reading/writing large data sets.
 */
