 ...
 * <ol>
 * <li>If system property <i>org.xerial.snappy.use.systemlib</i> is set to true, lookup folders specified by <i>java.lib.path</i> system property (This is the default path that JVM searches for native libraries)
 * <li>(System property: <i>org.xerial.snappy.lib.path</i>)/(System property: <i>org.xerial.lib.name</i>)
 * <li>One of the libraries embedded in snappy-java-(version).jar extracted into (System property: <i>java.io.tempdir</i>). If <i>org.xerial.snappy.tempdir</i> is set, use this folder instead of <i>java.io.tempdir</i>.
 * </ol>
 * 
 * <p>
 * If you do not want to use folder <i>java.io.tempdir</i>, set the System property <i>org.xerial.snappy.tempdir</i>. For example, to use <i>/tmp/leo</i> as a temporary folder to copy native libraries, use -D option of JVM:
 * 
 * <pre>
 * <code>
...
public class SnappyLoader {
	...
	/**
	 * load system properties when configuration file of the name {@link #SNAPPY_SYSTEM_PROPERTIES_FILE} is found
	 */
	private static void loadSnappySystemProperties() {
		...
		try {
			...
			System.err.println("Could not load '" + SNAPPY_SYSTEM_PROPERTIES_FILE + "' from classpath: " + ex.toString());
		}
	}
