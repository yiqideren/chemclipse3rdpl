...
/**
 * Centralized place to create new instances of operations and functions. Must call {@link #setManagerTemp} before any other functions.
 *
 * @author Peter Abeles
 */
public class ManagerFunctions {
	 ...
	 *            Which operation
	 * @param left
	 *            Input variable on left
	 * @param right
	 *            Input variable on right
	 * @return Resulting operation
	 */
