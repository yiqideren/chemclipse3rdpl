...
class TokenList {
	 ...
	 * 
	 * @param where
	 *            Where 'token' should be inserted after. if null the put at it at the beginning
	 * @param token
	 *            The token that is to be inserted
	 */
