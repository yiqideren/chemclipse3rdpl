...
public class NormOps {
	...
	/**
	 * <p>
	 * The condition number of a matrix is used to measure the sensitivity of the linear system <b>Ax=b</b>. A value near one indicates that it is a well conditioned matrix.<br>
	 * <br>
	...
	/**
	 * <p>
	 * The condition p = 2 number of a matrix is used to measure the sensitivity of the linear system <b>Ax=b</b>. A value near one indicates that it is a well conditioned matrix.<br>
	 * <br>
	 ...
	 *
	 * @param A
	 *            Vector or matrix whose norm is to be computed.
	 * @param p
	 *            The p value of the p-norm.
