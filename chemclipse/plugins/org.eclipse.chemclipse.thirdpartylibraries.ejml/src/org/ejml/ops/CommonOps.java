...
public class CommonOps {
	 ...
	 *
	 * @param a
	 *            The matrix being multiplied. Not modified.
	 * @param c
	 *            Where the results of the operation are stored. Modified.
	 */
	...
	/**
	 * <p>
	 * Computes the matrix multiplication outer product:<br>
	 * <br>
	 * c = a * a<sup>T</sup> <br>
	 * <br>
	 ...
	 * @param invA
	 *            Where the computed pseudo inverse is stored. n by m. Modified.
	 * @return
	 */
	...
	/**
	 * <p>
	 * Creates a new square matrix whose diagonal elements are specified by diagEl and all the other elements are zero.<br>
	 * <br>
	...
	/**
	 * <p>
	 * Creates a new rectangular matrix whose diagonal elements are specified by diagEl and all the other elements are zero.<br>
	 * <br>
	 * a<sub>ij</sub> = 0 if i &le; j<br>
	 * a<sub>ij</sub> = diag[i] if i = j<br>
	 * </p>
	 ...
	 * where C<sub>ij</sub> is a sub matrix inside of C &isin; &real; <sup>m*k &times; n*l</sup>, A &isin; &real; <sup>m &times; n</sup>, and B &isin; &real; <sup>k &times; l</sup>.
	 * </p>
	 *
	 * @param A
	 *            The left matrix in the operation. Not modified.
	 * @param B
	 *            The right matrix in the operation. Not modified.
	 * @param C
	 *            Where the results of the operation are stored. Modified.
	 ...
	 *
	 * @param src
	 *            Matrix whose diagonal elements are being extracted. Not modified.
	 * @param dst
	 ...
	 *            Input matrix
	 * @param row
	 *            Which row is to be extracted
	 * @param out
	 *            output. Storage for the extracted row. If null then a new vector will be returned.
	 ...
	 *            Input matrix
	 * @param column
	 *            Which column is to be extracted
	 * @param out
	 ...
	 *
	 * @param src
	 *            matrix that is being copied into dest. Not modified.
	 * @param dest
	 *            Where src is being copied into. Modified.
	 * @param destY0
	 *            Start row for the copy into dest.
	 * @param destX0
	 *            Start column for the copy into dest.
	 */
	 ...
	 * 
	 * @param a
	 *            The left matrix in the multiplication operation. Modified.
	 * @param b
	 *            The right matrix in the multiplication operation. Not modified.
	 */
	 ...
	 * 
	 * @param a
	 *            The left matrix in the division operation. Modified.
	 * @param b
	 *            The right matrix in the division operation. Not modified.
	 */
	 ...
	 * 
	 * @param a
	 *            The left matrix in the division operation. Not modified.
	 * @param b
	 *            The right matrix in the division operation. Not modified.
	 * @param c
	 *            Where the results of the operation are stored. Modified.
	 ...
	 *
	 * @param input
	 *            INput matrix whose rows are summed.
	 * @param output
	 *            Optional storage for output. Must be a vector. If null a row vector is returned. Modified.
	 ...
	 *            INput matrix whose rows are summed.
	 * @param output
	 *            Optional storage for output. Must be a vector. If null a column vector is returned. Modified.
	 * @return Vector containing the sum of each row in the input.
	 */
	 ...
	 *
	 * @param beta
	 *            The number that matrix 'b' is multiplied by.
	 * @param a
	 *            A Matrix. Modified.
	 * @param b
	 *            A Matrix. Not modified.
	 ...
	 *
	 * @param alpha
	 *            A scaling factor for matrix a.
	 * @param a
	 *            A Matrix. Not modified.
	 * @param beta
	 *            A scaling factor for matrix b.
	 * @param b
	 *            A Matrix. Not modified.
	 * @param c
	 *            A Matrix where the results are stored. Modified.
	 ...
	 *
	 * @param a
	 *            (input) A matrix. Not modified.
	 * @param val
	 *            (input) The value that's subtracted to each element.
	 * @param c
	 *            (Output) A matrix. Modified.
	 */
	 ...
	 *
	 * @param a
	 *            The matrix that is to be scaled. Modified.
	 * @param alpha
	 *            the amount each element is multiplied by.
	 */
	 ...
	 *            the amount each element is multiplied by.
	 * @param a
	 *            The matrix that is to be scaled. Not modified.
	 * @param b
	 *            Where the scaled matrix is stored. Modified.
	 */
	 ...
	 *
	 * @param a
	 *            The matrix whose elements are divide the scalar. Modified.
	 * @param alpha
	 *            top value in division
	 */
	 ...
	 *
	 * @param a
	 *            The matrix whose elements are to be divided. Modified.
	 * @param alpha
	 *            the amount each element is divided by.
	 */
	 ...
	 *            The numerator.
	 * @param a
	 *            The matrix whose elements are the divisor. Not modified.
	 * @param b
	 ...
	 *
	 * @param a
	 *            The matrix whose elements are to be divided. Not modified.
	 * @param alpha
	 *            the amount each element is divided by.
	 * @param b
	 *            Where the results are stored. Modified.
	 ...
	 * @param reduced
	 *            Storage for reduced echelon matrix. If null then a new matrix is returned. Modified.
