...
public class SingularOps {
	 ...
	 *            Matrix. Modified.
	 * @param tranU
	 *            is U transposed or not.
	 * @param W
	 *            Diagonal matrix with singular values. Modified.
	 * @param V
	 *            Matrix. Modified.
	 * @param tranV
	 *            is V transposed or not.
	 */
	 ...
	 *            Array of singular values. Modified.
	 * @param numSingularValues
	 *            Number of elements in singularValues array
	 * @param V
	 *            Matrix. Modified.
	 * @param tranV
	 *            is V transposed or not.
	 ...
	 *
	 * @param svd
	 *            A precomputed decomposition. Not modified.
	 * @param nullSpace
	 *            Storage for null space. Will be reshaped as needed. Modified.
	 * @param tol
	 *            Threshold for selecting singular values. Try UtilEjml.EPS.
	 ...
	 *            A precomputed decomposition. Not modified.
	 * @param isRight
	 *            true for right null space and false for left null space. Right is more commonly used.
	 * @param nullVector
	 *            Optional storage for a vector for the null space. Modified.
	...
	/**
	 * Returns a reasonable threshold for singular values.<br>
	 * <br>
	 *
	 ...
	 *            A precomputed decomposition. Not modified.
	 * @param threshold
	 *            Tolerance used to determine of a singular value is singular.
	 * @return The rank of the decomposed matrix.
	 */
