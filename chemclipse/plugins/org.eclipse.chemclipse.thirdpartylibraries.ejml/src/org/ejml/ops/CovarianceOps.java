...
public class CovarianceOps {
	 ...
	 *
	 * @param cov
	 *            On input it is a covariance matrix, on output it is the inverse. Modified.
	 ...
	 *
	 * @param cov
	 *            A covariance matrix. Not modified.
	 * @param cov_inv
	 *            The inverse of cov. Modified.
	 * @return true if it could invert the matrix false if it could not.
	 */
	 ...
	 *
	 * @param cov
	 *            The distirbutions covariance. Not modified.
	 * @param vector
	 *            The random vector. Modified.
	 * @param rand
