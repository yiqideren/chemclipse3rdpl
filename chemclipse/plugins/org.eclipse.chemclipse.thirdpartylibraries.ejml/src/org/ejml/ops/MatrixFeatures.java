...
public class MatrixFeatures {
	 ...
	 *
	 * @param A
	 *            square symmetric matrix. Not modified.
	 *
	 ...
	 *            A matrix. Not modified.
	 * @param tol
	 *            Tolerance for how similar two elements need to be.
	 ...
	 * @param tol
	 *            Tolerance for being skew symmetric.
	...
	/**
	 * <p>
	 * Checks to see if each element in the two matrices are within tolerance of each other: tol &ge; |a<sub>ij</sub> - b<sub>ij</sub>|.
	 * <p>
	 *
	 * <p>
	 ...
	 *            A matrix. Not modified.
	 * @param tol
	 *            How close to being identical each element needs to be.
	...
	/**
	 * <p>
	 * Checks to see if each element in the upper or lower triangular portion of the two matrices are within tolerance of each other: tol &ge; |a<sub>ij</sub> - b<sub>ij</sub>|.
	 * <p>
	 *
	 * <p>
	 * NOTE: If any of the elements are not countable then false is returned.<br>
	 ...
	 *            A matrix. Not modified.
	 * @param upper
	 *            true of upper triangular and false for lower.
	 * @param tol
	 *            How close to being identical each element needs to be.
	 * @return true if equals and false otherwise.
	 */
	...
	/**
	 * <p>
	 * Checks to see if each element in the two matrices are equal: a<sub>ij</sub> == b<sub>ij</sub>
	 * <p>
	 *
	 * <p>
	 ...
	 *
	 * @param Q
	 *            The matrix being tested. Not modified.
	 * @param tol
	 *            Tolerance.
	 ...
	 *
	 * @param A
	 *            Matrix whose rows are being tested for linear independence.
	 ...
	 *
	 * @param mat
	 *            Matrix being examined. Not modified.
	 * @param tol
	 *            Tolerance.
	 ...
	 *            The matrix being tested. Not modified.
	 * @param val
	 *            Checks to see if every element in the matrix has this value.
	 * @param tol
	 *            True if all the elements are within this tolerance.
	 ...
	 *
	 * @param a
	 *            First matrix. Not modified.
	 * @param b
	 *            Second matrix. Not modified.
	 * @param tol
	 *            Numerical tolerance.
	...
	/**
	 * <p>
	 * Checks to see if a matrix is upper triangular or Hessenberg. A Hessenberg matrix of degree N has the following property:<br>
	 * <br>
	 ...
	 * 
	 * @param A
	 *            Matrix being tested. Not modified.
	 * @param hessenberg
	 *            The degree of being hessenberg.
	 * @param tol
	 *            How close to zero the lower left elements need to be.
	 ...
	 *            Matrix whose rank is to be calculated. Not modified.
	 * @param threshold
	 *            The numerical threshold used to determine a singular value.
	 * @return The matrix's rank.
	 */
