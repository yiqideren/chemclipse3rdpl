...
public class RandomMatrices {
	 ...
	 *
	 * @param dimen
	 *            dimension of the space which the vectors will span.
	 * @param numVectors
	 *            How many vectors it should generate.
	 * @param rand
	 *            Used to create random vectors.
	 ...
	 *
	 * @param span
	 *            The span the random vector belongs in.
	 * @param rand
	 *            RNG
	 ...
	 * @param rand
	 *            Random number generator used to create matrices.
	 ...
	 * @param min
	 *            Minimum value of a diagonal element.
	 * @param max
	 *            Maximum value of a diagonal element.
	 * @param rand
	 ...
	 *
	 * @param numRows
	 *            Number of rows in the returned matrix..
	 * @param numCols
	 ...
	 * 
	 * @param numRows
	 *            Number of rows in generated matrix.
	 * @param numCols
	 *            NUmber of columns in generated matrix.
	 * @param rand
	 *            Random number generator.
	 * @param sv
	 ...
	 *            Random number generator.
	 * @param eigenvalues
	 *            Set of real eigenvalues that the matrix will have.
	 ...
	 * @param hessenberg
	 *            0 for triangular matrix and > 0 for hessenberg matrix.
	 * @param min
