...
public class EigenOps {
	...
	/**
	 * <p>
	 * Given matrix A and an eigen vector of A, compute the corresponding eigen value. This is the Rayleigh quotient.<br>
	 * <br>
	 ...
	 *            Matrix. Not modified.
	 * @param eigenVector
	 *            An eigen vector of A. Not modified.
	...
	/**
	 * <p>
	 * Given an eigenvalue it computes an eigenvector using inverse iteration: <br>
	 * for i=1:MAX {<br>
	 ...
	 * 
	 * @param A
	 *            Matrix whose eigenvector is being computed. Not modified.
	 * @param eigenvalue
	 *            The eigenvalue in the eigen pair.
	 ...
	 *
	 * @param A
	 *            Square matrix with positive elements. Not modified.
	 * @param bound
	 *            Where the results are stored. If null then a matrix will be declared. Modified.
	 ...
	 *
	 * @param eig
	 *            An eigenvalue decomposition which has already decomposed a matrix.
