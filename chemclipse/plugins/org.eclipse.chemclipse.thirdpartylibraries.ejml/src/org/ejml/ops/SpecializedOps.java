...
public class SpecializedOps {
	 ...
	 *            A vector. Not modified.
	 * @param gamma
	 *            To produce a reflector gamma needs to be equal to 2/||u||.
	 * @return An orthogonal reflector.
	 */
	 ...
	 *
	 * @param order
	 *            Specifies which row in the dest corresponds to a row in the src. Not modified.
	 * @param src
	 ...
	 *
	 * @param src
	 *            Matrix being copied. Not modified.
	 * @param dst
	 *            Where just a triangle from src is copied. If null a new one will be created. Modified.
	 * @param upper
	 *            If the upper or lower triangle should be copied.
	 ...
	 * @param B
	 *            A square matrix that the results are saved to. Modified.
	 * @param alpha
	 ...
	 *
	 * @param A
	 *            Matrix that the vector is being extracted from. Not modified.
	 * @param rowA
	 *            Row of the first element that is extracted.
	 * @param colA
	 *            Column of the first element that is extracted.
	 * @param length
	 *            Length of the extracted vector.
	 * @param row
	 *            If true a row vector is extracted, otherwise a column vector is extracted.
	 * @param offsetV
	 *            First element in 'v' where the results are extracted to.
	 * @param v
	 ...
	 *            original matrix.
	 * @param column
	 *            If true then column vectors will be created.
	 ...
	 *
	 * @param ret
	 *            If null then a new matrix is declared otherwise the results are written to it. Is modified.
	 * @param pivots
	 *            Specifies the new order of rows in a matrix.
	 * @param numPivots
	 *            How many elements in pivots are being used.
	 * @param transposed
	 *            If the transpose of the matrix is returned.
	 ...
	 *
	 * @param T
	 *            A matrix. @return product of the diagonal elements.
