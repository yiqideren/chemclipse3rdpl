...
public class ComplexMath64F {
	 ...
	 *
	 * @param a
	 *            Complex number in polar notation. Not modified.
	 * @param b
	 *            Complex number in polar notation. Not modified.
	 * @param result
	 *            Storage for output.
	 ...
	 *            Complex number
	 * @param N
	 *            Power it is to be multiplied by
	 * @param result
	 *            Result
	 */
	 ...
	 *            Complex number
	 * @param N
	 *            The root's magnitude
	 * @param k
	 *            Specifies which root. 0 &le; k < N
	 * @param result
	 *            Computed root
	 */
