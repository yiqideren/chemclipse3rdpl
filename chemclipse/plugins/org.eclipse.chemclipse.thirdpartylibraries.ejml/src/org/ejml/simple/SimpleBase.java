...
public abstract class SimpleBase<T extends SimpleBase> implements Serializable {
	 ...
	 *
	 * @param b
	 *            A matrix that is n by bn. Not modified.
	 *
	 ...
	 *
	 * @param b
	 *            Value subtracted from each element
	 *
	 * @return The results of this operation.
	 */
	 ...
	 *
	 * @param v
	 *            The second vector in the dot product. Not modified.
	 * @return dot product
	 */
	 ...
	 *
	 * @param index
	 *            The matrix element that is being assigned a value.
	 * @param value
	 *            The element's new value.
	 */
	 ...
	 *
	 * @param row
	 *            The row that the array is to be written to.
	 * @param offset
	 *            The initial column that the array is written to.
	 * @param values
	 ...
	 *
	 * @param column
	 *            The column that the array is to be written to.
	 * @param offset
	 *            The initial column that the array is written to.
	 * @param values
	 *            Values which are to be written to the row in a matrix.
	 ...
	 *
	 * @param index
	 *            The element's index whose value is to be returned
	 ...
	 *
	 * @param rowMajor
	 *            true means it will traverse through the submatrix by row first, false by columns.
	 * @param minRow
	 *            first row it will start at.
	 * @param minCol
	 *            first column it will start at.
	 * @param maxRow
	 *            last row it will stop at.
	 * @param maxCol
	 *            last column it will stop at.
	 ...
	 *
	 * @param extractRow
	 *            If true a row will be extracted.
	 * @param element
	 *            The row or column the vector is contained in.
	 ...
	 *
	 * @param a
	 *            The matrix it is being compared against.
	 * @param tol
	 *            How similar they must be to be equals.
	 ...
	 *
	 * @param insertRow
	 *            First row the matrix is to be inserted into.
	 * @param insertCol
	 *            First column the matrix is to be inserted into.
	 * @param B
	 ...
	 *
	 * @param insertRow
	 *            Row where matrix B is written in to.
	 * @param insertCol
	 *            Column where matrix B is written in to.
	 * @param B
	 *            The matrix that is written into A.
	...
	/**
	 * <p>
	 * Returns a matrix which is the result of an element by element division of 'this' and 'b': c<sub>i,j</sub> = a<sub>i,j</sub>/b<sub>i,j</sub>
	 * </p>
	 *
	 * @param b
	 *            A simple matrix.
	...
	/**
	 * <p>
	 * Returns a matrix which is the result of an element by element power of 'this' and 'b': c<sub>i,j</sub> = a<sub>i,j</sub> ^ b<sub>i,j</sub>
	 * </p>
	 *
	 * @param b
	 *            A simple matrix.
	...
	/**
	 * <p>
	 * Returns a matrix which is the result of an element by element power of 'this' and 'b': c<sub>i,j</sub> = a<sub>i,j</sub> ^ b
	 * </p>
	 *
	 * @param b
	 *            Scalar
	...
	/**
	 * <p>
	 * Returns a matrix which is the result of an element by element exp of 'this' c<sub>i,j</sub> = Math.exp(a<sub>i,j</sub>)
	 * </p>
	 *
	 * @return The element by element power of 'this' and 'b'.
	 */
	...
	/**
	 * <p>
	 * Returns a matrix which is the result of an element by element exp of 'this' c<sub>i,j</sub> = Math.log(a<sub>i,j</sub>)
	 * </p>
	 *
	 * @return The element by element power of 'this' and 'b'.
	 */
