 ...
 *
 * <p>
 * Most functions in SimpleMatrix do not modify the original matrix. Instead they create a new SimpleMatrix instance which is modified and returned. This greatly simplifies memory management and writing of code in general. It also allows operations to be chained, as is shown below:<br>
 * <br>
...
public class SimpleMatrix extends SimpleBase<SimpleMatrix> {
	 ...
	 *
	 * <p>
	 * Note that 'data' is a variable argument type, so either 1D arrays or a set of numbers can be passed in:<br>
	 ...
	 * @param rowMajor
	 *            If the array is encoded in a row-major or a column-major format.
	 * @param data
	 ...
	 *            Upper bound
	 * @param rand
	 *            The random number generator that's used to fill the matrix. @return The new random matrix.
	 */
	 ...
	 *
	 * @param covariance
	 *            Covariance of the multivariate normal distribution
