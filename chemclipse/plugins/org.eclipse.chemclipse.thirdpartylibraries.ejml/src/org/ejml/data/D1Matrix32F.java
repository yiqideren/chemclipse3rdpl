...
public abstract class D1Matrix32F implements ReshapeMatrix, RealMatrix32F {
	 ...
	 *
	 * @param index
	 *            Index of element that is to be set.
	 * @param val
	 ...
	 *
	 * @param index
	 *            The index which is being modified.
	 * @param val
	 ...
	 *            The index which is being modified.
	 * @param val
	 *            The value that is being subtracted.
	 */
	 ...
	 *            The index which is being modified.
	 * @param val
	 *            The value that is being multiplied.
	 */
	 ...
	 * @param saveValues
	 *            If true then the value of each element will be save using a row-major reordering. Typically this should be false.
	 */
