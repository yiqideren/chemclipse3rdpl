 ...
 *
 * <p>
 * A linear system is defined as: A*X = B.<br>
 * where A &isin; &real; <sup>m &times; n</sup>, X &isin; &real; <sup>n &times; p</sup>, B &isin; &real; <sup>m &times; p</sup>. Different implementations can solve different types and shapes in input matrices and have different memory and runtime performance.
 * </p>
 * 
 * <p>
...
public interface LinearSolver<T extends Matrix> {
	 ...
	 *
	 * @param A
	 *            The 'A' matrix in the linear equation. Might be modified or save the reference.
	 ...
	 *
	 * @param B
	 *            A matrix &real; <sup>m &times; p</sup>. Might be modified.
	 * @param X
	 *            A matrix &real; <sup>n &times; p</sup>, where the solution is written to. Modified.
	 */
	public void solve(T B, T X);

	/**
	 * Computes the inverse of of the 'A' matrix passed into {@link #setA(org.ejml.data.Matrix)} and writes the results to the provided matrix. If 'A_inv' needs to be different from 'A'
	...
	/**
	 * Returns true if the passed in matrix to {@link #setA(org.ejml.data.Matrix)} is modified.
	 *
	...
	/**
	 * Returns true if the passed in 'B' matrix to {@link #solve(org.ejml.data.Matrix, org.ejml.data.Matrix)} is modified.
	 *
