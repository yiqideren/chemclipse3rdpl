...
/**
 * <p>
 * QR decompositions decompose a rectangular matrix 'A' such that 'A=QR'. Where A &isin; &real; <sup>n &times; m</sup> , n &ge; m, Q &isin; &real; <sup>n &times; n</sup> is an orthogonal matrix, and R &isin; &real; <sup>n &times; m</sup> is an upper triangular matrix. Some implementations of QR decomposition require that A has full rank.
 * </p>
 * <p>
...
public interface QRDecomposition<T extends Matrix> extends DecompositionInterface<T> {
	 ...
	 *
	 * @param Q
	 *            If not null then the Q matrix is written to it. Modified.
	 * @param compact
	 ...
	 * </p>
	 * <p>
	 * If setZeros is true then an n &times; m matrix is required and all the elements are set. If setZeros is false then the matrix must be at least m &times; m and only the upper triangular elements are set.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param R
	 *            If not null then the R matrix is written to it. Modified.
	 * @param compact
