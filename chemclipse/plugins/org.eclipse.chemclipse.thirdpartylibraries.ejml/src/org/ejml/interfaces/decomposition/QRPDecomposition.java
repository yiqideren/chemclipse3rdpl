...
/**
 * <p>
 * Similar to {@link QRDecomposition} but it can handle the rank deficient case by performing column pivots during the decomposition. The final decomposition has the following structure:<br>
 * A*P=Q*R<br>
...
public interface QRPDecomposition<T extends Matrix> extends QRDecomposition<T> {
	 ...
	 *
	 * @param P
	 *            Optional storage for pivot matrix. If null a new matrix will be created.
