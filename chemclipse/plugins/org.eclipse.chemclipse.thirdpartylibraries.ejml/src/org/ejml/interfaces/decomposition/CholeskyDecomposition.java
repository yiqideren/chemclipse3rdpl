...
/**
 * <p>
 * Cholesky decomposition for {@link DenseMatrix64F}. It decomposes positive-definite symmetric matrices (real) or hermitian-positive definite (complex) into either upper or lower triangles:<br>
 * <br>
 * L*L<sup>H</sup>=A<br>
 * R<sup>H</sup>*R=A<br>
 * <br>
 * where L is a lower triangular matrix and R is an upper triangular matrix. This is typically used to invert matrices, such as a covariance matrix.<br>
 * </p>
 *
 * @author Peter Abeles
 */
