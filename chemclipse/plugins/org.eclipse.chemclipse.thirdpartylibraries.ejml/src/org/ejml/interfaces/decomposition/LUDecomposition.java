 ...
 * <div align=center> P<sup>T</sup>*L*U = A</div> where P is a pivot matrix, L is a lower triangular matrix, U is an upper triangular matrix and A is the original matrix.
 * </p>
 *
 * <p>
...
public interface LUDecomposition<T extends Matrix> extends DecompositionInterface<T> {
	 ...
	 *
	 * @param lower
	 *            Storage for T matrix. If null then a new matrix is returned. Modified.
	 * @return The L matrix.
	 */
	 ...
	 *
	 * @param upper
	 *            Storage for U matrix. If null then a new matrix is returned. Modified.
	 * @return The U matrix.
	 */
	 ...
	 *
	 * @param pivot
	 *            Storage for the pivot matrix. If null then a new matrix is returned. Modified.
