...
/**
 * <p>
 * This is an abstract class for computing the singular value decomposition (SVD) of a matrix, which is defined as:<br>
...
public abstract interface SingularValueDecomposition<T extends Matrix> extends DecompositionInterface<T> {
	 ...
	 *
	 * @param U
	 *            Optional storage for U. If null a new instance or internally maintained matrix is returned. Modified.
	 * @param transposed
	 *            If the returned U is transposed.
	 ...
	 *
	 * @param V
	 *            Optional storage for v. If null a new instance or internally maintained matrix is returned. Modified.
	 * @param transposed
	 *            If the returned V is transposed.
	 * @return An orthogonal matrix.
	 */
	 ...
	 *
	 * @param W
	 *            Optional storage for W. If null a new instance or internally maintained matrix is returned. Modified.
