...
/**
 * <p>
 * Performs a {@link org.ejml.interfaces.decomposition.BidiagonalDecomposition} using householder reflectors. This is efficient on wide or square matrices.
 * </p>
 *
 * @author Peter Abeles
 */
public class BidiagonalDecompositionRow_D64 implements BidiagonalDecomposition<DenseMatrix64F> {
	 ...
	 *
	 * @param A
	 *            The matrix that is being decomposed. Not modified.
	 ...
	 *
	 * @param B
	 *            If not null the results are stored here, if null a new matrix is created.
	 ...
	 *
	 * @param U
	 *            If not null then the results will be stored here. Otherwise a new matrix will be created.
