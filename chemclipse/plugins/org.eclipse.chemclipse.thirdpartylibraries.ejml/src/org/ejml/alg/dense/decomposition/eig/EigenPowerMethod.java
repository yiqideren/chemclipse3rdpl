...
/**
 * <p>
 * The power method is an iterative method that can be used to find dominant eigen vector in a matrix. Computing <b>A<sup>n</sup>q</b> for larger and larger values of n, where q is a vector. Eventually the dominant (if there is any) eigen vector will "win".
 * <p>
 *
 * <p>
...
public class EigenPowerMethod {
	 ...
	 *
	 * @param A
	 *            An invertible square matrix matrix.
	 * @param alpha
	 *            Shifting factor.
	 * @return If it converged or not.
	 */
