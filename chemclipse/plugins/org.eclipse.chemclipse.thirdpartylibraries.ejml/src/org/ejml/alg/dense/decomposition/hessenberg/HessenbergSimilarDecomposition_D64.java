 ...
 *
 * <p>
 * A matrix is upper Hessenberg if a<sup>ij</sup> = 0 for all i > j+1. For example, the following matrix is upper Hessenberg.<br>
 * <br>
...
public class HessenbergSimilarDecomposition_D64 implements DecompositionInterface<DenseMatrix64F> {
	 ...
	 *
	 * @param initialSize
	 *            Expected size of the matrices it will decompose.
	 */
