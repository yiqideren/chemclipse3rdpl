...
/**
 * A specialized Cholesky decomposition algorithm that is designed to help out {@link CholeskyDecompositionBlock_D64} perform its calculations. While decomposing
...
class CholeskyBlockHelper_D64 {
	 ...
	 *
	 * @param widthMax
	 *            The maximum width of a matrix that can be processed.
	 */
	 ...
	 *
	 * @param mat
	 *            A matrix which has a submatrix that needs to be inverted
	 * @param indexStart
	 *            the first index of the submatrix
	 * @param n
	 *            The width of the submatrix that is to be inverted.
