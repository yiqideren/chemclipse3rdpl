...
public class QrHelperFunctions_CD64 {
	 ...
	 * @param startU
	 *            first index to consider in u
	 * @param length
	 *            Number of complex numebrs to consider
	 * @return magnitude
	 */
	 ...
	 */
	public static void divideElements(final int j, final int numRows, final double[] u, final int startU, final double realA, final double imagA) {
	 ...
	 *
	 * @param start
	 *            Element in 'u' that it starts at.
	 * @param stop
	 *            Element in 'u' that it stops at.
	 * @param x
	 *            Array
	 * @param max
	 *            Max value in 'u' that is used to normalize it.
	 * @param tau
	 *            Storage for tau
	 * @return Returns gamma
	 */
	public static double computeTauGammaAndDivide(final int start, final int stop, final double[] x, final double max, Complex64F tau) {
	 ...
	 *            vector
	 * @param offsetU
	 *            offset added to w0 when indexing u. Multiplied by 2 since complex.
	 * @param gammaR
	 *            real component of gamma
	 * @param colA0
	 *            first column in A sub-matrix.
	 * @param w0
	 *            first index in sub-array in u and row sub-matrix in A
	 * @param w1
	 *            last index + 1 in sub-array in u and row sub-matrix in A
	 * @param _temp
