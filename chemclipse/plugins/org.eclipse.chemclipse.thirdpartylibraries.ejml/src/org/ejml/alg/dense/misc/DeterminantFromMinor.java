...
/**
 * <p>
 * Computes the determinant of a matrix using Laplace expansion. This is done using minor matrices as is shown below:<br>
 * <br>
...
public class DeterminantFromMinor {
	 ...
	 *
	 * @param width
	 *            The width of the matrices that it will be computing the determinant for
	 */
	 ...
	 *            The width of the matrices that it will be computing the determinant for
	 * @param minWidth
	 *            At which point should it use a predefined function to compute the determinant.
	 */
