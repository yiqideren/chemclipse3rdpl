...
/**
 * <p>
 * This contains algorithms for solving systems of equations where T is a non-singular triangular complex matrix:<br>
 * <br>
 * T*x = b<br>
 * <br>
...
public class CTriangularSolver {
	...
	/**
	 * <p>
	 * Solves for non-singular lower triangular matrices with real valued diagonal elements using forward substitution. <br>
	 * b = L<sup>-1</sup>b<br>
	 * <br>
	...
	/**
	 * <p>
	 * This is a forward substitution solver for non-singular lower triangular matrices with real valued diagonal elements. <br>
