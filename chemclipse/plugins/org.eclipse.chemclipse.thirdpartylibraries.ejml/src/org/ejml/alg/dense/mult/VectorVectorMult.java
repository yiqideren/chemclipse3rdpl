...
public class VectorVectorMult {
	 ...
	 *
	 * @param x
	 *            A vector with n elements. Not modified.
	 * @param y
	 *            A vector with n elements. Not modified.
	 ...
	 *            A vector with n elements. Not modified.
	 * @param A
	 *            A matrix with n by m elements. Not modified.
	 * @param y
	 ...
	 *            A vector with n elements. Not modified.
	 * @param A
	 *            A matrix with n by n elements. Not modified.
	 * @param y
	 *            A vector with n elements. Not modified.
	 * @return The results.
	 */
	...
	/**
	 * <p>
	 * Sets A &isin; &real; <sup>m &times; n</sup> equal to an outer product multiplication of the two vectors. This is also known as a rank-1 operation.<br>
	 * <br>
	 * A = x * y' where x &isin; &real; <sup>m</sup> and y &isin; &real; <sup>n</sup> are vectors.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Adds to A &isin; &real; <sup>m &times; n</sup> the results of an outer product multiplication of the two vectors. This is also known as a rank 1 update.<br>
	 * <br>
	 * A = A + &gamma; x * y<sup>T</sup> where x &isin; &real; <sup>m</sup> and y &isin; &real; <sup>n</sup> are vectors.
	 * </p>
	 * <p>
	 ...
	 *
	 * @param gamma
	 *            A multiplication factor for the outer product.
	 * @param x
	 *            A vector with m elements. Not modified.
	 * @param y
	 *            A vector with n elements. Not modified.
	 ...
	 * </p>
	 * <p>
	 * This is called a rank1 update because the matrix u w<sup>T</sup> has a rank of 1. Both A and B can be the same matrix instance, but there is a special rank1Update for that.
	 * </p>
	 *
	 * @param gamma
	 *            A scalar.
	 * @param A
	 *            A m by m matrix. Not modified.
	 * @param u
	 *            A vector with m elements. Not modified.
	 * @param w
	 *            A vector with m elements. Not modified.
