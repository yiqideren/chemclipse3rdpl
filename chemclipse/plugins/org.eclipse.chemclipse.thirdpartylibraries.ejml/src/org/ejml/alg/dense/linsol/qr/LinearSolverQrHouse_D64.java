...
/**
 * <p>
 * QR decomposition can be used to solve for systems. However, this is not as computationally efficient as LU decomposition and costs about 3n<sup>2</sup> flops.
 * </p>
 * <p>
 * It solve for x by first multiplying b by the transpose of Q then solving for the result. <br>
 * QRx=b<br>
 * Rx=Q^T b<br>
 * </p>
 *
...
public class LinearSolverQrHouse_D64 extends LinearSolverAbstract_D64 {
	 ...
	 *
	 * @param B
	 *            A matrix that is n by m. Not modified.
	 * @param X
