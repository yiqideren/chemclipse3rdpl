 ...
 * </p>
 * <p>
 * Both Q and R are stored in the same m by n matrix. Q is not stored directly, instead the u from Q<sub>k</sub>=(I-&gamma;*u*u<sup>T</sup>) is stored. Decomposition requires about 2n*m<sup>2</sup>-2m<sup>2</sup>/3 flops.
 * </p>
 *
 * <p>
...
public class QRDecompositionHouseholder_D64 implements QRDecomposition<DenseMatrix64F> {
	...
	/**
	 * <p>
	 * In order to decompose the matrix 'A' it must have full rank. 'A' is a 'm' by 'n' matrix. It requires about 2n*m<sup>2</sup>-2m<sup>2</sup>/3 flops.
	 * </p>
	 *
	 * <p>
