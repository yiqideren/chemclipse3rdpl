...
/**
 * <p>
 * Computes the eigenvalues and eigenvectors of a real symmetric matrix using the symmetric implicit QR algorithm. Inside each iteration a QR decomposition of A<sub>i</sub>-p<sub>i</sub>I is implicitly computed.
 * </p>
 * <p>
...
public class SymmetricQRAlgorithmDecomposition_D64 implements EigenDecomposition<DenseMatrix64F> {
	 ...
	 *
	 * @param orig
	 *            The matrix which is being decomposed. Not modified.
