...
/**
 * <p>
 * Computes the Singular value decomposition of a matrix using the implicit QR algorithm for singular value decomposition. It works by first by transforming the matrix to a bidiagonal A=U*B*V<sup>T</sup> form, then it implicitly computing the eigenvalues of the B<sup>T</sup>B matrix, which are the same as the singular values in the original A matrix.
 * </p>
 *
 * <p>
