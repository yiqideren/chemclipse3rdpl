 ...
 *
 * <p>
 * This class implements the Moore-Penrose pseudo-inverse using SVD and should never fail. Alternative implementations can use Cholesky decomposition, but those will fail if the A<sup>T</sup>A matrix is singular. However the Cholesky implementation is much faster.
 * </p>
 *
 * @author Peter Abeles
 */
