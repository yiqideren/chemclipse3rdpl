 ...
 *
 * <p>
 * Definitions: A &isin; &real; <sup>m &times; n</sup>, m &ge; n, rank(A) = n and that A = QR, where Q &isin; &real; <sup>m &times; m</sup> is orthogonal, and R &isin; &real; <sup>m &times; n</sup> is upper triangular.
 * </p>
 * 
 * <p>
...
public class QrUpdate {
	 ...
	 *
	 * @param Q
	 *            The Q matrix which is to be modified, must be big enough to grow. Must be n by n.. Is modified.
	 * @param R
	 *            The R matrix which is to be modified, must be big enough to grow. Must be m by n. Is modified.
	 * @param row
	 *            The row being inserted. Not modified.
	 * @param rowIndex
	 *            Which row index it is to be inserted at.
	 * @param resizeR
	 ...
	 *
	 * @param Q
	 *            The Q matrix. Is modified.
	 * @param R
	 *            The R matrix. Is modified.
	 * @param rowIndex
	 *            Which index of the row that is being removed.
	 * @param resizeR
	 ...
	 * 
	 * @param Q
	 *            The Q matrix which is to be modified. Is modified later and reference saved.
	 * @param R
	 *            The R matrix which is to be modified. Is modified later and reference saved.
	 */
	 ...
	 *
	 * @param rowIndex
	 *            where the matrix has been inserted.
	 */
