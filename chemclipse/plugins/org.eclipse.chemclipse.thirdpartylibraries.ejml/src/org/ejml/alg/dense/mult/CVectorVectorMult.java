...
public class CVectorVectorMult {
	...
	/**
	 * <p>
	 * Computes the inner product between a vector and the conjugate of another one. <br>
	 * <br>
	 ...
	 * <br>
	 * A = x * y<sup>T</sup> where x &isin; &real; <sup>m</sup> and y &isin; &real; <sup>n</sup> are vectors.
	 * </p>
	 * <p>
	 ...
	 * Sets A &isin; &real; <sup>m &times; n</sup> equal to an outer product multiplication of the two vectors. This is also known as a rank-1 operation.<br>
	 * <br>
	 * A = x * y<sup>H</sup> where x &isin; &real; <sup>m</sup> and y &isin; &real; <sup>n</sup> are vectors.
	 * </p>
	 * <p>
	 * Which is equivalent to: A<sub>ij</sub> = x<sub>i</sub>*y<sub>j</sub>
	 * </p>
