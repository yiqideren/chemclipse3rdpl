...
/**
 * <p>
 * This contains algorithms for solving systems of equations where T is a non-singular triangular matrix:<br>
 * <br>
 * T*x = b<br>
 * <br>
...
public class TriangularSolver {
	 ...
	 *
	 * @param L
	 *            An n by n non-singular lower triangular matrix. Not modified.
	 * @param b
	...
	/**
	 * <p>
	 * This is a forward substitution solver for non-singular lower triangular matrices. <br>
	...
	/**
	 * <p>
	 * This is a forward substitution solver for non-singular upper triangular matrices. <br>
	 * b = U<sup>-1</sup>b<br>
	 * <br>
	 ...
	 *
	 * @param U
	 *            An n by n non-singular upper triangular matrix. Not modified.
	 * @param b
	 *            A vector of length n. Modified.
	 * @param n
	 *            The size of the matrices.
	...
	/**
	 * <p>
	 * This is a forward substitution solver for non-singular upper triangular matrices which are a sub-matrix inside a larger. The columns of 'b' are solved for individually <br>
	 * b = U<sup>-1</sup>b<br>
	 * <br>
	 ...
	 *
	 * @param U
	 *            Matrix containing the upper triangle system
	 * @param startU
	 *            Index of the first element in U
	 * @param strideU
	 *            stride between rows
	 * @param widthU
	 *            How wide the square matrix is
	 * @param b
	 *            Matrix containing the solution to the system. Overwritten with the solution.
	 * @param startB
