...
public class BlockInnerTriangularSolver {
	 ...
	 *
	 * @param L
	 *            Lower triangular matrix being inverted. Not modified.
	 * @oaran K_inv Where the inverse is stored. Can be the same as L. Modified.
	 * @param m
	 *            The number of rows and columns.
	 * @param offsetL
	 *            which index does the L matrix start at.
	 * @param offsetL_inv
	 *            which index does the L_inv matrix start at.
	 *
	 */
	 ...
	 *
	 * @param L
	 *            Lower triangular matrix being inverted. Over written with inverted matrix. Modified.
	 * @param m
	 *            The number of rows and columns.
	 * @param offsetL
	 *            which index does the L matrix start at.
	...
	/**
	 * <p>
	 * Solves for non-singular lower triangular matrices using forward substitution. <br>
	 * B = L<sup>-1</sup>B<br>
	 * <br>
	 ...
	 *
	 * @param L
	 *            An m by m non-singular lower triangular matrix. Not modified.
	 * @param b
	 *            An m by n matrix. Modified.
	 * @param m
	 *            size of the L matrix
	 * @param n
	 *            number of columns in the B matrix.
	 * @param strideL
	 *            number of elements that need to be added to go to the next row in L
	 * @param offsetL
	 *            initial index in L where the matrix starts
	 * @param offsetB
	...
	/**
	 * <p>
	 * Solves for non-singular transposed lower triangular matrices using backwards substitution: <br>
	 * B = L<sup>-T</sup>B<br>
	 * <br>
	 * where B is a (m by n) matrix, L is a lower triangular (m by m) matrix.
	 * </p>
	...
	/**
	 * <p>
	 * Solves for non-singular upper triangular matrices using backwards substitution. <br>
	 * B = U<sup>-1</sup>B<br>
	 * <br>
	 ...
	 *
	 * @param U
	 *            An m by m non-singular upper triangular matrix. Not modified.
	 * @param b
	 *            An m by n matrix. Modified.
	 * @param m
	 *            size of the L matrix
	...
	/**
	 * <p>
	 * Solves for non-singular upper triangular matrices using forward substitution. <br>
	 * B = U<sup>-T</sup>B<br>
	 * <br>
	 * where B (m by n) is a matrix, U is a (m by m ) upper triangular matrix.<br>
	 * </p>
