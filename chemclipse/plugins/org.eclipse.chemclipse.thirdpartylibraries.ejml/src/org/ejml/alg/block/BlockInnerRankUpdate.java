...
public class BlockInnerRankUpdate {
	 ...
	 * 
	 * @param blockLength
	 *            Size of the block in the block matrix.
	 * @param alpha
	...
	/**
	 * <p>
	 * Rank N update function for a symmetric inner submatrix and only operates on the upper triangular portion of the submatrix.<br>
	 * <br>
	 * A = A - B <sup>T</sup>B
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Rank N update function for a symmetric inner submatrix and only operates on the lower triangular portion of the submatrix.<br>
	 * <br>
	 ...
	 * </p>
	 */
	protected static void multTransABlockMinus(double[] dataA, double[] dataC, int indexA, int indexB, int indexC, final int heightA, final int widthA, final int widthC) {
	 ...
	 * </p>
	 */
	protected static void multTransABlockMinus_U(double[] dataA, double[] dataC, int indexA, int indexB, int indexC, final int heightA, final int widthA, final int widthC) {
	 ...
	 * </p>
	 */
	protected static void multTransBBlockMinus_L(double[] dataA, double[] dataC, int indexA, int indexB, int indexC, final int widthA, final int heightA, final int widthC) {
