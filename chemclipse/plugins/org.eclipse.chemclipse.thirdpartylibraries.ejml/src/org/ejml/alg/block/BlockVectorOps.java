...
public class BlockVectorOps {
	 ...
	 *
	 * @param A
	 *            submatrix. Not modified.
	 * @param rowA
	 *            which row in A the vector is contained in.
	 * @param alpha
	 *            scale factor.
	 * @param B
	 *            submatrix that the results are written to. Modified.
	 * @param offset
	 *            Index at which the vectors start at.
	 * @param end
	 *            Index at which the vectors end at.
	 */
	public static void scale_row(final int blockLength, D1Submatrix64F A, int rowA, double alpha, D1Submatrix64F B, int rowB, int offset, int end) {
	 ...
	 *            Index at which the vectors end at.
	 */
	public static void div_row(final int blockLength, D1Submatrix64F A, int rowA, double alpha, D1Submatrix64F B, int rowB, int offset, int end) {
	 ...
	 *
	 * @param blockLength
	 *            Length of each inner matrix block.
	 * @param A
	 *            submatrix. Not modified.
	 * @param rowA
	 *            which row in A the vector is contained in.
	 ...
	 *            submatrix. Not modified.
	 * @param rowB
	 *            which row in B the vector is contained in.
	 * @param beta
	 *            scale factor of B
	 * @param C
	 *            submatrix where the results are written to. Modified.
	 * @param rowC
	 *            which row in C is the vector contained.
	 * @param offset
	 *            Index at which the vectors start at.
	 * @param end
	 *            Index at which the vectors end at.
	 */
	public static void add_row(final int blockLength, D1Submatrix64F A, int rowA, double alpha, D1Submatrix64F B, int rowB, double beta, D1Submatrix64F C, int rowC, int offset, int end) {
	 ...
	 */
	public static double dot_row(final int blockLength, D1Submatrix64F A, int rowA, D1Submatrix64F B, int rowB, int offset, int end) {
	 ...
	 *
	 * @param A
	 *            block row vector. Not modified.
	 * @param rowA
	 *            which row in A the vector is contained in.
	 * @param B
	 *            block column vector. Not modified.
	 * @param colB
	 *            which column in B is the vector contained in.
	 * @param offset
	 *            Index at which the vectors start at.
	 * @param end
	 *            Index at which the vectors end at.
	 * @return Results of the dot product.
	 */
	public static double dot_row_col(final int blockLength, D1Submatrix64F A, int rowA, D1Submatrix64F B, int colB, int offset, int end) {
