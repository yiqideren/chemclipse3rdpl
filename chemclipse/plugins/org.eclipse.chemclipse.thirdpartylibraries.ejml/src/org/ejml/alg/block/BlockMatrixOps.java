...
public class BlockMatrixOps {
	 ...
	 *
	 * @param src
	 *            Original DenseMatrix64F. Not modified.
	 * @param dst
	 *            Equivalent BlockMatrix64F. Modified.
	 */
	 ...
	 * @param blockLength
	 *            Block size in the converted matrix.
	 * @param data
	 *            Matrix data in a row-major format. Modified.
	 * @param tmp
	 *            Temporary data structure that is to be the size of a block row.
	 */
	 ...
	 *
	 * @param src
	 *            Original BlockMatrix64F.. Not modified.
	 * @param dst
	 *            Equivalent DenseMatrix64F. Modified.
	 */
	 ...
	 *            Block size in the converted matrix.
	 * @param data
	 *            Matrix data in a block row-major format. Modified.
	 * @param tmp
	 *            Temporary data structure that is to be the size of a block row.
	 */
	 ...
	 *
	 * @param upper
	 *            If the upper or lower triangle is copied.
	 * @param src
	 *            The source matrix. Not modified.
	 * @param dst
	 ...
	 *
	 * @param src
	 *            Matrix which a submatrix is being extracted from. Not modified.
	 * @param dst
