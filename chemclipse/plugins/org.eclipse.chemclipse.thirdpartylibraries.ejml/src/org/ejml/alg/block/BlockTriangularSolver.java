...
public class BlockTriangularSolver {
	 ...
	 * @param blockLength
	 * @param upper
	 *            Is it upper or lower triangular.
	 * @param T
	 *            Triangular matrix that is to be inverted. Must be block aligned. Not Modified.
	 * @param T_inv
	 *            Where the inverse is stored. This can be the same as T. Modified.
	 * @param temp
	 *            Work space variable that is size blockLength*blockLength.
	 */
	public static void invert(final int blockLength, final boolean upper, final D1Submatrix64F T, final D1Submatrix64F T_inv, final double temp[]) {
	 ...
	 *            Is it upper or lower triangular.
	 * @param T
	 *            Triangular matrix that is to be inverted. Overwritten with solution. Modified.
	 * @param temp
	 *            Work space variable that is size blockLength*blockLength.
	 */
	public static void invert(final int blockLength, final boolean upper, final D1Submatrix64F T, final double temp[]) {
	 ...
	 * @param upper
	 *            If T is upper or lower triangular.
	 * @param T
	 *            An upper or lower triangular matrix. Not modified.
	 * @param B
	 *            A matrix whose height is the same as T's width. Solution is written here. Modified.
	 */
	public static void solve(final int blockLength, final boolean upper, final D1Submatrix64F T, final D1Submatrix64F B, final boolean transT) {
	 ...
	 *
	 * @param blockLength
	 *            Size of the inner blocks in the block matrix.
	 * @param upper
	 *            If T is upper or lower triangular.
	 * @param T
	 *            An upper or lower triangular matrix that is contained in an inner block. Not modified.
	 * @param B
	 *            A block aligned row or column submatrix. Modified.
	 * @param transT
	 *            If T is transposed or not.
	 * @param transB
	 *            If B is transposed or not.
	 */
	public static void solveBlock(final int blockLength, final boolean upper, final D1Submatrix64F T, final D1Submatrix64F B, final boolean transT, final boolean transB) {
	 ...
	 * @param blockLength
	 * @param L
	 *            Lower triangular with dimensions m by m. Not modified.
	 * @param B
	 *            A matrix with dimensions m by n. Solution is written into here. Modified.
	 * @param transL
	 *            Is the triangular matrix transposed?
	 */
	public static void solveL(final int blockLength, final D1Submatrix64F L, final D1Submatrix64F B, boolean transL) {
	 ...
	 * @param blockLength
	 * @param R
	 *            Upper triangular with dimensions m by m. Not modified.
	 * @param B
	 *            A matrix with dimensions m by n. Solution is written into here. Modified.
	 * @param transR
	 *            Is the triangular matrix transposed?
	 */
	public static void solveR(final int blockLength, final D1Submatrix64F R, final D1Submatrix64F B, boolean transR) {
