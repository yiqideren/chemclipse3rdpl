...
public class BlockD3MatrixOps {
	...
	public static BlockD3Matrix64F random(int numRows, int numCols, double min, double max, Random rand, int blockLength) {
	 ...
	 * (m , o) += (m , n) * (n , o)
	 */
	private static void multBlockAdd(double[] blockA, double[] blockB, double[] blockC, final int m, final int n, final int o, final int blockLength) {
	...
	private static void multBlockSet(double[] blockA, double[] blockB, double[] blockC, final int m, final int n, final int o, final int blockLength) {
