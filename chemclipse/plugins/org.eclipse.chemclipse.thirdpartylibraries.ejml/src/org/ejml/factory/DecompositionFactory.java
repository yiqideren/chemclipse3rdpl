...
public class DecompositionFactory {
	 ...
	 * @param lower
	 *            should a lower or upper triangular matrix be used. If not sure set to true.
	 ...
	 *
	 * @param numRows
	 *            Number of rows the returned decomposition is optimized for.
	 * @param numCols
	 *            Number of columns that the returned decomposition is optimized for.
	 * @param needU
	 *            Should it compute the U matrix. If not sure set to true.
	 * @param needV
	 *            Should it compute the V matrix. If not sure set to true.
	 * @param compact
	 *            Should it compute the SVD in compact form. If not sure set to false.
	 * @return
	 */
	 ...
	 *            Number of rows and columns that the returned decomposition is optimized for.
	 * @param needVectors
	 *            Should eigenvectors be computed or not. If not sure set to true.
	 ...
	 * @param isSymmetric
	 *            If true then the returned algorithm is specialized only for symmetric matrices, if false
	 ...
	 *
	 * @param orig
	 *            The original matrix which was decomposed. Not modified.
	 * @param svd
	 *            The decomposition after processing 'orig'. Not modified.
	 ...
	 * @param eig
	 *            EVD of the original matrix. Not modified.
	 * @return The quality of the decomposition.
	 */
	 ...
	 *
	 * @param decomp
	 *            Decomposition which is being wrapped
	 * @param M
