...
public class LinearSolverFactory {
	 ...
	 *
	 * @param numRows
	 *            The number of rows that the decomposition is optimized for.
	 * @param numCols
	 ...
	 *
	 * @param computeNorm2
	 *            true to compute the minimum 2-norm solution for singular systems. Try true.
	 * @param computeQ
	 *            Should it precompute Q or use house holder. Try false;
	 ...
	 *
	 * @param useSVD
	 *            If true SVD will be used, otherwise QR with column pivot will be used.
