...
public interface IAxis {
	...
	/**
	 * Sets the category series. In order to enable category series, <tt>enableCategoryAxis(true)</tt> has to be invoked.
	 * 
	 * @param series
	 *            the category series
	 */
	...
	/**
	 * Gets the category series. If the category series haven't been set yet, <tt>null</tt> will be returned.
	 * 
