...
public class AxisTickLabels implements PaintListener {
	...
	/**
	 * Sets the format for axis tick label. <tt>DecimalFormat</tt> and <tt>DateFormat</tt> should be used for <tt>double[]</tt> series and <tt>Data[]</tt> series respectively.
	 * <p>
