...
public class Legend extends Composite implements ILegend, PaintListener {
	 ...
	 * of legend.
	 * <p>
	 * If there are multiple x axes, the given series array will be sorted with x axis first. And then, the series in each x axis will be sorted with {@link Legend#sort(List, boolean, boolean)}.
	 *
	 * @param seriesArray
	 *            the series array
