...
public interface ILineSeries extends ISeries {
	...
	/**
	 * Sets the symbol type. If null is given, default type <tt>PlotSymbolType.CIRCLE</tt> will be set.
	 *
	 * @param type
	 *            the symbol type
	 */
	 ...
	 * the rest of plots will have the common color which is set with <tt>setSymbolColor(Color)</tt>.
	 *
	 * @param colors
	 ...
	 * symbol if applicable (i.e. <tt>PlotSymbolType.CROSS</tt> or <tt>PlotSymbolType.PLUS</tt>). The default width is 1.
	 *
	 * @param width
	 *            the line width
	 */
	...
	/**
	 * Gets the anti-aliasing value for drawing line. The default value is <tt>SWT.DEFAULT<tt>.
	 *
	 * @return the anti-aliasing value which can be <tt>SWT.DEFAULT</tt>, <tt>SWT.ON</tt> or <tt>SWT.OFF</tt>.
	 */
	int getAntialias();
	 ...
	 *
	 * @param antialias
	 *            the anti-aliasing value which can be <tt>SWT.DEFAULT</tt>, <tt>SWT.ON</tt> or <tt>SWT.OFF</tt>.
	 */
