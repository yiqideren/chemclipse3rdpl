...
public interface IAxisTick {
	...
	/**
	 * Sets the format for axis tick label. <tt>DecimalFormat</tt> and <tt>DateFormat</tt> should be used for <tt>double[]</tt> series and <tt>Date[]</tt> series respectively.
	 *
	 * @param format
	 *            the format
	 */
	 ...
	 * <p>
	 * This method is typically used for mouse listener to check whether mouse cursor is on axis tick. Mouse listener can be added to <tt>Chart</tt>.
	 *
