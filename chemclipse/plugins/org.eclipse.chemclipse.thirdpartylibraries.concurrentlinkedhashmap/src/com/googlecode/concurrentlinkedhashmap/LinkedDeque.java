 ...
 * <p>
 * Most <tt>LinkedDeque</tt> operations run in constant time by assuming that the {@link Linked} parameter is associated with the deque instance. Any usage that violates this assumption will result in non-deterministic behavior.
 * <p>
 * The iterators returned by this class are <em>not</em> <i>fail-fast</i>: If the deque is modified at any time after the iterator is created, the iterator will be in an unknown state. Thus, in the face of concurrent modification, the iterator risks arbitrary, non-deterministic behavior at an undetermined time in the future.
 *
