...
public final class Weighers {
	 ...
	 * serialized data.
	 * <p>
	 * A value with a weight of <tt>0</tt> will be rejected by the map. If a value with this weight can occur then the caller should eagerly evaluate the value and treat it as a removal operation. Alternatively, a custom weigher may be specified on the map to assign an empty value a positive weight.
	 *
	 ...
	 * number of elements. This weigher only should be used when the alternative {@link #collection()} weigher cannot be, as evaluation takes O(n) time. A
