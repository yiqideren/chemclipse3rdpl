...
public class SoftValueHashMap extends AbstractMap implements Map {
	 ...
	 * or 11 (whichever is greater), and a default load factor, which is <tt>0.75</tt>.
	 * 
	 * @param t
	...
	/* -- Simple queries -- */
	/**
	 * Returns the number of key-value mappings in this map. <strong>Note:</strong> <em>In contrast with most implementations of the
	 ...
	 * If this map does not contain a value for this key, then return <code>null</code>.
	 * 
	 * @param key
	...
	/**
	 * Updates this map so that the given <code>key</code> maps to the given <code>value</code>. If the map previously contained a mapping for <code>key</code> then that mapping is replaced and the previous value
	 * is returned.
	 * 
	 * @param key
	 ...
	 *            mapped
	 * 
	 * @return The previous value to which this key was mapped, or <code>null</code> if if there was no mapping for the key
	 */
