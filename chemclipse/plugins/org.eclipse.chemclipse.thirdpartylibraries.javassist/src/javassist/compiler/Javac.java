...
public class Javac {
	 ...
	 *
	 * <p>
	 * This must be called before calling <code>compileStmnt()</code> and <code>compileExpr()</code>. The correct value of <code>isStatic</code> must be recorded before compilation. <code>maxLocals</code> is updated to include $0,...
	 */
	 ...
	 * new local variables, the local variables at the index <code>max</code>, <code>max + 1</code>, ... are assigned.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Local variables are not accessible within the compiled source text. Fields and method parameters ($0, $1, ..) are available if <code>recordParams()</code> have been invoked.
	 */
