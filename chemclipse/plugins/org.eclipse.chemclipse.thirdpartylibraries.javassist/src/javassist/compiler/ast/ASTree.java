 ...
 * a binary tree. If the node is a leaf node, both <code>getLeft()</code> and <code>getRight()</code> returns null.
 */
public abstract class ASTree implements Serializable {
	...
	/**
	 * Returns the type of this node. This method is used by <code>toString()</code>.
	 */
