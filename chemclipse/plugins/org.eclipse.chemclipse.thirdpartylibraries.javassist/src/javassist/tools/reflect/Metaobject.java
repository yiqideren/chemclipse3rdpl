 ...
 *
 * <p>
 * A <code>Metaobject</code> is created for every object at the base level. A different reflective object is associated with a different metaobject.
 *
 * <p>
 * The metaobject intercepts method calls on the reflective object at the base-level. To change the behavior of the method calls, a subclass of <code>Metaobject</code> should be defined.
 *
 * <p>
