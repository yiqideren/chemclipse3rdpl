 ...
 *
 * <p>
 * A <code>ClassMetaobject</code> is created for every class of reflective objects. It can be used to hold values shared among the reflective objects of the same class.
 *
 * <p>
...
public class ClassMetaobject implements Serializable {
	 ...
	 * are renamed so that they begin with <code>methodPrefix "_m_"</code>.
	 */
	 ...
	 *
	 * @param params
	 *            <code>params[0]</code> is the name of the class
	...
	/**
	 * Invokes a method whose name begins with <code>methodPrefix "_m_"</code> and the identifier.
	 *
	 ...
	 *
	 * <p>
	 * Note that the actual method returned will be have an altered, reflective name i.e. <code>_m_2_..</code>.
	 *
	 * @param identifier
