 ...
 *
 * <p>
 * This translator directly modifies class files on a local disk so that the classes represented by those class files are reflective. After the modification, the class files can be run with the standard JVM without <code>javassist.tools.reflect.Loader</code> or any other user-defined class loader.
 *
 * <p>
 ...
 *
 * <p>
 * <code>-m <i>classname</i></code> : specifies the class of the metaobjects associated with instances of the class followed by this option. The default is <code>javassit.reflect.Metaobject</code>.
 *
 * <p>
 * <code>-c <i>classname</i></code> : specifies the class of the class metaobjects associated with instances of the class followed by this option. The default is <code>javassit.reflect.ClassMetaobject</code>.
 *
 * <p>
