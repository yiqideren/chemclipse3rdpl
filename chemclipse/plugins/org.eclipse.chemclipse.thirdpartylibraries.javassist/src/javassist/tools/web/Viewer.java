 ...
 *
 * <p>
 * This is a sort of applet viewer that can run any program even if the main class is not a subclass of <code>Applet</code>. This viewwer first calls <code>main()</code> in the main class.
 *
 * <p>
...
public class Viewer extends ClassLoader {
	 ...
	 *            executed class
	 * @param args
	 *            the arguments passed to <code>main()</code>.
	 */
	 ...
	 * either <code>java.*</code>, <code>javax.*</code>, or <code>Viewer</code>, then it is loaded by the parent class
	 * loader.
	 *
	 * <p>
