...
public abstract class CtMember {
	 ...
	 * For example, if an annotation <code>@Author</code> is associated
	 * with this member, the returned array contains an <code>Author</code> object. The member values can be obtained by calling methods on
	 * the <code>Author</code> object.
	 *
	 ...
	 *
	 * <p>
	 * As for constructor names, see <code>getName()</code> in <code>CtConstructor</code>.
	 *
	 ...
	 * If two members have the same signature (parameter types etc.), <code>getSignature()</code> returns the same string.
	 */
