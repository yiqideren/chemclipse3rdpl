 ...
 * interface and attach an instance of that class to a <code>Loader</code> object so that it can translate a class file
...
public interface Translator {
	 ...
	 * This method can be used for getting (for caching) some <code>CtClass</code> objects that will be accessed
	 * in <code>onLoad()</code> in <code>Translator</code>.
	 *
	 * @param pool
	 *            the <code>ClassPool</code> that this translator
	 *            should use.
	 * @see Loader
	 * @throws NotFoundException
	 *             if a <code>CtClass</code> cannot be found.
	 * @throws CannotCompileException
	 *             if the initialization by this method
	 *             fails.
	 */
	 ...
	 *
	 * <p>
	 * <code>classname</code> may be the name of a class that has not been created yet. If so, <code>onLoad()</code> must create that class so that the <code>Loader</code> can read it after <code>onLoad()</code> returns.
	 *
	 * @param pool
	 *            the <code>ClassPool</code> that this translator
	 *            should use.
