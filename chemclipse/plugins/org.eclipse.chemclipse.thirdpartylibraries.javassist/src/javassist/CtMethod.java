 ...
 *
 * <p>
 * See the super class <code>CtBehavior</code> since a number of useful methods are in <code>CtBehavior</code>. A number of useful factory methods are in <code>CtNewMethod</code>.
 *
...
public final class CtMethod extends CtBehavior {
	 ...
	 *
	 * <p>
	 * All occurrences of class names in the created method are replaced with names specified by <code>map</code> if <code>map</code> is not <code>null</code>.
	 *
	 * <p>
	 ...
	 * This method simply delegates to <code>make()</code> in <code>CtNewMethod</code>. See it for more details. <code>CtNewMethod</code> has a number of useful factory methods.
	 *
	 * @param src
	 *            the source text.
	 * @param declaring
	 ...
	 *             if the the <code>MethodInfo</code> object and the declaring class have different <code>ConstPool</code> objects
	 * @since 3.6
	 */
	 ...
	 *
	 * <p>
	 * All occurrences of the class names in the copied method body are replaced with the names specified by <code>map</code> if <code>map</code> is not <code>null</code>.
	 *
	 * @param src
