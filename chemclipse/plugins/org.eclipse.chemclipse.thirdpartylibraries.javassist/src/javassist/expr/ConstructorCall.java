...
/**
 * Constructor call such as <code>this()</code> and <code>super()</code> within a constructor body.
 *
 * @see NewExpr
 */
public class ConstructorCall extends MethodCall {
	...
	/**
	 * Returns true if the called constructor is not <code>this()</code> but <code>super()</code> (a constructor declared in the super class).
	 */
