...
public class ExprEditor {
	 ...
	 * The constructor call is either <code>super()</code> or <code>this()</code> included in a constructor body.
	 *
	 * The default implementation performs nothing.
	 *
	 * @see #edit(NewExpr)
