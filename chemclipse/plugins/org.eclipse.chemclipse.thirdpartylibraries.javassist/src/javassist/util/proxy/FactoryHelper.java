...
public class FactoryHelper {
	...
	static {
		try {
			...
			defineClass1 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[]{String.class, byte[].class, int.class, int.class});
			defineClass2 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[]{String.class, byte[].class, int.class, int.class, ProtectionDomain.class});
		} catch(Exception e) {
	 ...
	 * from a wrapper object. For example, <code>intValue()</code> is such a method for obtaining an integer value from a <code>java.lang.Integer</code> object.
	 */
	...
	/**
	 * The data size of primitive types. <code>long</code> and <code>double</code> are 2; the others are 1.
	 */
