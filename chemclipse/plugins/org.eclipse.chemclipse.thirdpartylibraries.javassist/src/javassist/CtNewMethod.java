...
public class CtNewMethod {
	 ...
	 *            the class to which the created method is added.
	 * @param delegateObj
	 *            the source text specifying the object
	...
	public static CtMethod make(CtClass returnType, String mname, CtClass[] parameters, CtClass[] exceptions, String body, CtClass declaring) throws CannotCompileException {
		...
		return make(Modifier.PUBLIC, returnType, mname, parameters, exceptions, body, declaring);
	}
	 ...
	 * This is a convenience method for calling {@link CtMethod#CtMethod(CtMethod, CtClass, ClassMap) this constructor}.
	 ...
	 *
	 * @param delegate
	 *            the method that the created method forwards to.
	 * @param declaring
	 *            the class to which the created method is
	 *            added.
	 */
	 ...
	 *
	 * <p>
	 * The body of the created method is a copy of the body of the method specified by <code>body</code>. However, it is wrapped in parameter-conversion code.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * If the type of a parameter or a returned value is a primitive type, then the value is converted into a wrapper object such as <code>java.lang.Integer</code>. If the type of the returned value is <code>void</code>, the returned value is discarded.
	 *
	 * <p>
	 * <i>Example:</i>
	 *
