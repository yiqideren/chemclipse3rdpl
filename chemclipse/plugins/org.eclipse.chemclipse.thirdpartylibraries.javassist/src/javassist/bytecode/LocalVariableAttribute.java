...
public class LocalVariableAttribute extends AttributeInfo {
	 ...
	 *
	 * @param name
	 *            the attribute name. <code>LocalVariableAttribute.tag</code> or <code>LocalVariableAttribute.typeTag</code>.
	 * @see #tag
	 * @see #typeTag
	 * @since 3.1
	 * @deprecated
	...
	/**
	 * Returns the value of <code>local_variable_table[i].descriptor_index</code>.
	 * This represents the type descriptor of the local variable.
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this method returns the value of <code>local_variable_type_table[i].signature_index</code>. It represents the type of the local variable.
	 *
	 * @param i
	 *            the i-th entry.
	 */
	 ...
	 * this method should be used instead of <code>descriptorIndex()</code> since the method name is more appropriate.
	 * 
	 * @param i
	 *            the i-th entry.
	 ...
	 * <p>
	 * If this attribute represents a LocalVariableTypeTable attribute, this method returns the type signature of the local variable specified by <code>local_variable_type_table[i].signature_index</code>.
	 *
	 * @param i
	 *            the i-th entry.
	 */
	 ...
	 * If this attribute represents a LocalVariableTypeTable attribute,
	 * this method should be used instead of <code>descriptor()</code> since the method name is more appropriate.
	 *
	 * <p>
	 * To parse the string, call <code>toFieldSignature(String)</code> in <code>SignatureAttribute</code>.
	 *
	 * @param i
	 *            the i-th entry.
	 * @see #descriptor(int)
