 ...
 *
 * <p>
 * An instance of this class is returned by <code>getAnnotations()</code> in <code>AnnotationsAttribute</code> or in <code>ParameterAnnotationsAttribute</code>.
 *
...
public class Annotation {
	 ...
	 *            the entry at that index must be the <code>CONSTANT_Utf8_Info</code> structure
	 ...
	 *
	 * <p>
	 * If this annotation does not have a value for the specified member, this method returns null. It does not return a <code>MemberValue</code> with the default value. The default value can be obtained from the annotation type.
	 *
	 * @param name
	 *            the member name
