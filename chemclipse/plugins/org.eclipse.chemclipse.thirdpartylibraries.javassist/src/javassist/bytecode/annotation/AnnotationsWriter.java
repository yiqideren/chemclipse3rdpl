...
public class AnnotationsWriter {
	 ...
	 * This method must be followed by <code>num</code> calls to <code>numAnnotations()</code>.
	 */
	...
	/**
	 * Writes <code>num_annotations</code> in <code>Runtime(In)VisibleAnnotations_attribute</code>.
	 * This method must be followed by <code>num</code> calls to <code>annotation()</code>.
	 */
	 ...
	 * This method must be followed by <code>numMemberValuePairs</code> calls to <code>memberValuePair()</code>.
	 *
	 * @param type
	 *            the annotation interface name.
	 * @param numMemberValuePairs
	 *            <code>num_element_value_pairs</code> in <code>annotation</code>.
	 */
	 ...
	 *            <code>element_name_index</code> in <code>element_value_pairs</code> array.
	 */
	...
	/**
	 * Writes <code>tag</code> and <code>class_info_index</code> in <code>element_value</code>.
	 *
	 * @param name
	 *            the class name.
	 */
	...
	/**
	 * Writes <code>tag</code> and <code>annotation_value</code> in <code>element_value</code>.
	...
	/**
	 * Writes <code>tag</code> and <code>array_value</code> in <code>element_value</code>.
