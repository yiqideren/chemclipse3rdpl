...
public class TypeAnnotationsWriter extends AnnotationsWriter {
	...
	/**
	 * Writes {@code num_annotations} in {@code Runtime(In)VisibleTypeAnnotations_attribute}.
	...
	/**
	 * Writes {@code target_type} and {@code localvar_target} of {@code target_info} union.
