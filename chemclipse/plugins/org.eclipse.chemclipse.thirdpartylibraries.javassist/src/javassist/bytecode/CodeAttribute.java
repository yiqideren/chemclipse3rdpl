 ...
 *
 * <p>
 * To browse the <code>code</code> field of a <code>Code_attribute</code> structure, use <code>CodeIterator</code>.
 *
 * @see CodeIterator
 * @see #iterator()
 */
public class CodeAttribute extends AttributeInfo implements Opcode {
	...
	/**
	 * Computes the maximum stack size and sets <code>max_stack</code> to the computed size.
	 *
	 * @throws BadBytecode
	 ...
	 * This method does not update <code>LocalVariableAttribute</code>, <code>LocalVariableTypeAttribute</code>, <code>StackMapTable</code>, or <code>StackMap</code>.
