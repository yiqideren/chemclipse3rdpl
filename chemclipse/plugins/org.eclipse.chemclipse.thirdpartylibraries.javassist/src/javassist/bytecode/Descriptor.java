...
public class Descriptor {
	 ...
	 * "[Ljava/lang/Object;" and "[I;". For such names, use <code>toClassName()</code>.
	 *
	 ...
	 *
	 * <p>
	 * This method works even if the package-class separator is not <code>/</code> but <code>.</code> (period). For example, it accepts <code>Ljava.lang.Object;</code> as well as <code>Ljava/lang/Object;</code>.
	 *
	 * @param desc
	 *            descriptor.
	 * @param cp
	 ...
	 * For example, if the given descriptor is <code>"[[Ljava/lang/String;"</code> and the given dimension is 2,
	 ...
	 *
	 * <p>
	 * If the descriptor represents a method type, this method returns (the size of the returned value) - (the sum of the data sizes of all the parameters). For example, if the descriptor is <code>"(I)D"</code>, then this method returns 1 (= 2 - 1).
	 *
	 * @param desc
	 *            descriptor
	 */
	 ...
	 * is 2 words. For example, if the given descriptor is <code>"(IJ)D"</code>, then this method returns 3. The size of the
	 ...
	 * given descriptor. For example, <code>Ljava/lang/Object;</code> is converted into <code>java.lang.Object</code>. <code>(I[I)V</code> is converted into <code>(int, int[])</code> (the return type is ignored).
	 */
