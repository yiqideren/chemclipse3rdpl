...
public class SignatureAttribute extends AttributeInfo {
	 ...
	 *
	 * @param sig
	 *            the signature obtained from the <code>SignatureAttribute</code> of a <code>ClassFile</code>.
	 ...
	 *
	 * @param sig
	 *            the signature obtained from the <code>SignatureAttribute</code> of a <code>MethodInfo</code>.
	 ...
	 *
	 * @param sig
	 *            the signature string obtained from the <code>SignatureAttribute</code> of a <code>FieldInfo</code>.
