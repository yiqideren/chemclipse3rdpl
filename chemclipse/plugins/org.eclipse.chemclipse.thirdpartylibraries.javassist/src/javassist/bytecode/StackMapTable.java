...
public class StackMapTable extends AttributeInfo {
	 ...
	 *                if a <code>BadBytecode</code> exception is thrown while copying,
	 *                it is converted into <code>RuntimeCopyException</code>.
	 *
	 */
	...
	public static class Walker {
		 ...
		 *
		 * @param data
		 *            the <code>info</code> field of the <code>attribute_info</code> structure.
		 *            It can be obtained by <code>get()</code> in the <code>AttributeInfo</code> class.
		 */
		 ...
		 *
		 * @param pos
		 *            the position of the frame in the <code>info</code> field of <code>attribute_info</code> structure.
		 * @param nth
		 ...
		 *
		 * @param pos
		 *            the position of this frame in the <code>info</code> field of <code>attribute_info</code> structure.
		 * @param offsetDelta
		 */
		...
		/**
		 * Invoked if the visited frame is a <code>same_locals_1_stack_item_frame</code> or a <code>same_locals_1_stack_item_frame_extended</code>.
		 *
		 * @param pos
		 *            the position.
		 * @param offsetDelta
		 ...
		 * @param stackData
		 *            <code>stack[0].cpool_index</code> if the tag is <code>OBJECT</code>,
		 *            or <code>stack[0].offset</code> if the tag is <code>UNINIT</code>.
		 */
		 ...
		 * @param data
		 *            <code>locals[i].cpool_index</code> or <code>locals[i].offset</code>.
		 */
		 ...
		 * @param stackData
		 *            <code>stack[i].cpool_index</code> or <code>stack[i].offset</code>
		 */
		...
		/**
		 * Invoked if <code>Object_variable_info</code> or <code>Uninitialized_variable_info</code> is visited.
		 *
		 * @param tag
		 ...
		 * @param pos
		 *            the position of <code>cpool_index</code> or <code>offset</code>.
		 */
	 ...
	 * @param classInfo
	 *            the index of the <code>CONSTANT_Class_info</code> structure
	 ...
	 * descriptor. This method returns <code>INTEGER</code> unless the descriptor is either D (double), F (float),
	...
	public static class Writer {
		 ...
		 *            either 1, 2, or 3.
		 * @param data
		 *            <code>locals[].cpool_index</code> if the tag is <code>OBJECT</code>,
		 *            or <code>locals[].offset</code> if the tag is <code>UNINIT</code>.
		 *            Otherwise, this parameter is not used.
		 */
		...
		/**
		 * Writes a <code>full_frame</code>. <code>number_of_locals</code> and <code>number_of_stack_items</code> are specified by the the length of <code>localTags</code> and <code>stackTags</code>.
		 *
		 * @param localTags
		 *            <code>locals[].tag</code>.
		 * @param localData
		 ...
		 *            <code>stack[].tag</code>.
		 * @param stackData
		 *            <code>stack[].cpool_index</code> if the tag is <code>OBJECT</code>,
		 *            or <code>stack[].offset</code> if the tag is <code>UNINIT</code>.
		 *            Otherwise, this parameter is not used.
		 */
