 ...
 *
 * <p>
 * The bytecode sequence of the method is represented by a <code>CodeAttribute</code> object.
 * 
...
public class MethodInfo {
	 ...
	 * 
	 * <p>
	 * Note: only <code>Code</code> and <code>Exceptions</code> attributes are copied from the source. The other attributes are ignored.
	 * 
	 * @param cp
	 *            a constant pool table
	 * @param methodname
	 ...
	 * 
	 * <p>
	 * The added attribute must share the same constant pool table as this <code>method_info</code> structure.
	 */
	 ...
	 * 
	 * <p>
	 * This method modifies a call to <code>super()</code>, which should be at the head of a constructor body, so that a constructor in a different super class is called. This method does not change actual parameters. Hence the new super class must have a constructor with the same signature as the original one.
	 * 
	 * <p>
	 * This method should be called when the super class of the class declaring this method is changed.
	 * 
	 * <p>
	 * This method does not perform anything unless this <code>MethodInfo</code> represents a constructor.
	 * 
	 * @param superclass
	 *            the new super class
	 */
