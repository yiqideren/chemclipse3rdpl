...
/**
 * A class representing <code>RuntimeVisibleAnnotations_attribute</code> and <code>RuntimeInvisibleAnnotations_attribute</code>.
 *
 * <p>
 * To obtain an ParameterAnnotationAttribute object, invoke <code>getAttribute(ParameterAnnotationsAttribute.invisibleTag)</code> in <code>MethodInfo</code>. The obtained attribute is a runtime invisible annotations attribute. If the parameter is <code>ParameterAnnotationAttribute.visibleTag</code>, then the obtained attribute is a runtime visible one.
 */
public class ParameterAnnotationsAttribute extends AttributeInfo {

	/**
	 * The name of the <code>RuntimeVisibleParameterAnnotations</code> attribute.
	 */
	public static final String visibleTag = "RuntimeVisibleParameterAnnotations";
	/**
	 * The name of the <code>RuntimeInvisibleParameterAnnotations</code> attribute.
	 */
	 ...
	 *            constant pool
	 * @param attrname
	 *            attribute name (<code>visibleTag</code> or <code>invisibleTag</code>).
	 * @param info
	 *            the contents of this attribute. It does not
	 *            include <code>attribute_name_index</code> or <code>attribute_length</code>.
	 */
	...
	/**
	 * Constructs an empty <code>Runtime(In)VisibleParameterAnnotations_attribute</code>.
	 ...
	 * this object unless the tree is copied back to this object by <code>setAnnotations()</code>.
	 *
