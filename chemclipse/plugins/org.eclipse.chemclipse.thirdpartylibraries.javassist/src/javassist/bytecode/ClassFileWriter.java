...
public class ClassFileWriter {
	...
	public static final class MethodWriter {
		...
		/**
		 * Appends an <code>exception_table</code> entry to the <code>Code_attribute</code>. This method is available
	...
	public static final class ConstPoolWriter {
		 ...
		 *
		 * @param kind
		 *            <code>reference_kind</code> such as {@link ConstPool#REF_invokeStatic <code>REF_invokeStatic</code>}.
		 * @param index
