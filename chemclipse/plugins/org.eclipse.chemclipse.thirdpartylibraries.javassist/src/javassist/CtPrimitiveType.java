...
public final class CtPrimitiveType extends CtClass {
	 ...
	 * For example, if the type is int, then the wrapper class is <code>java.lang.Integer</code>.
	 */
	 ...
	 * For example, if the type is int, then the method name is <code>intValue</code>.
	 */
	 ...
	 * from the wrapper object.
	 * For example, if the type is int, then the method descriptor is <code>()I</code>.
	 */
	 ...
	 * For example, if the type is int, then the returned opcode is <code>javassit.bytecode.Opcode.IRETURN</code>.
	 */
	 ...
	 * For example, if the type is int, then this method returns <code>javassit.bytecode.Opcode.T_INT</code>.
	 */
