...
public class CtField extends CtMember {
	 ...
	 *
	 * <p>
	 * If getter and setter methods are needed, call <code>CtNewMethod.getter()</code> and <code>CtNewMethod.setter()</code>.
	 *
	 * @param type
	 *            field type
	 * @param name
	 ...
	 * file (read only).
	 * Normal applications do not need calling this method. Use <code>getFieldInfo()</code>.
	 *
	 * <p>
	 * The <code>FieldInfo</code> object obtained by this method is read only. Changes to this object might not be reflected on a class file generated by <code>toBytecode()</code>, <code>toClass()</code>, etc in <code>CtClass</code>.
	 *
	 * <p>
	 * This method is available even if the <code>CtClass</code> containing this field is frozen. However, if the class is frozen, the <code>FieldInfo</code> might be also pruned.
	 *
	 * @see #getFieldInfo()
	 ...
	 * If two fields have the same type, <code>getSignature()</code> returns the same string.
	 *
	 * <p>
	 * Note that the returned string is not the type signature contained in the <code>SignatureAttirbute</code>. It is a descriptor.
	 *
	 ...
	 * It represents a type including type variables.
	 * See {@link javassist.CtClass#setGenericSignature(String)} for a code sample.
	 *
	 * @param sig
	 ...
	 *
	 * @return a <code>Integer</code>, <code>Long</code>, <code>Float</code>, <code>Double</code>, <code>Boolean</code>,
	 *         or <code>String</code> object
	 *         representing the constant value. <code>null</code> if it is not a constant field
	 ...
	 *
	 * <p>
	 * Note that an attribute is a data block specified by the class file format. See {@link javassist.bytecode.AttributeInfo}.
	 *
	 * @param name
	 *            attribute name
	 */
	...
	// inner classes
	/**
	 * Instances of this class specify how to initialize a field. <code>Initializer</code> is passed to <code>CtClass.addField()</code> with a <code>CtField</code>.
	 *
	 * <p>
	 * This class cannot be instantiated with the <code>new</code> operator. Factory methods such as <code>byParameter()</code> and <code>byNew</code> must be used for the instantiation. They create a new instance with the given parameters and return it.
	 *
	...
	public static abstract class Initializer {
		 ...
		 * <code>String[] strs</code> - the character strings specified by <code>stringParams</code><br>
		 *
		 * <p>
		 * If the initialized field is static, then the constructor receives only <code>strs</code>.
		 *
		 * @param objectType
		 *            the class instantiated for the initial value.
		 * @param stringParams
		 ...
		 * <p>
		 * <code>Object obj</code> - the object including the field.<br>
		 * <code>Object[] args</code> - the parameters passed to the constructor of the object including the filed.
		 *
		 * <p>
		 * If the initialized field is static, then the constructor does not receive any parameters.
		 *
		 ...
		 *
		 * <p>
		 * If the initialized field is static, then the method receive only <code>strs</code>.
		 *
		 * <p>
		 * The type of the returned value must be the same as the field type.
		 *
		 ...
		 *            the type of the array.
		 * @param sizes
		 *            an <code>int</code> array of the size in every
		 *            dimension.
