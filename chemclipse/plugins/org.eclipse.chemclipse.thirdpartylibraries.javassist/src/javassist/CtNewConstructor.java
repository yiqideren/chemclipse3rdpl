 ...
 *
 * <p>
 * A class initializer (static constructor) cannot be created by the methods in this class. Call <code>makeClassInitializer()</code> in <code>CtClass</code> and append code snippet to the body of the class initializer obtained by <code>makeClassInitializer()</code>.
 *
...
public class CtNewConstructor {
	...
	/**
	 * Specifies that parameters are converted into an array of <code>Object</code> and passed to a super-class'
	 * constructor.
	 */
	 ...
	 * This is a convenience method for calling {@link CtConstructor#CtConstructor(CtConstructor, CtClass, ClassMap) this constructor}.
	 ...
	 *
	 * <p>
	 * The parameters passed to the created constructor should be used for field initialization. <code>CtField.Initializer</code> objects implicitly insert initialization code in constructor bodies.
	 *
	 * @param parameters
	 *            parameter types
	 * @param exceptions
	 ...
	 *
	 * <p>
	 * If <code>howto</code> is <code>PASS_PARAMS</code>, the created constructor calls the super's constructor with the same signature. The superclass must contain a constructor taking the same set of parameters as the created one.
	 *
	 * <p>
	 * If <code>howto</code> is <code>PASS_NONE</code>, the created constructor calls the super's default constructor. The superclass must contain a constructor taking no parameters.
	 *
	 * <p>
	 ...
	 *            constructor (<code>PASS_NONE</code>, <code>PASS_ARRAY</code>,
	 *            or <code>PASS_PARAMS</code>)
	 * @param body
	 *            appended body (may be <code>null</code>).
