...
public class ClassMap extends java.util.HashMap {
	 ...
	 *
	 * <p>
	 * If <code>oldname</code> is identical to <code>newname</code>, then this method does not perform anything; it does not record the mapping from <code>oldname</code> to <code>newname</code>. See <code>fix</code> method.
	 *
	 * @param oldname
	 *            the original class name.
	 * @param newname
	...
	/**
	 * Returns the class name to wihch the given <code>jvmClassName</code> is mapped. A subclass of this class should override this method.
	 *
	 * <p>
