 ...
 *
 * <p>
 * In some cases it might be necessary to use memory obtained from <code>malloc</code>. For example, <code>Memory</code> helps accomplish the following idiom:
 * 
 * <pre>
 ...
 *
 * <p>
 * The {@link #finalize} method will free allocated memory when this object is no longer referenced.
 *
...
public class Memory extends Pointer {
	...
	static {
		buffers = Collections.synchronizedMap(Platform.HAS_BUFFERS ? (Map)new WeakIdentityHashMap() : (Map)new HashMap());
	}
	...
	// ////////////////////////////////////////////////////////////////////////
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.read</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.read</code>. But this method performs a bounds checks to
	 * ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	// ////////////////////////////////////////////////////////////////////////
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.write</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	// ////////////////////////////////////////////////////////////////////////
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.getByte</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.getInt</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.getDouble</code>. But this method performs a
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.getPointer</code>. But this method performs
	...
	// ////////////////////////////////////////////////////////////////////////
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setByte</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	 * @see Pointer#setByte
	 */
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setChar</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	 * @see Pointer#setChar
	 */
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setShort</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setInt</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	 * @see Pointer#setInt
	 */
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setLong</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	 * @see Pointer#setLong
	 */
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setFloat</code>. But this method performs a bounds
	 * checks to ensure that the indirection does not cause memory outside the <code>malloc</code>ed space to be accessed.
	 *
	...
	/**
	 * Indirect the native pointer to <code>malloc</code> space, a la <code>Pointer.setPointer</code>. But this method performs
	 * a bounds checks to ensure that the indirection does not cause memory
	 * outside the <code>malloc</code>ed space to be accessed.
	 *
