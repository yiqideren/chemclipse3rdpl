...
/**
 * An abstraction for a native function pointer. An instance of <code>Function</code> represents a pointer to some native function. {@link #invoke(Class,Object[],Map)} is the primary means to call
 * the function.
 * <p/>
 * <a name=callflags></a> Function call behavior may be modified by passing one of the following call flags:
 * <ul>
 ...
 * <li>{@link Function#THROW_LAST_ERROR} Throw a {@link LastErrorException} if the native function sets the system error to a non-zero value (errno or GetLastError). Setting this flag will cause the system error to be cleared prior to native function invocation.
 * </ul>
 *
...
public class Function extends Pointer {
	...
	/**
	 * Any argument which implements this interface will have the {@link #read} method called immediately after function invocation.
	 */
	...
	public Object invoke(Class returnType, Object[] inArgs, Map options) {
		...
		for(int i = 0; i < args.length; i++) {
			Class paramType = invokingMethod != null ? (isVarArgs(invokingMethod) && i >= paramTypes.length - 1 ? paramTypes[paramTypes.length - 1].getComponentType() : paramTypes[i]) : null;
	 ...
	 *            Arguments to pass to the native function
	 * @param wide
	 *            whether the native string uses <code>wchar_t</code>;
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invokeObject(Object.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Pointer.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(String.class, args)} or {@link #invoke(Class,Object[]) invoke(WString.class, args)}
	 * 
	 * @param args
	 *            Arguments passed to native function
	 * @param wide
	 *            Whether the return value is of type <code>wchar_t*</code>;
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Integer.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Long.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Float.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Double.class, args)}.
	 */
	...
	/**
	 * Convenience method for {@link #invoke(Class,Object[]) invoke(Void.class, args)}.
	 */
