...
class NativeString implements CharSequence, Comparable {
	...
	/**
	 * Create a native string as a NUL-terminated array of <code>wchar_t</code> (if <code>wide</code> is true) or <code>char</code>.
	 * <p>
	 * If not <code>wide</code>, the encoding is obtained from {@link Native#getDefaultStringEncoding()}.
	 * 
	 * @param string
