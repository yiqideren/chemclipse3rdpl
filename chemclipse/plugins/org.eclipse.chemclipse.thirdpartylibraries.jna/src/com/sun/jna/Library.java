 ...
 *
 * Define an instance of your library like this: <code><pre>
 ...
 * Interface options will be automatically propagated to structures defined within the library provided a call to {@link Native#loadLibrary(String,Class,Map)} is made prior to instantiating any of those structures. One common way of ensuring this is to declare an <b>INSTANCE</b> field in the interface which holds the <code>loadLibrary</code> result.
 * <p>
 * <b>OPTIONS</b> (an instance of {@link Map}), <b>TYPE_MAPPER</b> (an instance of {@link TypeMapper}), <b>STRUCTURE_ALIGNMENT</b> (one of the alignment types defined in {@link Structure}), and <b>STRING_ENCODING</b> (a {@link String}) may also be defined. If no instance of the interface has been instantiated, these fields will be used to determine customization settings for structures and methods defined within the interface.
 * <p>
 * 
...
public interface Library {
	 ...
	 * pointer. <em>NOTE:</em> This is for use with raw JNI interactions via the
	...
	static class Handler implements InvocationHandler {
		...
		public Handler(String libname, Class interfaceClass, Map options) {
			...
			if(options.get(OPTION_CALLING_CONVENTION) == null) {
				options.put(OPTION_CALLING_CONVENTION, new Integer(callingConvention));
			}
