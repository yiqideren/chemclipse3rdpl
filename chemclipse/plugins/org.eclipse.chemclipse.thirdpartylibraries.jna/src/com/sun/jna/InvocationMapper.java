 ...
 * the options map with key {@link Library#OPTION_INVOCATION_MAPPER}.
 * <p>
 ...
 * <p>
 * For example, the GNU C library remaps the <code>stat</code> function into a call to <code>_xstat</code> with a slight rearrangement of arguments. A mapper for the GNU C library might look like the following:<br>
 * <blockquote> <code><pre>
 ...
 *     } 
 * } 
 * </pre></code> </blockquote> Another situation is where a header provides a function-like macro or inline function definition. <blockquote> <code><pre>
