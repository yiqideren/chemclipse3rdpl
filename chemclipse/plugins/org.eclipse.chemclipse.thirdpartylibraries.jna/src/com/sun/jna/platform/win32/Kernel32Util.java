...
public abstract class Kernel32Util implements WinDef {
	...
	/**
	 * Format a message from the value obtained from {@link Kernel32#GetLastError} or {@link Native#getLastError}.
	 * 
	 * @param code
	 *            int
	...
	public static String formatMessage(int code) {
		...
		if(0 == Kernel32.INSTANCE.FormatMessage(WinBase.FORMAT_MESSAGE_ALLOCATE_BUFFER | WinBase.FORMAT_MESSAGE_FROM_SYSTEM | WinBase.FORMAT_MESSAGE_IGNORE_INSERTS, null, code, 0, // TODO:
	 ...
	 *            is in the form of a string; the {@link Kernel32#GetPrivateProfileInt} function converts the
	 ...
	 *            parameter is {@code null}, the {@link Kernel32#GetPrivateProfileString} function copies all
	 ...
	 *            in the initialization file, {@link Kernel32#GetPrivateProfileString} returns the default.
