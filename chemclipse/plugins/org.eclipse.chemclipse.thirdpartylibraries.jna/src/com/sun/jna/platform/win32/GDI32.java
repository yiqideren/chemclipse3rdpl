...
public interface GDI32 extends StdCallLibrary {
	 ...
	 *         To get extended error information, call GetLastError.
	 */
	HRGN CreatePolyPolygonRgn(WinDef.POINT[] lppt, int[] lpPolyCounts, int nCount, int fnPolyFillMode);
	 ...
	 * @param lpbi
	 *            A pointer to a {@link BITMAPINFO} structure that specifies
	 *            the desired format for the DIB data.
	 * @param uUsage
	 *            The format of the bmiColors member of the {@link BITMAPINFO} structure.
	 */
