...
public class TypeLib extends Unknown implements ITypeLib {
	...
	/* [out] */BSTRByReference pBstrHelpFile) {
		...
		return (HRESULT)this._invokeNativeObject(9, new Object[]{this.getPointer(), index, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile}, HRESULT.class);
	}
	...
	/* [out] */BOOLByReference pfName) {
		...
		return (HRESULT)this._invokeNativeObject(10, new Object[]{this.getPointer(), szNameBuf, lHashVal, pfName}, HRESULT.class);
	}
	...
	/* [out][in] */USHORTByReference pcFound) {
		...
		return (HRESULT)this._invokeNativeObject(11, new Object[]{this.getPointer(), szNameBuf, lHashVal, ppTInfo, rgMemId, pcFound}, HRESULT.class);
	}
	...
	public void ReleaseTLibAttr(/* [in] */TLIBATTR pTLibAttr) {
		...
		this._invokeNativeObject(12, new Object[]{this.getPointer()}, HRESULT.class);
	}
}
