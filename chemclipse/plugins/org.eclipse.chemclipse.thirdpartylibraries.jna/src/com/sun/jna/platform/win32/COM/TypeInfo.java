...
public class TypeInfo extends Unknown implements ITypeInfo {
	...
	/* [out] */PointerByReference ppTypeAttr) {
		...
		return (HRESULT)this._invokeNativeObject(3, new Object[]{this.getPointer(), ppTypeAttr}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppTComp) {
		...
		return (HRESULT)this._invokeNativeObject(4, new Object[]{this.getPointer(), ppTComp}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppFuncDesc) {
		...
		return (HRESULT)this._invokeNativeObject(5, new Object[]{this.getPointer(), index, ppFuncDesc}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppVarDesc) {
		...
		return (HRESULT)this._invokeNativeObject(6, new Object[]{this.getPointer(), index, ppVarDesc}, HRESULT.class);
	}
	...
	/* [out] */UINTByReference pcNames) {
		...
		return (HRESULT)this._invokeNativeObject(7, new Object[]{this.getPointer(), memid, rgBstrNames, cMaxNames, pcNames}, HRESULT.class);
	}
	...
	/* [out] */HREFTYPEByReference pRefType) {
		...
		return (HRESULT)this._invokeNativeObject(8, new Object[]{this.getPointer(), index, pRefType}, HRESULT.class);
	}
	...
	/* [out] */IntByReference pImplTypeFlags) {
		...
		return (HRESULT)this._invokeNativeObject(9, new Object[]{this.getPointer(), index, pImplTypeFlags}, HRESULT.class);
	}
	...
	/* [size_is][out] */MEMBERID[] pMemId) {
		...
		return (HRESULT)this._invokeNativeObject(10, new Object[]{this.getPointer(), rgszNames, cNames, pMemId}, HRESULT.class);
	}
	...
	/* [out] */UINTByReference puArgErr) {
		...
		return (HRESULT)this._invokeNativeObject(11, new Object[]{this.getPointer(), pvInstance, memid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr}, HRESULT.class);
	}
	...
	/* [out] */BSTRByReference pBstrHelpFile) {
		...
		return (HRESULT)this._invokeNativeObject(12, new Object[]{this.getPointer(), memid, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile}, HRESULT.class);
	}
	...
	/* [out] */WORDByReference pwOrdinal) {
		...
		return (HRESULT)this._invokeNativeObject(13, new Object[]{this.getPointer(), memid, invKind, pBstrDllName, pBstrName, pwOrdinal}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppTInfo) {
		...
		return (HRESULT)this._invokeNativeObject(14, new Object[]{this.getPointer(), hRefType, ppTInfo}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppv) {
		...
		return (HRESULT)this._invokeNativeObject(15, new Object[]{this.getPointer(), memid, invKind, ppv}, HRESULT.class);
	}
	...
	/* [iid_is][out] */PointerByReference ppvObj) {
		...
		return (HRESULT)this._invokeNativeObject(16, new Object[]{this.getPointer(), pUnkOuter, riid, ppvObj}, HRESULT.class);
	}
	...
	/* [out] */BSTRByReference pBstrMops) {
		...
		return (HRESULT)this._invokeNativeObject(17, new Object[]{this.getPointer(), memid, pBstrMops}, HRESULT.class);
	}
	...
	/* [out] */UINTByReference pIndex) {
		...
		return (HRESULT)this._invokeNativeObject(18, new Object[]{this.getPointer(), ppTLib, pIndex}, HRESULT.class);
	}
