...
public class COMEarlyBindingObject extends COMBindingBaseObject implements IDispatch {
	...
	@Override
	public HRESULT Invoke(DISPID dispIdMember, IID riid, LCID lcid, DISPID wFlags, DISPPARAMS pDispParams, ByReference pVarResult, EXCEPINFO.ByReference pExcepInfo, IntByReference puArgErr) {
