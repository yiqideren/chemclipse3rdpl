...
public class TypeComp extends Unknown {
	...
	/* [out] */BINDPTR.ByReference pBindPtr) {
		...
		return (HRESULT)this._invokeNativeObject(3, new Object[]{this.getPointer(), szName, lHashVal, wFlags, ppTInfo, pDescKind, pBindPtr}, HRESULT.class);
	}
	...
	/* [out] */PointerByReference ppTComp) {
		...
		return (HRESULT)this._invokeNativeObject(4, new Object[]{this.getPointer(), szName, lHashVal, ppTInfo, ppTComp}, HRESULT.class);
	}
}
