...
public interface OleAuto extends StdCallLibrary {
	...
	/** The instance. */
	OleAuto INSTANCE = (OleAuto)Native.loadLibrary("OleAut32", OleAuto.class, W32APIOptions.UNICODE_OPTIONS);
	 ...
	 *         created.
	 */
	public SAFEARRAY.ByReference SafeArrayCreate(VARTYPE vt, int cDims, SAFEARRAYBOUND[] rgsabound);
	 ...
	 *            loaded.
	 */
	public HRESULT LoadRegTypeLib(GUID rguid, int wVerMajor, int wVerMinor, LCID lcid, PointerByReference pptlib);
	 ...
	 */
	public int SystemTimeToVariantTime(SYSTEMTIME lpSystemTime, DoubleByReference pvtime);
}
