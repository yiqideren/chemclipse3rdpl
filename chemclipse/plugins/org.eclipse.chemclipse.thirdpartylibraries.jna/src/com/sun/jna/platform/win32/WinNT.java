...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
	...
	int FILE_GENERIC_WRITE = STANDARD_RIGHTS_WRITE | SYNCHRONIZE | FILE_WRITE_DATA | FILE_WRITE_ATTRIBUTES | FILE_WRITE_EA | FILE_APPEND_DATA;
	...
	int KEY_ALL_ACCESS = STANDARD_RIGHTS_ALL | KEY_QUERY_VALUE | KEY_SET_VALUE | KEY_CREATE_SUB_KEY | KEY_ENUMERATE_SUB_KEYS | KEY_NOTIFY | KEY_CREATE_LINK & (~SYNCHRONIZE);
	//
	// Open/Create Options
	//
	/**
	...
	int REG_LEGAL_OPTION = REG_OPTION_RESERVED | REG_OPTION_NON_VOLATILE | REG_OPTION_VOLATILE | REG_OPTION_CREATE_LINK | REG_OPTION_BACKUP_RESTORE | REG_OPTION_OPEN_LINK;
	//
	...
	int REG_LEGAL_CHANGE_FILTER = REG_NOTIFY_CHANGE_NAME | REG_NOTIFY_CHANGE_ATTRIBUTES | REG_NOTIFY_CHANGE_LAST_SET | REG_NOTIFY_CHANGE_SECURITY;
	//
	...
	/**
	 * Describes the relationship between the specified processor set. This structure is used with the {@link Kernel32#GetLogicalProcessorInformation} function.
	 */
	public static class SYSTEM_LOGICAL_PROCESSOR_INFORMATION extends Structure {
		 ...
		 * This member can be one of {@link LOGICAL_PROCESSOR_RELATIONSHIP#RelationCache}, {@link LOGICAL_PROCESSOR_RELATIONSHIP#RelationNumaNode}, {@link LOGICAL_PROCESSOR_RELATIONSHIP#RelationProcessorCore} or {@link LOGICAL_PROCESSOR_RELATIONSHIP#RelationProcessorPackage}.
		 *
	...
	/**
	 * Represents the relationship between the processor set identified in the corresponding {@link SYSTEM_LOGICAL_PROCESSOR_INFORMATION} or <code>SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX</code> structure.
	 */
