...
public interface User32 extends StdCallLibrary, WinUser, WinNT {
	 ...
	 *         <tr>
	 *         <td>WAIT_TIMEOUT</td>
	 *         <td>The wait was terminated because the time-out interval elapsed.</td>
	 *         </tr>
	 *         <tr>
	 *         <td>WAIT_FAILED</td>
	 ...
	 * 
	 *         If the function fails, the return value is zero. To get extended
	 *         error information, call {@link Kernel32#GetLastError}. {@link WinUser#WM_HOTKEY} messages generated by the hot key {@link WinUser#WM_HOTKEY} message.<br/>
	 ...
	 *         <li>{@link WinUser#MOD_NOREPEAT} Changes the hotkey behavior so that the keyboard auto-repeat does not yield multiple hotkey notifications. <b><br/>
	 ...
	 *         <li>{@link WinUser#MOD_WIN} Either WINDOWS key was held down. These keys are labeled with the Windows logo.</li>
	 *         </ul>
	 */
	 ...
	 */
	public HWND CreateWindowEx(int dwExStyle, WString lpClassName, String lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, HWND hWndParent, HMENU hMenu, HINSTANCE hInstance, LPVOID lpParam);
	 ...
	 * 
	 * @param Handle
	 *            [in] Device notification handle returned by the
