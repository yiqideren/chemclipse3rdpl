 ...
 * <p>
 * When the image is no longer needed, invoke {@link #dispose}, which hides the graphic immediately, or {@link #returnToOrigin}, which moves the image to its original location and then disposes it.
 */
public class GhostedDragImage {
	 ...
	 * @param icon
	 *            image to be drawn
	 * @param initialScreenLoc
	 *            initial screen location of the image
	 */
