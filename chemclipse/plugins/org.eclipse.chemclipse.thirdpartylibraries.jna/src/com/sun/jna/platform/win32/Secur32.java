...
public interface Secur32 extends StdCallLibrary {
	 ...
	 * @param len
	 *            On input, the size of the buffer, on output the number of characters copied into the buffer, not including the terminating null character.
	 ...
	 */
	public int AcquireCredentialsHandle(String pszPrincipal, String pszPackage, int fCredentialUse, LUID pvLogonID, Pointer pAuthData, Pointer pGetKeyFn, // TODO: SEC_GET_KEY_FN
			Pointer pvGetKeyArgument, CredHandle phCredential, TimeStamp ptsExpiry);
	 ...
	 *         If the function fails, the function returns one of the SEC_E_ error codes.
	 */
	public int InitializeSecurityContext(CredHandle phCredential, CtxtHandle phContext, String pszTargetName, int fContextReq, int Reserved1, int TargetDataRep, SecBufferDesc pInput, int Reserved2, CtxtHandle phNewContext, SecBufferDesc pOutput, IntByReference pfContextAttr, TimeStamp ptsExpiry);
	 ...
	 */
	public int AcceptSecurityContext(CredHandle phCredential, CtxtHandle phContext, SecBufferDesc pInput, int fContextReq, int TargetDataRep, CtxtHandle phNewContext, SecBufferDesc pOutput, IntByReference pfContextAttr, TimeStamp ptsTimeStamp);
	 ...
	 */
	public int EnumerateSecurityPackages(IntByReference pcPackages, PSecPkgInfo ppPackageInfo);
	 ...
	 */
	public int QuerySecurityContextToken(CtxtHandle phContext, HANDLEByReference phToken);
