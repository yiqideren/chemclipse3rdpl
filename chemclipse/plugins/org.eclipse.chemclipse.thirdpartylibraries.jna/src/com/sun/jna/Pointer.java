 ...
 * be any <em>type</em> of native pointer. Methods such as <code>write</code>, <code>read</code>, <code>getXXX</code>, and <code>setXXX</code>, provide
...
public class Pointer {
	...
	/**
	 * Returns a hashcode for the native pointer represented by this <code>Pointer</code> object
	 *
	 ...
	 * @param buf
	 *            <code>byte</code> array into which data is copied
	 * @param index
	 ...
	 * @param buf
	 *            <code>short</code> array into which data is copied
	 * @param index
	 ...
	 *            byte offset from pointer from which data is copied
	 * @param buf
	 *            <code>float</code> array into which data is copied
	 * @param index
	 *            array index to which data is copied
	 * @param length
	 *            number of elements from native pointer that must be copied
	 ...
	 *            byte offset from pointer from which data is copied
	 * @param buf
	 *            <code>double</code> array into which data is copied
	 * @param index
	 *            array index to which data is copied
	 * @param length
	 *            number of elements from native pointer that must be copied
	 ...
	 *            byte offset from pointer from which data is copied
	 * @param buf
	 *            {@link Pointer} array into which data is copied
	 * @param index
	 *            array index to which data is copied
	 * @param length
	 *            number of elements from native pointer that must be copied
	 ...
	 *            byte offset from pointer into which data is copied
	 * @param buf
	 *            <code>byte</code> array from which to copy
	 * @param index
	 *            array index from which to start copying
	 * @param length
	 ...
	 *            byte offset from pointer into which data is copied
	 * @param buf
	 *            <code>short</code> array from which to copy
	 * @param index
	 *            array index from which to start copying
	 * @param length
	 *            number of elements from <code>buf</code> that must be
	 ...
	 *            byte offset from pointer into which data is copied
	 * @param buf
	 *            <code>long</code> array from which to copy
	 * @param index
	 *            array index from which to start copying
	 * @param length
	 *            number of elements from <code>buf</code> that must be
	 ...
	 *            byte offset from pointer into which data is copied
	 * @param buf
	 *            <code>float</code> array from which to copy
	 * @param index
	 *            array index from which to start copying
	 * @param length
	 *            number of elements from <code>buf</code> that must be
	 ...
	 *            byte offset from pointer into which data is copied
	 * @param buf
	 *            <code>Pointer</code> array from which to copy
	 * @param index
	 *            array index from which to start copying
	 * @param length
	 *            number of elements from <code>buf</code> that must be
	 ...
	 * equivalent to the expression <code>*((jbyte *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 ...
	 * is equivalent to the expression <code>*((wchar_t*)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            offset from pointer to perform the indirection
	 ...
	 * equivalent to the expression <code>*((jshort *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 ...
	 * equivalent to the expression <code>*((jint *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	 ...
	 * equivalent to the expression <code>*((jlong *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	...
	/**
	 * Indirect the native pointer as a pointer to <code>long</code>. This is
	 * equivalent to the expression <code>*((long *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	 * @return the <code>long</code> value being pointed to
	 ...
	 * equivalent to the expression <code>*((jfloat *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	 ...
	 * is equivalent to the expression <code>*((jdouble *)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	 ...
	 * to the expression <code>*((void **)((char *)Pointer + offset))</code>.
	 *
	 * @param offset
	 *            byte offset from pointer to perform the indirection
	 * @return a {@link Pointer} equivalent of the pointer value
	 *         being pointed to, or <code>null</code> if the pointer value is <code>NULL</code>;
	 */
	 ...
	 * 
	 * @deprecated use {@link #getString(long,String)} or {@link #getWideString(long)} instead.
	 */
	 ...
	 * <p/>
	 * The strings are decoded using the encoding returned by {@link Native#getDefaultStringEncoding()}.
	 */
	...
	/**
	 * Returns an array of <code>String</code> based on a native array
	 * of <code>char*</code> or <code>wchar_t*</code> based on the <code>wide</code> parameter. The array length is determined by a
	 * NULL-valued terminating element.
	 * 
	 * @deprecated use {@link #getStringArray(long,String)} or {@link #getWideStringArray(long)} instead.
	 */
	...
	/**
	 * Returns an array of <code>String</code> based on a native array
	 * of <code>char*</code> or <code>wchar_t*</code> based on the <code>wide</code> parameter, using the given array length.
	 * 
	 * @deprecated use {@link #getStringArray(long,int,String)} or {@link #getWideStringArray(long,int)} instead.
	 */
	 ...
	 * to the expression <code>*((jbyte *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((jshort *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	 *            <code>short</code> value to set
	 */
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((wchar_t *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	 *            <code>char</code> value to set
	 */
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((jint *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((jlong *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((long *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((jfloat *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((jdouble *)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	...
	/**
	 * Set <code>value</code> at location being pointed to. This is equivalent
	 * to the expression <code>*((void **)((char *)Pointer + offset)) = value</code>.
	 *
	 * @param offset
	 *            byte offset from pointer at which <code>value</code> must be set
	 * @param value
	 *            <code>Pointer</code> holding the actual pointer value to
	 *            set, which may be <code>null</code> to indicate a <code>NULL</code> pointer.
	 */
	 ...
	 *
	 * @param offset
	 *            byte offset from pointer at which characters in <code>value</code> must be set
	 * @param value
	 *            <code>java.lang.String</code> value to set
	 * @param wide
	 *            whether to write the native string as an array of <code>wchar_t</code>. If false, writes as a NUL-terminated array of <code>char</code> using the encoding indicated by {@link Native#getDefaultStringEncoding()}.
	 * 
	 ...
	 *            byte offset from pointer at which characters in <code>value</code> must be set
	 * @param value
	 *            <code>WString</code> value to set
	 */
	 ...
	 * pointed to, using the encoding indicated by {@link Native#getDefaultStringEncoding()}.
	 *
	 * @param offset
	 *            byte offset from pointer at which characters in <code>value</code> must be set
	 * @param value
