 ...
 * then the value must be {@literal @Foo(Color.Green)}. And if you know it is {@literal @Foo(Color.Green)}, you know it cannot be {@literal @Foo(Color.Red)} or {@literal @Foo(Color.Blue)}
 * 
 * <code>
 * 
