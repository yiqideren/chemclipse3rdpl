...
public enum FilterType {
	 ...
	 * <p>
	 * When this filter is used, the wrapped {@link EventHandler
	 * event handler} {@link EventHandler#eventOccurred(double, double[], boolean) eventOccurred} method will be called <em>only</em> with its {@code increasing} argument set to false.
	 * </p>
	 */
	 ...
	 * <p>
	 * When this filter is used, the wrapped {@link EventHandler
	 * event handler} {@link EventHandler#eventOccurred(double, double[], boolean) eventOccurred} method will be called <em>only</em> with its {@code increasing} argument set to true.
	 * </p>
	 */
