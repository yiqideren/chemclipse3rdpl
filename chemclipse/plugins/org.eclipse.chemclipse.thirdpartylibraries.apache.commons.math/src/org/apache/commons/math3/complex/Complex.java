 ...
 * point numbers (according to which the test {@code x == x} must fail if {@code x} is {@code NaN}). The method {@link org.apache.commons.math3.util.Precision#equals(double,double,int)
 * equals for primitive double} in {@link org.apache.commons.math3.util.Precision} conforms with IEEE-754 while this class conforms with the standard behavior
...
public class Complex implements FieldElement<Complex>, Serializable {
	 ...
	 * <ul>
	 * <li>If either {@code this} or {@code divisor} has a {@code NaN} value in either part, {@link #NaN} is returned.</li>
	 ...
	 * <li>If {@code this} is finite (i.e., has no {@code Infinite} or {@code NaN} parts) and {@code divisor} is infinite (one or both parts infinite), {@link #ZERO} is returned.</li>
	 * <li>If {@code this} is infinite and {@code divisor} is finite, {@code NaN} values are returned in the parts of the result if the {@link java.lang.Double} rules applied to the definitional formula force {@code NaN} results.</li>
	 * </ul>
	 *
	 * @param divisor
	 ...
	 * Double}:
	 * <ul>
	 * <li>All {@code NaN} values are considered to be equal, i.e, if either (or both) real and imaginary parts of the complex number are equal to {@code Double.NaN}, the complex number is equal to {@code NaN}.</li>
	 * <li>
	 * Instances constructed with different representations of zero (i.e. either "0" or "-0") are <em>not</em> considered to be equal.</li>
	 * </ul>
	 *
	 * @param other
	 *            Object to test for equality with this instance.
	 ...
	 *
	 * @param x
	 *            First value (cannot be {@code null}).
	 * @param y
	 *            Second value (cannot be {@code null}).
	 * @param maxUlps
