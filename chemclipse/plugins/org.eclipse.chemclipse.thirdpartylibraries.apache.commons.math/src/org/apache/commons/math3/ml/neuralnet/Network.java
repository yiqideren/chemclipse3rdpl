...
public class Network implements Iterable<Neuron>, Serializable {
	 ...
	 * @param neuronList
	 *            Neurons.
	 * @param neighbourIdList
	 *            Links associated to each of the neurons in {@code neuronList}.
	 ...
	 *
	 * @param comparator
	 *            {@link Comparator} used for sorting the neurons.
	 ...
	 *
	 * @param features
	 *            Initial values for the neuron's features.
	 * @return the neuron's identifier.
	 * @throws DimensionMismatchException
	 *             if the length of {@code features} is different from the expected size (as set by the {@link #Network(long,int) constructor}).
	 */
	 ...
	 *
	 * @param neuron
	 *            Neuron to be removed from this network.
	 * @throws NoSuchElementException
	 *             if {@code n} does not belong to
	 *             this network.
	 */
	 ...
	 *
	 * @param neuron
	 *            Neuron for which to retrieve the neighbours.
	 * @return the list of neighbours.
