 ...
 * </p>
 * <p>
 * Multistep integrators with Nordsieck representation are highly sensitive to large step changes because when the step is multiplied by factor a, the k<sup>th</sup> component of the Nordsieck vector is multiplied by a<sup>k</sup> and the last components are the least accurate ones. The default max growth factor is therefore set to a quite low value: 2<sup>1/order</sup>.
 * </p>
 *
