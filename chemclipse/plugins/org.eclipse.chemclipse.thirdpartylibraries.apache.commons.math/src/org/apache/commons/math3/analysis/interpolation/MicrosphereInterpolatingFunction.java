...
public class MicrosphereInterpolatingFunction implements MultivariateFunction {
	...
	/**
	 * @param xval
	 *            Arguments for the interpolation points. {@code xval[i][0]} is the first component of interpolation point {@code i}, {@code xval[i][1]} is the second component, and so on
	 ...
	 *             if the lengths of {@code yval} and {@code xval} (equal to {@code n}, the number of interpolation points)
