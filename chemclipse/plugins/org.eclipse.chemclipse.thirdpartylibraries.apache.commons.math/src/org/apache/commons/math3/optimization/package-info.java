 ...
 */
/**
 * <h2>All classes and sub-packages of this package are deprecated.</h2> <h3>Please use their replacements, to be found under
 * <ul>
 ...
 * MultivariateDifferentiableOptimizer} for {@link org.apache.commons.math3.analysis.differentiation.MultivariateDifferentiableFunction
 ...
 * MultivariateDifferentiableVectorOptimizer} for {@link org.apache.commons.math3.analysis.differentiation.MultivariateDifferentiableVectorFunction
 * multivariate differentiable vectorial functions}</li>
 * </ul>
 * </p>
 *
 * <p>
 * Despite there are only four types of supported optimizers, it is possible to optimize a transform a {@link org.apache.commons.math3.analysis.MultivariateVectorFunction
 * non-differentiable multivariate vectorial function} by converting it to a {@link org.apache.commons.math3.analysis.MultivariateFunction non-differentiable multivariate
 * real function} thanks to the {@link org.apache.commons.math3.optimization.LeastSquaresConverter LeastSquaresConverter} helper class. The transformed function can be optimized using any implementation of the {@link org.apache.commons.math3.optimization.MultivariateOptimizer MultivariateOptimizer} interface.
 * </p>
 *
 * <p>
