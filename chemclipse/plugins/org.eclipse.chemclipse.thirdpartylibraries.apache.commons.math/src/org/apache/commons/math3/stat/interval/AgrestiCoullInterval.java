 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Binomial_proportion_confidence_interval#Agresti-Coull_Interval"> Agresti-Coull interval (Wikipedia)</a>
 * @since 3.3
 */
public class AgrestiCoullInterval implements BinomialConfidenceInterval {
	...
	public ConfidenceInterval createInterval(int numberOfTrials, int numberOfSuccesses, double confidenceLevel) {
		...
		final double difference = z * FastMath.sqrt(1.0 / modifiedNumberOfTrials * modifiedSuccessesRatio * (1 - modifiedSuccessesRatio));
