...
public class FastHadamardTransformer implements RealTransformer, Serializable {
	 ...
	 * to M[n][N])</em></li>
	 * <li>Place the input vector {@code x[N]} in the first column of the matrix {@code hadm}.</li>
	 ...
	 * <li>the columns of {@code D_top} are the pairwise mutually exclusive sums of the previous column.</li>
	 * </ul>
	 * </li>
	 ...
	 * <li>the columns of {@code D_bottom} are the pairwise differences of the previous column.</li>
	 * </ul>
	 * </li>
	 * <li>The consputation of {@code D_top} and {@code D_bottom} are best understood with the above example (for {@code N = 8}).
	 ...
	 *
	 * @param x
	 *            the integer data array to be transformed
