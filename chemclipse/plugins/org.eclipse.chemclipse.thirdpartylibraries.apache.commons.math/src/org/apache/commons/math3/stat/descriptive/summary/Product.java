 ...
 * <p>
 * If there are no values in the dataset, then 1 is returned. If any of the values are <code>NaN</code>, then <code>NaN</code> is returned.
 * </p>
 * <p>
...
public class Product extends AbstractStorelessUnivariateStatistic implements Serializable, WeightedEvaluation {
	...
	/**
	 * <p>
	 * Returns the weighted product of the entries in the specified portion of the input array, or <code>Double.NaN</code> if the designated subarray is empty.
	 * </p>
	 *
	 * <p>
