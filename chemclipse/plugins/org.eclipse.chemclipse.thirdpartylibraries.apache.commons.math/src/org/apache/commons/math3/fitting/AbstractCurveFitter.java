 ...
 * the independent variable and the <code>p<sub>i</sub></code> are the <em>parameters</em>. <br/>
 * A fitter will find the optimal values of the parameters by <em>fitting</em> the curve so it remains very close to a set of {@code N} observed points <code>(x<sub>k</sub>, y<sub>k</sub>)</code>, {@code 0 <= k < N}. <br/>
