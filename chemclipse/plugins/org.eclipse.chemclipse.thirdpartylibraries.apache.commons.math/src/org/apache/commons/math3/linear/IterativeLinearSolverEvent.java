...
/**
 * This is the base class for all events occurring during the iterations of a {@link IterativeLinearSolver}.
 *
 * @since 3.0
 */
public abstract class IterativeLinearSolverEvent extends IterationEvent {
	 ...
	 * be <em>exact</em>. Instead, the norm of the so-called <em>updated</em> residual (if available) should be returned. For example, the {@link ConjugateGradient conjugate gradient} method computes a sequence
