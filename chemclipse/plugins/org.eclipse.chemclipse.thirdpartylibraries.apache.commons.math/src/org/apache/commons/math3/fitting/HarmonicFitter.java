...
public class HarmonicFitter extends CurveFitter<HarmonicOscillator.Parametric> {
	 ...
	 *
	 * <p>
	 * We know f (t) at some sampling points t<sub>i</sub> and want to find a, &omega; and &phi; such that f (t) = a cos (&omega; t + &phi;).
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * The preceding expression shows that If'2 (t) is a linear combination of both t and If2 (t): If'2 (t) = A &times; t + B &times; If2 (t)
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * It appears that <code>fc = a &omega; cos (&phi;)</code> and <code>fs = -a &omega; sin (&phi;)</code>, so we can use these expressions to compute &phi;. The best estimate over the sample is given by averaging these expressions.
	 * </p>
	 *
	 * <p>
	...
	public static class ParameterGuesser {
		 ...
		 *
		 * @param observations
		 *            Observations, sorted w.r.t. abscissa.
		 * @throws ZeroException
		 *             if the abscissa range is zero.
		 * @throws MathIllegalStateException
		 *             when the guessing procedure cannot
