 ...
 * <p>
 * The Fuzzy K-Means algorithm is a variation of the classical K-Means algorithm, with the major difference that a single data point is not uniquely assigned to a single cluster. Instead, each point i has a set of weights u<sub>ij</sub> which indicate the degree of membership to the cluster j.
 * <p>
...
public class FuzzyKMeansClusterer<T extends Clusterable> extends Clusterer<T> {
	 ...
	 * @param fuzziness
	 *            the fuzziness factor, must be &gt; 1.0
	 ...
	 *            the distance measure to use
	 * @param epsilon
	 *            the convergence criteria (default is 1e-3)
	 * @param random
	 ...
	 *
	 * @param matrix
	 *            the membership matrix of the previous iteration
