 ...
 * </p>
 * <p>
 * The {@code code map} and {@code mapToSelf} methods operate on vectors element-wise, i.e. they perform the same operation (adding a scalar, applying a function ...) on each element in turn. The {@code map} versions create a new vector to hold the result and do not change the instance. The {@code mapToSelf} version uses the instance itself to store the results, so the instance is changed by this method. In all cases, the result vector is returned by the methods, allowing the <i>fluent API</i>
 * style, like this:
 * </p>
 * 
 * <pre>
...
public abstract class RealVector {
	 ...
	 * <p>
	 * This method computes the distance consistent with the L<sub>2</sub> norm, i.e. the square root of the sum of element differences, or Euclidean distance.
	 * </p>
	 *
	 * @param v
	 ...
	 * Distance between two vectors.
	 * <p>
	 * This method computes the distance consistent with L<sub>1</sub> norm, i.e. the sum of the absolute values of the elements differences.
	 * </p>
	 *
	 * @param v
	 *            Vector to which distance is requested.
	 ...
	 * Distance between two vectors.
	 * <p>
	 * This method computes the distance consistent with L<sub>&infin;</sub> norm, i.e. the max of the absolute values of element differences.
	 * </p>
	 *
	 * @param v
	 *            Vector to which distance is requested.
