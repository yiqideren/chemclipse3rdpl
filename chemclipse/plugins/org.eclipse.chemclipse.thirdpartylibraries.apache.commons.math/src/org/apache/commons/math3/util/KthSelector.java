...
public class KthSelector implements Serializable {
	 ...
	 *
	 * @param work
	 *            work array to use to find out the K<sup>th</sup> value
	 * @param pivotsHeap
	 *            cached pivots heap that can be used for efficient estimation
	 * @param k
	 *            the index whose value in the array is of interest
	 ...
	 *            work array
	 * @param begin
	 *            index of the first element of the slice of work array
	 * @param end
	 *            index after the last element of the slice of work array
	 * @param pivot
