 ...
 * where {@code x} is the (integer) independent variable. <br/>
 * Class is immutable.
 *
 * @since 3.3
 */
public class ExponentialDecayFunction {
	 ...
	 *
	 * @param initValue
	 *            Initial value, i.e. {@link #value(long) value(0)}.
	 * @param valueAtNumCall
	 *            Value of the function at {@code numCall}.
	 * @param numCall
	 *            Argument for which the function returns {@code valueAtNumCall}.
	 ...
	 *
	 * @param numCall
	 *            Current step of the training task.
