 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Convex_hull_algorithms#Akl-Toussaint_heuristic"> Akl-Toussaint heuristic (Wikipedia)</a>
 * @since 3.3
 */
public final class AklToussaintHeuristic {
	 ...
	 *
	 * @param points
	 *            the respective points with min/max x/y coordinate
