 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Binomial_proportion_confidence_interval#Normal_approximation_interval"> Normal approximation interval (Wikipedia)</a>
 * @since 3.3
 */
public class NormalApproximationInterval implements BinomialConfidenceInterval {
	...
	public ConfidenceInterval createInterval(int numberOfTrials, int numberOfSuccesses, double confidenceLevel) {
		...
		final double difference = normalDistribution.inverseCumulativeProbability(1 - alpha) * FastMath.sqrt(1.0 / numberOfTrials * mean * (1 - mean));
