...
public class FastMath {
	 ...
	 *
	 * @param base
	 *            Base of the logarithm, must be greater than 0.
	 * @param x
	 ...
	 *            base number
	 * @param direction
	 *            (the only important thing is whether {@code direction} is greater or smaller than {@code d})
	 ...
	 *            base number
	 * @param direction
	 *            (the only important thing is whether {@code direction} is greater or smaller than {@code f})
	 * @return the next machine representable number in the specified direction
	 */
