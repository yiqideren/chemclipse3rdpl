...
public class BetaDistribution extends AbstractRealDistribution {
	 ...
	 * {@inheritDoc}
	 *
	 * For first shape parameter {@code alpha} and second shape parameter {@code beta}, the mean is {@code alpha / (alpha + beta)}.
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * For first shape parameter {@code alpha} and second shape parameter {@code beta}, the variance is {@code (alpha * beta) / [(alpha + beta)^2 * (alpha + beta + 1)]}.
	 */
