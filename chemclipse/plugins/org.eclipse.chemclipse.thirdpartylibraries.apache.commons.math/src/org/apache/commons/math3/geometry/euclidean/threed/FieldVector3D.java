...
public class FieldVector3D<T extends RealFieldElement<T>> implements Serializable {
	 ...
	 * <p>
	 * If all coordinates of two 3D vectors are exactly the same, and none of their {@link RealFieldElement#getReal() real part} are <code>NaN</code>, the two 3D vectors are considered to be equal.
	 * </p>
	 * <p>
	 * <code>NaN</code> coordinates are considered to affect globally the vector and be equals to each other - i.e, if either (or all) real part of the coordinates of the 3D vector are <code>NaN</code>, the 3D vector is <code>NaN</code>.
	 * </p>
	 *
	 * @param other
