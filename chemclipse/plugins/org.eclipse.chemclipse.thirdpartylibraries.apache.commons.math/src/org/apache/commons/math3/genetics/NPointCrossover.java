...
public class NPointCrossover<T> implements CrossoverPolicy {
	 ...
	 * <p>
	 * <b>Note</b>: the number of crossover points must be &lt; <code>chromosome length - 1</code>. This condition can only be checked at runtime, as the chromosome length is not known in advance.
	 *
