...
public class DefaultIterativeLinearSolverEvent extends IterativeLinearSolverEvent {
	...
	/**
	 * Creates a new instance of this class. This implementation does <em>not</em> deep copy the specified vectors {@code x}, {@code b}, {@code r}. Therefore the user must make sure that these vectors are
	...
	/**
	 * Creates a new instance of this class. This implementation does <em>not</em> deep copy the specified vectors {@code x}, {@code b}.
	 ...
	 * {@inheritDoc}
	 *
	 * This implementation throws an {@link MathUnsupportedOperationException} if no residual vector {@code r} was provided at construction time.
	 */
	@Override
