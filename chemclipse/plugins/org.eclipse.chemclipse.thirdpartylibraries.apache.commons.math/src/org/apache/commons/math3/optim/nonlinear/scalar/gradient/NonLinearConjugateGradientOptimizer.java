...
public class NonLinearConjugateGradientOptimizer extends GradientMultivariateOptimizer {
	 ...
	 * @deprecated as of 3.3. Please use {@link #NonLinearConjugateGradientOptimizer(Formula,ConvergenceChecker,double,double,double)} instead.
	 */
	@Deprecated
	 ...
	 *            Relative threshold for line search.
	 * @param absoluteTolerance
	 *            Absolute threshold for line search.
	 * @param initialBracketingRange
	 ...
	 *            Preconditioner.
	 * @deprecated as of 3.3. Please use {@link #NonLinearConjugateGradientOptimizer(Formula,ConvergenceChecker,double,double,double,Preconditioner)} instead.
	 */
	@Deprecated
