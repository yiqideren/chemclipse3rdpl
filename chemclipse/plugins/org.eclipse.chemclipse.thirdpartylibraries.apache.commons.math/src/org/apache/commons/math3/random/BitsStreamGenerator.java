...
public abstract class BitsStreamGenerator implements RandomGenerator, Serializable {
	 ...
	 *
	 * <li>If n is not a power of 2, what is returned is {@code next(31) % n} with {@code next(31)} values rejected (i.e. regenerated) until a value that is larger than the remainder of {@code Integer.MAX_VALUE / n} is generated. Rejection of this initial segment is necessary to ensure a uniform distribution.</li>
	 * </ul>
	 * </p>
	 */
