...
public class WilcoxonSignedRankTest {
	 ...
	 * </p>
	 * <p>
	 * Let X<sub>i</sub> denote the i'th individual of the first sample and Y<sub>i</sub> the related i'th individual in the second sample. Let Z<sub>i</sub> = Y<sub>i</sub> - X<sub>i</sub>.
	 * </p>
	 * <p>
	 * <strong>Preconditions</strong>:
	 * <ul>
	 * <li>The differences Z<sub>i</sub> must be independent.</li>
	 * <li>Each Z<sub>i</sub> comes from a continuous population (they must be identical) and is symmetric about a common median.</li>
	 * <li>The values that X<sub>i</sub> and Y<sub>i</sub> represent are ordered, so the comparisons greater than, less than, and equal to are meaningful.</li>
	 * </ul>
	 * </p>
	 *
	 * @param x
