 ...
 * </p>
 * <p>
 * <b>Note:</b> using "," as a separator may interfere with the grouping separator of the default {@link NumberFormat} for the current locale. Thus it is advised to use a {@link NumberFormat} instance with disabled grouping in such a case.
 * </p>
 *
 * @since 3.0
 */
