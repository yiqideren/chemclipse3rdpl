...
/**
 * <p>
 * This is an implementation of the conjugate gradient method for {@link RealLinearOperator}. It follows closely the template by <a href="#BARR1994">Barrett et al. (1994)</a> (figure 2.5). The linear system at hand is A &middot; x = b, and the residual is r = b - A &middot; x.
 * </p>
 * <h3><a id="stopcrit">Default stopping criterion</a></h3>
 * <p>
 * A default stopping criterion is implemented. The iterations stop when || r || &le; &delta; || b ||, where b is the right-hand side vector, r the current estimate of the residual, and &delta; a user-specified tolerance. It should be noted that r is the so-called <em>updated</em> residual, which might differ from the true residual due to rounding-off errors (see e.g. <a href="#STRA2002">Strakos and Tichy, 2002</a>).
 * </p>
 * <h3>Iteration count</h3>
 * <p>
 * In the present context, an iteration should be understood as one evaluation of the matrix-vector product A &middot; x. The initialization phase therefore counts as one iteration.
 * </p>
 ...
 * <li>key {@code "vector"} points to the offending vector, say x, such that x<sup>T</sup> &middot; L &middot; x < 0.</li>
 * </ul>
 * </p>
 * <h3>References</h3>
 * <dl>
 ...
 * <dt>
 * <dd>Z. Strakos and P. Tichy, <a href="http://etna.mcs.kent.edu/vol.13.2002/pp56-80.dir/pp56-80.pdf"> <em>On error estimation in the conjugate gradient method and why it works
