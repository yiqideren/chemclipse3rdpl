...
public class LineSearch {
	 ...
	 * values.
	 * The {@code relativeTolerance} and {@code absoluteTolerance} arguments are thus passed to a {@link SimpleUnivariateValueChecker
	 ...
	 *            computeObjectiveValue} method will be called by the {@link #search(double[],double[]) search} method.
