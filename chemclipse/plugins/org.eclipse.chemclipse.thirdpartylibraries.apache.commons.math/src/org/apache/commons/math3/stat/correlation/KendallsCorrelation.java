 ...
 * <p>
 * A pair of observations (x<sub>1</sub>, y<sub>1</sub>) and (x<sub>2</sub>, y<sub>2</sub>) are considered <i>concordant</i> if x<sub>1</sub> &lt; x<sub>2</sub> and y<sub>1</sub> &lt; y<sub>2</sub> or x<sub>2</sub> &lt; x<sub>1</sub> and y<sub>2</sub> &lt; y<sub>1</sub>. The pair is <i>discordant</i> if x<sub>1</sub> &lt; x<sub>2</sub> and y<sub>2</sub> &lt; y<sub>1</sub> or x<sub>2</sub> &lt; x<sub>1</sub> and y<sub>1</sub> &lt; y<sub>2</sub>. If either x<sub>1</sub> = x<sub>2</sub> or
 * y<sub>1</sub> = y<sub>2</sub>, the pair is neither concordant nor discordant.
 * <p>
 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Kendall_tau_rank_correlation_coefficient"> Kendall tau rank correlation coefficient (Wikipedia)</a>
