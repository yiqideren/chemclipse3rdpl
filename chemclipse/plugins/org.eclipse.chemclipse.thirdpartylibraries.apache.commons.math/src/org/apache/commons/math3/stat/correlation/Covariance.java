 ...
 *
 * <p>
 * The constructors that take <code>RealMatrix</code> or <code>double[][]</code> arguments generate covariance matrices. The columns of the input matrices are assumed to represent variable values.
 * </p>
 *
 * <p>
 * The constructor argument <code>biasCorrected</code> determines whether or not computed covariances are bias-corrected.
 * </p>
 *
 * <p>
 * Unbiased covariances are given by the formula
 * </p>
 * <code>cov(X, Y) = &Sigma;[(x<sub>i</sub> - E(X))(y<sub>i</sub> - E(Y))] / (n - 1)</code> where <code>E(X)</code> is the mean of <code>X</code> and <code>E(Y)</code> is the mean of the <code>Y</code> values.
 *
 * <p>
