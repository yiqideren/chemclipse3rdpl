 ...
 * <p>
 * The Cholesky decomposition of a real symmetric positive-definite matrix A consists of a lower triangular matrix L with same size such that: A = LL<sup>T</sup>. In a sense, this is the square root of A.
 * </p>
 * <p>
 ...
 * <li>the {@code isspd} method has been removed, since the constructor of this class throws a {@link NonPositiveDefiniteMatrixException} when a matrix cannot be decomposed,</li>
