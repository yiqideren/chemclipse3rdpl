...
public interface Region<S extends Space> {
	 ...
	 * 
	 * @param node
	 *            root node of the sub-tree (<em>must</em> have {@link Region Region} tree semantics, i.e. the leaf nodes must have {@code Boolean} attributes representing an inside/outside
	 *            property)
