 ...
 * <p>
 * This implementation is based on the rjbesl Fortran routine at <a href="http://www.netlib.org/specfun/rjbesl">Netlib</a>.
 * </p>
 * <p>
...
public class BesselJ implements UnivariateFunction {
	 ...
	 *
	 * @param order
	 *            order of the function computed when using {@link #value(double)}.
	 */
	 ...
	 * <p>
	 * <ul>
	 * <li>nVals < 0: An argument is out of range. For example, nb <= 0, alpha < 0 or > 1, or x is too large. In this case, b(0) is set to zero, the remainder of the b-vector is not calculated, and nVals is set to MIN(nb,0) - 1 so that nVals != nb.</li>
