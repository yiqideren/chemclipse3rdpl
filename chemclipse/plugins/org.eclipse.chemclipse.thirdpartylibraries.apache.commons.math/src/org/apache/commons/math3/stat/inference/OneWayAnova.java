...
public class OneWayAnova {
	 ...
	 * <li>There must be at least two <code>double[]</code> arrays in the <code>categoryData</code> collection and each of these arrays must contain at least two values.</li>
	 * </ul>
	 * </p>
	 * <p>
	 ...
	 *             if the length of the <code>categoryData</code> array is less than 2 or a contained <code>double[]</code> array does not have
	 *             at least two values
	 */
	 ...
	 * <li>There must be at least two {@link SummaryStatistics} in the <code>categoryData</code> collection and each of these statistics must contain at least two values.</li>
	 * </ul>
	 * </p>
	 * <p>
	 * This implementation uses the {@link org.apache.commons.math3.distribution.FDistribution
	 ...
	 *
	 * @param categoryData
	 *            <code>Collection</code> of {@link SummaryStatistics} each containing data for one category
	 ...
	 *             if <code>categoryData</code> is <code>null</code>
	 * @throws DimensionMismatchException
	 *             if the length of the <code>categoryData</code> array is less than 2 or a contained {@link SummaryStatistics} does not have
	 *             at least two values
	 * @throws ConvergenceException
	 *             if the p-value can not be computed due to a convergence error
	 * @throws MaxCountExceededException
	 ...
	 *             if <code>categoryData</code> is <code>null</code>
	 * @throws DimensionMismatchException
	 *             if <code>allowOneElementData</code> is false and the number of
