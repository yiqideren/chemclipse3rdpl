 ...
 *
 * <p>
 * <b>Note:</b> the grouping functionality of the used {@link NumberFormat} is disabled to prevent problems when parsing (e.g. 1,345.34 would be a valid number but conflicts with the default column separator).
 * </p>
 *
 * @since 3.1
 */
