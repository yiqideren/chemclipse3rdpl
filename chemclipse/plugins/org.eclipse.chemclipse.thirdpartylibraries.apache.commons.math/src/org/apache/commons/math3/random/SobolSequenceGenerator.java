 ...
 * <p>
 * The implementation already comes with support for up to 1000 dimensions with direction numbers calculated from <a href="http://web.maths.unsw.edu.au/~fkuo/sobol/">Stephen Joe and Frances Kuo</a>.
 * <p>
...
public class SobolSequenceGenerator implements RandomVectorGenerator {
	 ...
	 * <p>
	 * The expected format is identical to the files available from <a href="http://web.maths.unsw.edu.au/~fkuo/sobol/">Stephen Joe and Frances Kuo</a>. The first line will be ignored as it is assumed to contain only the column headers. The columns are:
	 * <ul>
	 ...
	 *            the space dimension
	 * @param is
	 *            the stream to read the direction vectors from
	 ...
	 *             if the content in the stream could not be parsed successfully
	 * @throws IOException
	 ...
	 *
	 * @param is
	 *            the input stream to read the direction vector from
	 ...
	 *
	 * @param d
	 *            the dimension, zero-based
	 * @param a
	 *            the coefficients of the primitive polynomial
	 * @param m
	 ...
	 *
	 * @param index
	 *            the index in the sequence to skip to
