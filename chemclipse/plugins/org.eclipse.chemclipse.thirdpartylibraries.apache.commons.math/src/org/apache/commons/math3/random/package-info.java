 ...
 * <li>BitStreamGenerator which is an abstract class for several generators and which in turn is extended by:
 * <ul>
 ...
 * <font size="+1">
 * <td>Name</td>
 * <td>generation rate (relative to MersenneTwister)</td></font>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.MersenneTwister MersenneTwister}</td>
 * <td>1</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.JDKRandomGenerator JDKRandomGenerator}</td>
 * <td>between 0.96 and 1.16</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well512a Well512a}</td>
 * <td>between 0.85 and 0.88</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well1024a Well1024a}</td>
 * <td>between 0.63 and 0.73</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well19937a Well19937a}</td>
 * <td>between 0.70 and 0.71</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well19937c Well19937c}</td>
 * <td>between 0.57 and 0.71</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well44497a Well44497a}</td>
 * <td>between 0.69 and 0.71</td>
 * </tr>
 * <tr>
 * <td>{@link org.apache.commons.math3.random.Well44497b Well44497b}</td>
 ...
 *
 * <p>
 * Note that <em>none</em> of these generators are suitable for cryptography. They are devoted to simulation, and to generate very long series with strong properties on the series as a whole (equidistribution, no correlation ...). They do not attempt to create small series but with very strong properties of unpredictability as needed in cryptography.
 * </p>
 *
 *
 */
