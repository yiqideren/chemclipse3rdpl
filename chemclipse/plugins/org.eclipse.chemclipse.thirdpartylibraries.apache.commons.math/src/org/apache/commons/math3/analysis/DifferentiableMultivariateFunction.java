...
public interface DifferentiableMultivariateFunction extends MultivariateFunction {
	 ...
	 * <p>
	 * The partial derivative is defined with respect to point coordinate x<sub>k</sub>. If the partial derivatives with respect to all coordinates are needed, it may be more efficient to use the {@link #gradient()} method which will compute them all at once.
	 * </p>
	 * k
