...
public class DSCompiler {
	 ...
	 * <p>
	 * If all orders are set to 0, then the 0<sup>th</sup> order derivative is returned, which is the value of the function.
	 * </p>
	 * <p>
	 ...
	 * <li>if there is only 1 {@link #getFreeParameters() free parameter}, then the derivatives are sorted in increasing derivation order (i.e. f at index 0, df/dp at index 1, d<sup>2</sup>f/dp<sup>2</sup> at index 2 ... d<sup>k</sup>f/dp<sup>k</sup> at index k),</li>
	 * <li>if the {@link #getOrder() derivation order} is 1, then the derivatives are sorted in increasing free parameter order (i.e. f at index 0, df/dx<sub>1</sub> at index 1, df/dx<sub>2</sub> at index 2 ... df/dx<sub>k</sub> at index k),</li>
