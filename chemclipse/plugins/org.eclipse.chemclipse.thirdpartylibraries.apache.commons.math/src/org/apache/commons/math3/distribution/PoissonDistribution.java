...
public class PoissonDistribution extends AbstractIntegerDistribution {
	 ...
	 * <ul>
	 * <li>For small means, uses simulation of a Poisson process using Uniform deviates, as described <a href="http://mathaa.epfl.ch/cours/PMMI2001/interactive/rng7.htm"> here</a>. The Poisson process (and hence value returned) is bounded by 1000 * mean.</li>
	 * <li>For large means, uses the rejection algorithm described in <blockquote> Devroye, Luc. (1981).<i>The Computer Generation of Poisson Random Variables</i><br>
