 ...
 * <p>
 * The LUP-decomposition of a matrix A consists of three matrices L, U and P that satisfy: P&times;A = L&times;U. L is lower triangular (with unit diagonal terms), U is upper triangular and P is a permutation matrix. All matrices are m&times;m.
 * </p>
 * <p>
 ...
 * <li>the {@code solve} and {@code isNonSingular} methods have been replaced by a {@link #getSolver() getSolver} method and the equivalent methods provided by the returned {@link DecompositionSolver}.</li>
 * </ul>
 *
