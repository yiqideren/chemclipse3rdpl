...
public class MannWhitneyUTest {
	 ...
	 * </p>
	 * <p>
	 * Let X<sub>i</sub> denote the i'th individual of the first sample and Y<sub>j</sub> the j'th individual in the second sample. Note that the samples would often have different length.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Ties give rise to biased variance at the moment. See e.g. <a href="http://mlsc.lboro.ac.uk/resources/statistics/Mannwhitney.pdf" >http://mlsc.lboro.ac.uk/resources/statistics/Mannwhitney.pdf</a>.
	 * </p>
	 *
	 * @param x
	 *            the first sample
