...
public abstract class BaseOptimizer<PAIR> {
	 ...
	 * <p>
	 * Important note: Subclasses <em>must</em> override {@link #parseOptimizationData(OptimizationData[])} if they need to register their own options; but then, they <em>must</em> also call {@code super.parseOptimizationData(optData)} within that method.
	 *
	 * @param optData
	 *            Optimization data.
	 *            This method will register the following data:
	 *            <ul>
	 *            <li>{@link MaxEval}</li> <li>{@link MaxIter}</li>
	 *            </ul>
