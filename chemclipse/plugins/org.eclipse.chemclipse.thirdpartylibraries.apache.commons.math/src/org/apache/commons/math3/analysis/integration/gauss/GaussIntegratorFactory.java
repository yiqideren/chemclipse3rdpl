...
public class GaussIntegratorFactory {
	 ...
	 * The call to the {@link GaussIntegrator#integrate(org.apache.commons.math3.analysis.UnivariateFunction)
	...
	/**
	 * Creates an integrator of the given order, and whose call to the {@link GaussIntegrator#integrate(org.apache.commons.math3.analysis.UnivariateFunction)
	 * integrate} method will perform an integration on the given interval.
	 *
	 * @param numberOfPoints
	 *            Order of the integration rule.
	 ...
	 * The call to the {@link SymmetricGaussIntegrator#integrate(org.apache.commons.math3.analysis.UnivariateFunction)
	 * integrate} method will perform a weighted integration on the interval {@code [-&inf;, +&inf;]}: the computed value is the improper integral of <code>
	 *  e<sup>-x<sup>2</sup></sup> f(x)
	 * </code> where {@code f(x)} is the function passed to the {@link SymmetricGaussIntegrator#integrate(org.apache.commons.math3.analysis.UnivariateFunction)
	 * integrate} method.
	 *
	 * @param numberOfPoints
	 *            Order of the integration rule.
