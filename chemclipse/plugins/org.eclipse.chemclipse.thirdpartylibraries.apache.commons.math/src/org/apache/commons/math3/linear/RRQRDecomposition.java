 ...
 * <p>
 * The rank-revealing QR-decomposition of a matrix A consists of three matrices Q, R and P such that AP=QR. Q is orthogonal (Q<sup>T</sup>Q = I), and R is upper triangular. If A is m&times;n, Q is m&times;m and R is m&times;n and P is n&times;n.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This class is based on the class with similar name from the <a href="http://math.nist.gov/javanumerics/jama/">JAMA</a> library, with the following changes:
 * </p>
 * <ul>
 * <li>a {@link #getQT() getQT} method has been added,</li>
 * <li>the {@code solve} and {@code isFullRank} methods have been replaced by a {@link #getSolver() getSolver} method and the equivalent methods provided by the returned {@link DecompositionSolver}.</li>
 * </ul>
 *
