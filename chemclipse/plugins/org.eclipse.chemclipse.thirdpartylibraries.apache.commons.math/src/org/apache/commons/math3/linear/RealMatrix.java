...
public interface RealMatrix extends AnyMatrix {
	 ...
	 * @return {@code m * this}
	 * @throws DimensionMismatchException
	 *             if {@code rowDimension(this) != columnDimension(m)}
	 */
	 ...
	 *
	 * @param p
	 *            raise {@code this} to power {@code p}
	 * @return {@code this^p}
	 ...
	 * </pre>
	 * 
	 * and <code>subMatrix = {{3, 4} {5,6}}</code>, invoking {@code setSubMatrix(subMatrix,1,1))} will result in
	 * 
	 * <pre>
	 * 1  2  3  4
	 * 5  3  4  8
	 ...
	 * @throws NoDataException
	 *             if {@code subMatrix} is empty.
	 * @throws OutOfRangeException
	 *             if {@code subMatrix} does not fit into
	 ...
	 *             if the specified row index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the row dimension of the {@code matrix} is not {@code 1}, or the column dimensions of {@code this} and {@code matrix} do not match.
	 */
	 ...
	 *             if the specified column index is invalid.
	 * @throws MatrixDimensionMismatchException
	 *             if the column dimension of the {@code matrix} is not {@code 1}, or the row dimensions of {@code this} and {@code matrix} do not match.
	 */
	 ...
	 *
	 * @param row
	 *            Row index of the entry to be modified.
	 * @param column
	 *            Column index of the entry to be modified.
	 * @param increment
