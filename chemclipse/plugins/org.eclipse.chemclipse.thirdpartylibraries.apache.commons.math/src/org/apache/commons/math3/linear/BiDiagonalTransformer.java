 ...
 * <p>
 * Any m &times; n matrix A can be written as the product of three matrices: A = U &times; B &times; V<sup>T</sup> with U an m &times; m orthogonal matrix, B an m &times; n bi-diagonal matrix (lower diagonal if m &lt; n, upper diagonal otherwise), and V an n &times; n orthogonal matrix.
 * </p>
 * <p>
