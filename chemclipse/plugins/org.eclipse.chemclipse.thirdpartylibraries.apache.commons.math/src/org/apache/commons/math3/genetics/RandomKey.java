 ...
 * For details, see:
 * <ul>
 * <li>Bean, J.C.: Genetic algorithms and random keys for sequencing and optimization. ORSA Journal on Computing 6 (1994) 154-160</li>
 * <li>Rothlauf, F.: Representations for Genetic and Evolutionary Algorithms. Volume 104 of Studies in Fuzziness and Soft Computing. Physica-Verlag, Heidelberg (2002)</li>
 * </ul>
 *
 * @param <T>
...
public abstract class RandomKey<T> extends AbstractListChromosome<Double> implements PermutationChromosome<T> {
	 ...
	 *             iff the length of the <code>sequence</code>, <code>representation</code> or <code>sortedRepr</code> lists are not equal
	 */
	...
	/**
	 * Generates a representation of a permutation corresponding to the <code>data</code> sorted by <code>comparator</code>. The <code>data</code> is not modified during the process.
	 *
