...
public class RegressionResults implements Serializable {
	...
	/**
	 * <p>
	 * Returns the <a href="http://www.xycoon.com/standerrorb(1).htm">standard error of the parameter estimates</a>, usually denoted s(b<sub>i</sub>).
	 * </p>
	 *
	 * <p>
	 * If there are problems with an ill conditioned design matrix then the regressor which is redundant will be assigned <code>Double.NaN</code>.
	 * </p>
	 *
	 ...
	 * <strong>Preconditions</strong>:
	 * <ul>
	 * <li>numberOfParameters data pairs must have been added before invoking this method. If this method is invoked before a model can be estimated, <code>Double,NaN</code> is returned.</li>
	 * </ul>
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * If there are fewer than <strong>numberOfParameters + 1</strong> data pairs in the model, or if there is no variation in <code>x</code>, this returns <code>Double.NaN</code>.
	 * </p>
	 *
	 * @return sum of squared deviations of y values
	 */
	...
	/**
	 * <p>
	 * Returns the <a href="http://www.xycoon.com/coefficient1.htm"> coefficient of multiple determination</a>, usually denoted r-square.
	 * </p>
	 *
	 * <p>
	 * <strong>Preconditions</strong>:
	 * <ul>
	 * <li>At least numberOfParameters observations (with at least numberOfParameters different x values) must have been added before invoking this method. If this method is invoked before a model can be estimated, {@code Double,NaN} is returned.</li>
	 * </ul>
	 * </p>
	 *
