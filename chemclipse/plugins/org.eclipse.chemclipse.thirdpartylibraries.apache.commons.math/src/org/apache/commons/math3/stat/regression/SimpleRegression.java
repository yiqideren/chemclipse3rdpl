 ...
 * <ul>
 * <li>When there are fewer than two observations in the model, or when there is no variation in the x values (i.e. all x values are the same) all statistics return <code>NaN</code>. At least two observations with different x coordinates are required to estimate a bivariate regression model.</li>
 ...
 * <li>The intercept term may be suppressed by passing {@code false} to the {@link #SimpleRegression(boolean)} constructor. When the {@code hasIntercept} property is false, the model is estimated without a constant term and {@link #getIntercept()} returns {@code 0}.</li>
 * </ul>
 * </p>
 *
 */
public class SimpleRegression implements Serializable, UpdatingMultipleLinearRegression {
	 ...
	 * <ul>
	 * <li>At least two observations (with at least two different x values) must have been added before invoking this method. If this method is invoked before a model can be estimated, <code>Double,NaN</code> is returned.</li>
	 * </ul>
	 * </p>
	 *
	 * @param x
	 ...
	 * <p>
	 * The least squares estimate of the intercept is computed using the <a href="http://www.xycoon.com/estimation4.htm">normal equations</a>. The intercept is sometimes denoted b0.
	 * </p>
	 * <p>
	 * <strong>Preconditions</strong>:
	 * <ul>
	 ...
	 * <p>
	 * The least squares estimate of the slope is computed using the <a href="http://www.xycoon.com/estimation4.htm">normal equations</a>. The slope is sometimes denoted b1.
	 * </p>
	 * <p>
	 * <strong>Preconditions</strong>:
	 * <ul>
	 ...
	 * </p>
	 * <p>
	 * where <code>SYY</code> is the sum of the squared deviations of the y values about their mean, <code>SXX</code> is similarly defined and <code>SXY</code> is the sum of the products of x and y mean deviations.
	 * </p>
	 * <p>
	 ...
	 * <p>
	 * If there are fewer than <strong>three</strong> data pairs in the model, or if there is no variation in <code>x</code>, this returns <code>Double.NaN</code>.
	 * </p>
	 *
	 * @return sum of squared deviations of y values
	 */
	 ...
	 * <p>
	 * Specifically, the returned value is the smallest <code>alpha</code> such that the slope confidence interval with significance level equal to <code>alpha</code> does not include <code>0</code>. On regression output, this is often denoted <code>Prob(|t| > 0)</code>
	 * </p>
	 * <p>
	 * <strong>Usage Note</strong>:<br>
	 * The validity of this statistic depends on the assumption that the observations included in the model are drawn from a <a href="http://mathworld.wolfram.com/BivariateNormalDistribution.html"> Bivariate Normal Distribution</a>.
