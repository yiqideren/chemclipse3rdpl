...
public class OpenMapRealMatrix extends AbstractRealMatrix implements SparseRealMatrix, Serializable {
	 ...
	 *
	 * @throws NumberIsTooLargeException
	 *             if {@code m} is an {@code OpenMapRealMatrix}, and the total number of entries of the product
	 ...
	 *             if the number of rows of {@code m} differ from the number of columns of {@code this} matrix.
	 * @throws NumberIsTooLargeException
	 *             if the total number of entries of the
