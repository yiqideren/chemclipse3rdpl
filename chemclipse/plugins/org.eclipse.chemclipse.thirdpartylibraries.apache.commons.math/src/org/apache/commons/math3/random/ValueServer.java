...
public class ValueServer {
	 ...
	 *
	 * @param seed
	 *            Value with which to reseed the {@link RandomDataImpl} used to generate random data.
	 */
	 ...
	 * <ul>
	 * <li>Before this method is called, <code>computeDistribution()</code> must have completed successfully; otherwise an <code>IllegalStateException</code> will be thrown</li>
	 * </ul>
	 * </p>
	 *
	 ...
	 * </p>
	 * <p>
	 * The <code>valuesFileURL</code> will be closed and reopened to wrap around from EOF to BOF if EOF is encountered. EOFException (which is a kind of IOException) may still be thrown if the <code>valuesFileURL</code> is empty.
	 * </p>
	 *
