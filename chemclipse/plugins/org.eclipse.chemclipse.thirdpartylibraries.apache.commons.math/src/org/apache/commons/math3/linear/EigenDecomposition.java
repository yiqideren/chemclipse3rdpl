 ...
 * <p>
 * The eigen decomposition of matrix A is a set of two matrices: V and D such that A = V &times; D &times; V<sup>T</sup>. A, V and D are all m &times; m matrices.
 * </p>
 * <p>
 * This class is similar in spirit to the <code>EigenvalueDecomposition</code> class from the <a href="http://math.nist.gov/javanumerics/jama/">JAMA</a> library, with the following changes:
 * </p>
 * <ul>
...
public class EigenDecomposition {
	 ...
	 *
	 * @param main
	 *            Main diagonal of the symmetric tridiagonal form.
	 * @param secondary
	 ...
	 * <p>
	 * The method performs a zero check for each element of the {@link #getImagEigenvalues()} array and returns {@code true} if any element is not equal to zero.
	 *
	 ...
	 * linear sense.
	 * <p>
	 * Since 3.1, eigen decomposition of a general matrix is supported, but the {@link DecompositionSolver} only supports real eigenvalues.
	 *
	 * @return a solver
	 * @throws MathUnsupportedOperationException
	...
	private static class Solver implements DecompositionSolver {
		...
		/**
		 * @param i
		 *            which eigenvalue to find the norm of
