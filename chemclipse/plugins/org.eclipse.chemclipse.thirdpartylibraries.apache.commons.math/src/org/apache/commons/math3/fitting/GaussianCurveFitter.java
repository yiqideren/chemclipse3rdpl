...
/**
 * Fits points to a {@link org.apache.commons.math3.analysis.function.Gaussian.Parametric Gaussian} function. <br/>
...
public class GaussianCurveFitter extends AbstractCurveFitter {
	 ...
	 *
	 * @param initialGuess
	 *            Initial guess. If set to {@code null}, the initial guess
	...
	public static class ParameterGuesser {
		 ...
		 * @return {@code true} if {@code value} is between {@code boundary1} and {@code boundary2} (inclusive), {@code false} otherwise.
		 */
