...
public interface RandomData {
	 ...
	 *
	 * @param lower
	 *            lower bound for generated long integer
	 * @param upper
	 *            upper bound for generated long integer
	 ...
	 * <p>
	 * <strong>Definition</strong>: <a href="http://www.itl.nist.gov/div898/handbook/eda/section3/eda3662.htm"> Uniform Distribution</a> {@code lower} and {@code upper - lower} are the <a href = "http://www.itl.nist.gov/div898/handbook/eda/section3/eda364.htm"> location and scale parameters</a>, respectively.
	 * </p>
	 *
	 * @param lower
	 *            the exclusive lower bound of the support
	 * @param upper
	 *            the exclusive upper bound of the support
	 ...
	 *            {@code true} if the lower bound is inclusive
