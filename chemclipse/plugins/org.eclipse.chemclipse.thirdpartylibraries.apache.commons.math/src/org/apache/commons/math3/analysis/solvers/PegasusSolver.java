 ...
 *
 * <p>
 * Like the <em>Regula Falsi</em> method, convergence is guaranteed by maintaining a bracketed solution. The <em>Pegasus</em> method however, should converge much faster than the original <em>Regula Falsi</em> method. Furthermore, this implementation of the <em>Pegasus</em> method should not suffer from the same implementation issues as the <em>Regula
 * Falsi</em> method, which may fail to convergence in certain cases. Also, the <em>Pegasus</em> method should converge faster than the {@link IllinoisSolver <em>Illinois</em>} method, another <em>Regula
 * Falsi</em>-based method.
 * </p>
 *
 * <p>
 * The <em>Pegasus</em> method assumes that the function is continuous, but not necessarily smooth.
 * </p>
 *
 * <p>
 * Implementation based on the following article: M. Dowell and P. Jarratt, <em>The "Pegasus" method for computing the root of an equation</em>, BIT Numerical Mathematics, volume 12, number 4, pages 503-508, Springer, 1972.
 * </p>
 *
 * @since 3.0
 */
