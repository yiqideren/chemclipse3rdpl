...
public class FastFourierTransformer implements Serializable {
	 ...
	 *
	 * @param dataRI
	 *            the two dimensional array of real and imaginary parts of the data
	 * @param normalization
	 *            the normalization to be applied to the transformed data
	 * @param type
	 ...
	 * @throws MathIllegalArgumentException
	 *             if the number of sample points {@code n} is not a power of two
	 */
	 ...
	 *
	 * @param mdca
	 *            Multi-Dimensional Complex Array, i.e. {@code Complex[][][][]}
	 * @param type
	 *            the type of transform (forward, inverse) to be performed
