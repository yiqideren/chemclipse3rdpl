...
public class BaseMultivariateMultiStartOptimizer<FUNC extends MultivariateFunction> implements BaseMultivariateOptimizer<FUNC> {
	 ...
	 * including the best one already returned by the {@link #optimize(int,MultivariateFunction,GoalType,double[]) optimize} method. <br/>
	 ...
	 *             if {@link #optimize(int,MultivariateFunction,GoalType,double[]) optimize} has not been called.
	 */
