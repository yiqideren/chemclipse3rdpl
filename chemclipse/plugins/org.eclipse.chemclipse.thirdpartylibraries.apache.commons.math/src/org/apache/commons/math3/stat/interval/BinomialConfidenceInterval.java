 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Binomial_proportion_confidence_interval">Binomial proportion confidence interval (Wikipedia)</a>
 * @since 3.3
 */
public interface BinomialConfidenceInterval {
	 ...
	 *             if {@code numberOfTrials <= 0}.
	 * @throws NotPositiveException
	 *             if {@code numberOfSuccesses < 0}.
	 * @throws NumberIsTooLargeException
	 *             if {@code numberOfSuccesses > numberOfTrials}.
	 * @throws OutOfRangeException
	 *             if {@code confidenceLevel} is not in the interval {@code (0, 1)}.
	 */
