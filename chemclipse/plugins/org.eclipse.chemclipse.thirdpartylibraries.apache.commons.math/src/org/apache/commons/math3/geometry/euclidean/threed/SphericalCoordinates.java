 ...
 * </ul>
 * <p>
 * r is the radius, &theta; is the azimuthal angle in the x-y plane and &Phi; is the polar (co-latitude) angle. These conventions are <em>different</em> from the conventions used in physics (and in particular in spherical harmonics) where the meanings of &theta; and &Phi; are reversed.
 * </p>
 * <p>
