 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Uniform_distribution_(continuous)" >Uniform distribution (continuous), at Wikipedia</a>
 *
 * @since 3.0
 */
public class UniformRealDistribution extends AbstractRealDistribution {
	 ...
	 * @throws NumberIsTooLargeException
	 *             if {@code lower >= upper}.
	 * @deprecated as of 3.2, inverse CDF is now calculated analytically, use {@link #UniformRealDistribution(double, double)} instead.
	 */
	@Deprecated
	 ...
	 *             if {@code lower >= upper}.
	 * @since 3.1
	 * @deprecated as of 3.2, inverse CDF is now calculated analytically, use {@link #UniformRealDistribution(RandomGenerator, double, double)} instead.
	 */
	@Deprecated
