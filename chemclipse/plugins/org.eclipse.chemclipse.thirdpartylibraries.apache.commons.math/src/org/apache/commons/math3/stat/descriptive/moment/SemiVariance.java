...
/**
 * <p>
 * Computes the semivariance of a set of values with respect to a given cutoff value. We define the <i>downside semivariance</i> of a set of values <code>x</code> against the <i>cutoff value</i> <code>cutoff</code> to be <br/>
 ...
 *
 * <p>
 * The cutoff value defaults to the mean, bias correction defaults to <code>true</code> and the "variance direction" (upside or downside) defaults to downside. The variance direction and bias correction may be set using property setters or their values can provided as parameters to {@link #evaluate(double[], double, Direction, boolean, int, int)}.
 * </p>
 *
 * <p>
 * If the input array is null, <code>evaluate</code> methods throw <code>IllegalArgumentException.</code> If the array has length 1, <code>0</code> is returned, regardless of the value of the <code>cutoff.</code>
 *
 * <p>
 * <strong>Note that this class is not intended to be threadsafe.</strong> If multiple threads access an instance of this class concurrently, and one or more of these threads invoke property setters, external synchronization must be provided to ensure correct results.
 * </p>
 *
 * @since 2.1
 */
public class SemiVariance extends AbstractUnivariateStatistic implements Serializable {
	...
	/**
	 * Constructs a SemiVariance with default (true) <code>biasCorrected</code> property and default (Downside) <code>varianceDirection</code> property.
	 */
	public SemiVariance() {
	...
	/**
	 * Constructs a SemiVariance with the specified <code>biasCorrected</code> property and default (Downside) <code>varianceDirection</code> property.
	 *
	 * @param biasCorrected
	...
	/**
	 * Constructs a SemiVariance with the specified <code>isBiasCorrected</code> property and the specified <code>Direction</code> property.
	 *
	 * @param corrected
	 *            setting for bias correction - true means
	 *            bias will be corrected and is equivalent to using the argumentless
	 ...
	 *
	 * <p>
	 * Returns <code>NaN</code> if the array is empty and throws <code>IllegalArgumentException</code> if the array is null.
	 * </p>
	 *
	 * @param values
	 *            the input array
	 ...
	 *
	 * <p>
	 * Returns <code>NaN</code> if the array is empty and throws <code>MathIllegalArgumentException</code> if the array is null.
	 * </p>
	 *
	 * @param values
	 *            the input array
