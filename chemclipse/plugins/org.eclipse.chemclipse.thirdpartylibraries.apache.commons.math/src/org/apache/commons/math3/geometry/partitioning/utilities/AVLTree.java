 ...
 *
 * <p>
 * In order to clearly mark the methods provided here do not have the same semantics as the ones specified in the {@code SortedSet} interface, different names are used ({@code add} has been replaced by {@link #insert insert} and {@code remove} has been replaced by {@link #delete
 * delete}).
 * </p>
 *
 * <p>
 * This class is based on the C implementation Georg Kraml has put in the public domain. Unfortunately, his <a href="www.purists.org/georg/avltree/index.html">page</a> seems not to exist any more.
 * </p>
 *
 * @param <T>
