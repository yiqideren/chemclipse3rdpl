...
public class OLSMultipleLinearRegression extends AbstractMultipleLinearRegression {
	 ...
	 * </p>
	 * <p>
	 * The implementation here uses the QR decomposition to compute the hat matrix as Q I<sub>p</sub>Q<sup>T</sup> where I<sub>p</sub> is the p-dimensional identity matrix augmented by 0's. This computational formula is from "The Hat Matrix in Regression and ANOVA", David C. Hoaglin and Roy E. Welsch, <i>The American Statistician</i>, Vol. 32, No. 1 (Feb., 1978), pp. 17-22.
	 * </p>
	 * <p>
	 ...
	 *             unless method {@code newSampleData} has been
	 *             called beforehand.
	 */
	 ...
	 *
	 * <p>
	 * If the model has no intercept term, <code>0</code> is used for the mean of Y - i.e., what is returned is the sum of the squared Y values.
	 * </p>
	 *
	 * <p>
	 ...
	 * @throws NullPointerException
	 *             if the sample has not been set
	 * @see #isNoIntercept()
	 * @since 2.2
	 */
	 ...
	 * </p>
	 * <p>
	 * Uses QR decomposition to reduce (X<sup>T</sup>X)<sup>-1</sup> to (R<sup>T</sup>R)<sup>-1</sup>, with only the top p rows of R included, where p = the length of the beta vector.
	 * </p>
	 *
	 * <p>
	 * Data for the model must have been successfully loaded using one of the {@code newSampleData} methods before invoking this method; otherwise a {@code NullPointerException} will be thrown.
