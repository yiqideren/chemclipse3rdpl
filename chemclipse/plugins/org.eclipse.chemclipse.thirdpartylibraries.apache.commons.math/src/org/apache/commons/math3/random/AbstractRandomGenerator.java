 ...
 * <p>
 * All data generation methods are based on {@code code nextDouble()}. Concrete implementations <strong>must</strong> override this method and <strong>should</strong> provide better / more performant implementations of the other methods if the underlying PRNG supplies them.
 * </p>
 *
 * @since 1.1
 */
public abstract class AbstractRandomGenerator implements RandomGenerator {
	 ...
	 * <p>
	 * The default implementation uses the <em>Polar Method</em> due to G.E.P. Box, M.E. Muller and G. Marsaglia, as described in D. Knuth, <u>The Art of Computer Programming</u>, 3.4.1C.
	 * </p>
	 * <p>
