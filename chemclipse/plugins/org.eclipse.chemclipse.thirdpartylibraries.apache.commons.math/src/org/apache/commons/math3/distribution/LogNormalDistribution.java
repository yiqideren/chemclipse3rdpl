 ...
 * </p>
 * <ul>
 * <li>{@code m} is the <em>scale</em> parameter: this is the mean of the normally distributed natural logarithm of this distribution,</li>
 * <li>{@code s} is the <em>shape</em> parameter: this is the standard deviation of the normally distributed natural logarithm of this distribution.
 * </ul>
 *
...
public class LogNormalDistribution extends AbstractRealDistribution {
	 ...
	 * <ul>
	 * <li>{@code 0} if {@code x <= 0},</li>
	 * <li>{@code 0} if {@code ln(x) - m < 0} and {@code m - ln(x) > 40 * s}, as in these cases the actual value is within {@code Double.MIN_VALUE} of 0,
	 * <li>{@code 1} if {@code ln(x) - m >= 0} and {@code ln(x) - m > 40 * s}, as in these cases the actual value is within {@code Double.MIN_VALUE} of 1,</li>
