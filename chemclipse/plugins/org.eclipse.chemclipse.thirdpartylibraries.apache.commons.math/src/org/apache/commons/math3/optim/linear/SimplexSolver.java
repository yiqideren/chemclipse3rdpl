 ...
 * </ul>
 * <p>
 * <b>Note:</b> Depending on the problem definition, the default convergence criteria may be too strict, resulting in {@link NoFeasibleSolutionException} or {@link TooManyIterationsException}. In such a case it is advised to adjust these criteria with more appropriate values, e.g. relaxing the epsilon value.
 * <p>
 ...
 * </ul>
 * <p>
 * The cut-off value has been introduced to handle the case of very small pivot elements in the Simplex tableau, as these may lead to numerical instabilities and degeneracy. Potential pivot elements smaller than this value will be treated as if they were zero and are thus not considered by the pivot selection mechanism. The default value is safe for many problems, but may need to be adjusted in case of very small coefficients used in either the {@link LinearConstraint} or
...
public class SimplexSolver extends LinearOptimizer {
	 ...
	 *
	 * @param optData
	 *            Optimization data. In addition to those documented in {@link LinearOptimizer#optimize(OptimizationData...)
	 ...
	 * @param optData
	 *            Optimization data.
	 *            In addition to those documented in {@link LinearOptimizer#parseOptimizationData(OptimizationData[])
	 *            LinearOptimizer}, this method will register the following data:
	 *            <ul>
	 *            <li>{@link SolutionCallback}</li>
	 *            <li>{@link PivotSelectionRule}</li>
