 ...
 * Each neuron defines one surface element. <br/>
...
public class NeuronSquareMesh2D implements Serializable {
	 ...
	 *             if {@code numRows < 2} or {@code numCols < 2}.
	 */
	...
	private static class SerializationProxy implements Serializable {
		...
		/**
		 * @param wrapRows
		 *            Whether the row dimension is wrapped.
		 * @param wrapColumns
		 *            Whether the column dimension is wrapped.
		 * @param neighbourhood
		 *            Neighbourhood type.
		 * @param featuresList
		 *            List of neurons features. {@code neuronList}.
		 */
