...
public class Neuron implements Serializable {
	 ...
	 *
	 * @param identifier
	 *            Identifier (assigned by the {@link Network}).
	 * @param features
	 ...
	 * @param update
	 *            Features's new values.
	 * @return {@code true} if the update was successful, {@code false} otherwise.
	 * @throws DimensionMismatchException
	 *             if the length of {@code update} is
	 ...
	 *            Expected values.
	 * @throws DimensionMismatchException
	 *             if the length of {@code expected} is not the same as specified in the {@link #Neuron(long,double[])
	 *             constructor}.
