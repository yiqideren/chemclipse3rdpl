 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Uniform_distribution_(discrete)" >Uniform distribution (discrete), at Wikipedia</a>
 *
 * @since 3.0
 */
public class UniformIntegerDistribution extends AbstractIntegerDistribution {
	 ...
	 * {@inheritDoc}
	 *
	 * For lower bound {@code lower} and upper bound {@code upper}, and {@code n = upper - lower + 1}, the variance is {@code (n^2 - 1) / 12}.
	 */
