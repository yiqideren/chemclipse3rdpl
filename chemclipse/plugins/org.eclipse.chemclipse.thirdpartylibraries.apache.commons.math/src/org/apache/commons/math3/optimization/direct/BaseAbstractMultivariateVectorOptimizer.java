...
public abstract class BaseAbstractMultivariateVectorOptimizer<FUNC extends MultivariateVectorFunction> implements BaseMultivariateVectorOptimizer<FUNC> {
	 ...
	 * {@inheritDoc}
	 *
	 * @deprecated As of 3.1. Please use {@link #optimize(int,MultivariateVectorFunction,OptimizationData[])} instead.
	 */
	@Deprecated
	 ...
	 * @deprecated As of 3.1. Please use {@link #optimizeInternal(int,MultivariateVectorFunction,OptimizationData[])} instead.
	 */
	@Deprecated
	 ...
	 * class.
	 * It will be called after the parsing step performed in the {@link #optimize(int,MultivariateVectorFunction,OptimizationData[])
