...
public class LeastSquaresBuilder {
	...
	public LeastSquaresProblem build() {
		...
		return LeastSquaresFactory.create(model, target, start, weight, checker, maxEvaluations, maxIterations, lazyEvaluation, paramValidator);
	}

	/**
	 * Configure the max evaluations.
	 *
	 * @param newMaxEvaluations
	 *            the maximum number of evaluations permitted.
	 * @return this
	 */
	 ...
	 *
	 * @param value
	 *            the model function value
	 * @param jacobian
	 *            the Jacobian of {@code value}
	 * @return this
	 */
	 ...
	 *
	 * @param newModel
	 *            the model function value and Jacobian
	 * @return this
	 */
	 ...
	 *
	 * @param newValue
	 *            Whether to perform lazy evaluation.
	 * @return this object.
	 *
	 * @since 3.4
	 */
