 ...
 * <ul>
 * <li><a href="http://dx.doi.org/10.1145/22721.23109">Didonato and Morris (1986)</a>, <em>Computation of the Incomplete Gamma Function Ratios
...
public class Beta {
	...
	/**
	 * Returns the value of log Γ(a + b) for 1 ≤ a, b ≤ 2. Based on the <em>NSWC Library of Mathematics Subroutines</em> double precision
