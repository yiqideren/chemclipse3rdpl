...
public class GaussNewtonOptimizer implements LeastSquaresOptimizer {
	...
	public static enum Decomposition {
		 ...
		 *
		 * <p>
		 * Theoretically this method takes mn<sup>2</sup>/2 operations to compute the normal matrix and n<sup>3</sup>/3 operations (m > n) to solve the system using the LU decomposition.
		 * </p>
		 */
		LU {
		 ...
		 *
		 * <p>
		 * Theoretically this method takes mn<sup>2</sup> - n<sup>3</sup>/3 operations (m > n) and has better numerical accuracy than any method that forms the normal equations.
		 * </p>
		 */
		QR {
		 ...
		 *
		 * <p>
		 * Theoretically this method takes mn<sup>2</sup>/2 operations to compute the normal matrix and n<sup>3</sup>/6 operations (m > n) to solve the system using the Cholesky decomposition.
		 * </p>
		 */
		CHOLESKY {
	 ...
	 *
	 * @param decomposition
	 *            the {@link Decomposition} algorithm.
	 */
	 ...
	 *
	 * @param newDecomposition
	 *            the {@link Decomposition} algorithm to use.
	 ...
	 *
	 * @param jacobian
	 *            the m by n jacobian matrix, J. Input.
	 * @param residuals
	 *            the m by 1 residual vector, r. Input.
