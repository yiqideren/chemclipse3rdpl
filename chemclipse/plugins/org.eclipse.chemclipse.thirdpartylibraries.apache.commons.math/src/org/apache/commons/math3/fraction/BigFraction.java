...
public class BigFraction extends Number implements FieldElement<BigFraction>, Comparable<BigFraction>, Serializable {
	 ...
	 * <p>
	 * This constructor behaves <em>differently</em> from {@link #BigFraction(double, double, int)}. It converts the double value exactly, considering its internal bits representation. This works for all values except NaN and infinities and does not requires any loop or convergence threshold.
	 * </p>
	 * <p>
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>BigDecimal</code>. This calculates the fraction as the numerator divided by denominator.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>BigDecimal</code> following the passed scale and rounding mode. This calculates the fraction as the numerator divided by denominator.
	 * </p>
	 *
	 * @param scale
	 ...
	 * @return true if two fractions are equal, false if object is <code>null</code>, not an instance of {@link BigFraction}, or not
	...
	/**
	 * <p>
	 * Multiplies the value of this fraction by the passed <code>BigInteger</code>, returning the result in reduced form.
	 * </p>
	 *
	 * @param bg
	...
	/**
	 * <p>
	 * Returns a <code>BigFraction</code> whose value is <tt>(this<sup>exponent</sup>)</tt>, returning the result in reduced form.
	 * </p>
	 *
	 * @param exponent
	...
	/**
	 * <p>
	 * Returns a <code>double</code> whose value is <tt>(this<sup>exponent</sup>)</tt>, returning the result in reduced form.
	 * </p>
	 *
	 * @param exponent
	 *            exponent to which this <code>BigFraction</code> is to be raised.
	...
	/**
	 * <p>
	 * Returns the <code>String</code> representing this fraction, ie "num / dem" or just "num" if the denominator is one.
	 * </p>
	 *
