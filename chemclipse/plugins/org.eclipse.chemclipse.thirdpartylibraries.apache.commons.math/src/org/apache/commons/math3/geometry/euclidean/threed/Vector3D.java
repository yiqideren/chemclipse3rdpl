...
public class Vector3D implements Serializable, Vector<Euclidean3D> {
	 ...
	 * <p>
	 * If all coordinates of two 3D vectors are exactly the same, and none are <code>Double.NaN</code>, the two 3D vectors are considered to be equal.
	 * </p>
	 * <p>
	 * <code>NaN</code> coordinates are considered to affect globally the vector and be equals to each other - i.e, if either (or all) coordinates of the 3D vector are equal to <code>Double.NaN</code>, the 3D vector is equal to {@link #NaN}.
	 * </p>
	 *
	 * @param other
