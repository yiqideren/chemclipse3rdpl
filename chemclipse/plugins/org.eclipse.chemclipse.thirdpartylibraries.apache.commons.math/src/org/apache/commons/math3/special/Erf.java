...
public class Erf {
	 ...
	 * More precisely, the current implementations of {@link #erf(double)} and {@link #erfc(double)} satisfy:<br/>
	 ...
	 *
	 * <p>
	 * This implementation computes erf(x) using the {@link Gamma#regularizedGammaP(double, double, double, int) regularized gamma function}, following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3)
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * erfc(x) = 2/&radic;&pi; <sub>x</sub>&int;<sup>&infin;</sup> e<sup>-t<sup>2</sup></sup>dt <br/>
	 * = 1 - {@link #erf(double) erf(x)}
	 * </p>
	 *
	 * <p>
	 * This implementation computes erfc(x) using the {@link Gamma#regularizedGammaQ(double, double, double, int) regularized gamma function}, following <a href="http://mathworld.wolfram.com/Erf.html"> Erf</a>, equation (3).
	 * </p>
	 *
	 * <p>
