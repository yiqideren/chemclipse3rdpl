...
public class Vector1D implements Vector<Euclidean1D> {
	 ...
	 * <p>
	 * If all coordinates of two 1D vectors are exactly the same, and none are <code>Double.NaN</code>, the two 1D vectors are considered to be equal.
	 * </p>
	 * <p>
	 * <code>NaN</code> coordinates are considered to affect globally the vector and be equals to each other - i.e, if either (or all) coordinates of the 1D vector are equal to <code>Double.NaN</code>, the 1D vector is equal to {@link #NaN}.
	 * </p>
	 *
	 * @param other
