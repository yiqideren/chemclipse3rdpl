...
public class StorelessCovariance extends Covariance {
	...
	/**
	 * Appends {@code sc} to this, effectively aggregating the computations in {@code sc} with this. After invoking this method, covariances returned should be close
	 * to what would have been obtained by performing all of the {@link #increment(double[])} operations in {@code sc} directly on this.
	 *
	 * @param sc
	 *            externally computed StorelessCovariance to add to this
	 * @throws DimensionMismatchException
