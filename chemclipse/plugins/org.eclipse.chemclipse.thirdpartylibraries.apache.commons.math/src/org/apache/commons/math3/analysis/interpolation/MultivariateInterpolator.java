...
public interface MultivariateInterpolator {
	 ...
	 *
	 * @param xval
	 *            the arguments for the interpolation points. {@code xval[i][0]} is the first component of interpolation point {@code i}, {@code xval[i][1]} is the second component, and so on
