 ...
 * <ul>
 * <li>MINIMAL - NaNs are treated as minimal in the ordering, equivalent to (that is, tied with) <code>Double.NEGATIVE_INFINITY</code>.</li>
 ...
 * <li>FIXED - NaNs are left "in place," that is the rank transformation is applied to the other elements in the input array, but the NaN elements are returned unchanged.</li>
