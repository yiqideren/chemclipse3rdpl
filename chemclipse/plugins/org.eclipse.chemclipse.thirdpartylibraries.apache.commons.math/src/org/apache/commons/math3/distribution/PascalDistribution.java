 ...
 * </p>
 * <p>
 * For a random variable {@code X} whose values are distributed according to this distribution, the probability mass function is given by<br/>
 * {@code P(X = k) = C(k + r - 1, r - 1) * p^r * (1 - p)^k,}<br/>
 * where {@code r} is the number of successes, {@code p} is the probability of success, and {@code X} is the total number of failures. {@code C(n, k)} is the binomial coefficient ({@code n} choose {@code k}). The mean and variance of {@code X} are<br/>
 ...
 * </p>
 *
 * @see <a href="http://en.wikipedia.org/wiki/Negative_binomial_distribution"> Negative binomial distribution (Wikipedia)</a>
 * @see <a href="http://mathworld.wolfram.com/NegativeBinomialDistribution.html"> Negative binomial distribution (MathWorld)</a>
