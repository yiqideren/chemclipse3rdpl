...
public class UnivariateSolverUtils {
	 ...
	 * <strong>Note: </strong> this method can take <code>Integer.MAX_VALUE</code> iterations to throw a <code>ConvergenceException.</code> Unless you are confident that there
	 * is a root between <code>lowerBound</code> and <code>upperBound</code> near <code>initial,</code> it is better to use {@link #bracket(UnivariateFunction, double, double, double, double, double, int) bracket(function, initial, lowerBound, upperBound, q, r, maximumIterations)},
	 ...
	 *            value).
	 * @param q
	 *            additive offset used to compute bounds sequence (must be strictly positive)
	 * @param r
	 *            multiplicative factor used to compute bounds sequence
	 * @param maximumIterations
	 *            Maximum number of iterations to perform
