...
public class ROIFigure extends Figure {
	...
	class ROIRectDragger extends CommonDragger {
		...
		protected void updateROIBounds(MouseEvent me) {
			...
			int dx = me.x - start.x;
			int dy = me.y - start.y;
			RECT_SINGLETON.setBounds(startROIBounds.x + dx, startROIBounds.y + dy, startROIBounds.width, startROIBounds.height);
	...
	class HandlerBoundsCalulator {
		...
		public Rectangle calcBoundsFromROIBounds(Rectangle roiBounds) {
			...
			return new Rectangle(roiBounds.x - HANDLE_SIZE / 2, roiBounds.y - HANDLE_SIZE / 2, HANDLE_SIZE, HANDLE_SIZE);
		}
	}
				...
				case 0:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							int dy = me.y - start.y;
							setROIGeoBounds(me.x, me.y, startROIBounds.width - dx, startROIBounds.height - dy);
						}
					};
				...
				case 1:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dy = me.y - start.y;
							setROIGeoBounds(startROIBounds.x, me.y, startROIBounds.width, startROIBounds.height - dy);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 2:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							int dy = me.y - start.y;
							setROIGeoBounds(startROIBounds.x, startROIBounds.y + dy, startROIBounds.width + dx, startROIBounds.height - dy);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 3:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							setROIGeoBounds(startROIBounds.x, startROIBounds.y, startROIBounds.width + dx, startROIBounds.height);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 4:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							int dy = me.y - start.y;
							setROIGeoBounds(startROIBounds.x, startROIBounds.y, startROIBounds.width + dx, startROIBounds.height + dy);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 5:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dy = me.y - start.y;
							setROIGeoBounds(startROIBounds.x, startROIBounds.y, startROIBounds.width, startROIBounds.height + dy);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 6:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							int dy = me.y - start.y;
							setROIGeoBounds(startROIBounds.x + dx, startROIBounds.y, startROIBounds.width - dx, startROIBounds.height + dy);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
				...
				case 7:
					...
					dragger = new CommonDragger() {
						...
						protected void updateROIBounds(MouseEvent me) {
							...
							int dx = me.x - start.x;
							setROIGeoBounds(startROIBounds.x + dx, startROIBounds.y, startROIBounds.width - dx, startROIBounds.height);
						}
					};
					handlerBoundsCalulator = new HandlerBoundsCalulator() {
	 ...
	 */
	public ROIFigure(IntensityGraphFigure intensityGraphFigure, String name, Color color, IROIListener roiListener, IROIInfoProvider roiInfoProvider) {
	...
	protected void layout() {
		...
		if(roiDataBounds == null) {
			roiGeoBounds = new PrecisionRectangle(clientArea.x + clientArea.width / 2 - clientArea.width / 10, clientArea.y + clientArea.height / 2 - clientArea.height / 10, clientArea.width / 5, clientArea.height / 5);
			roiDataBounds = getROIFromGeoBounds(new PrecisionRectangle(roiGeoBounds.preciseX() + getBounds().x, roiGeoBounds.preciseY() + getBounds().y, roiGeoBounds.preciseWidth(), roiGeoBounds.preciseHeight()));
			fireROIUpdated();
		}
		updateROIGeoBounds();
		updateChildrenBounds();
	...
	protected void paintFigure(Graphics graphics) {
		...
		if(roiInfoProvider != null) {
			String text = roiInfoProvider.getROIInfo(roiDataBounds.x, roiDataBounds.y, roiDataBounds.width, roiDataBounds.height);
