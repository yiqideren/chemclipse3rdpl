	...
	class XMeterLayout extends AbstractLayout {
		...
		public void layout(IFigure container) {
			...
			if(valueLabel != null) {
				...
				valueLabel.setBounds(new Rectangle(area.x + area.width / 2 - labelSize.width / 2, area.y + area.height / 2 - area.height / 4 - (scale.getInnerRadius() - area.height / 4) / 2 - labelSize.height / 2, labelSize.width, labelSize.height));
			}
