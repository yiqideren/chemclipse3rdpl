...
public class GraphConfigPage {
	...
	public void createPage(final Composite composite) {
		...
		titleColorSelector.addListener(new IPropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				...
				fontLabel.setForeground(XYGraphMediaFactory.getInstance().getColor(titleColorSelector.getColorValue()));
			}
		});
		...
		plotAreaColorSelector.setColorValue(xyGraph.getPlotArea().getBackgroundColor().getRGB());
	...
	public void applyChanges() {
		...
		xyGraph.getPlotArea().setBackgroundColor(XYGraphMediaFactory.getInstance().getColor(plotAreaColorSelector.getColorValue()));
