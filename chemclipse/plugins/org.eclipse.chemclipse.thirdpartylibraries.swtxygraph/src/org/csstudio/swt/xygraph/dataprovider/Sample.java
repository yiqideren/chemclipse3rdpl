...
public class Sample implements ISample {
	 ...
	 * @param xMinusError
	 */
	public Sample(final double xValue, final double yValue, final double yPlusError, final double yMinusError, final double xPlusError, final double xMinusError) {
	 ...
	 * @param info
	 */
	public Sample(final double xValue, final double yValue, final double yPlusError, final double yMinusError, final double xPlusError, final double xMinusError, final String info) {
