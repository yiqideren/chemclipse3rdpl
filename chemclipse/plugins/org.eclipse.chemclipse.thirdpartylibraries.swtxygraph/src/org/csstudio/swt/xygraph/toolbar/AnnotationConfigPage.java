...
public class AnnotationConfigPage {
	...
	public void applyChanges() {
		...
		if(snapToTrace.getSelection())
			...
			annotation.setFree(xyGraph.getXAxisList().get(xAxisOrTraceCombo.getSelectionIndex()), xyGraph.getYAxisList().get(yAxisCombo.getSelectionIndex()));
	...
	private void initialize() {
		...
		colorSelector.setColorValue(annotation.getAnnotationColor() == null ? annotation.getYAxis().getForegroundColor().getRGB() : annotation.getAnnotationColor().getRGB());
