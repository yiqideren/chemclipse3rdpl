...
public class LinearScaleTickMarks extends Figure {
	 ...
	 */
	private void drawXTickMarks(Graphics gc, ArrayList<Integer> tickLabelPositions, LabelSide tickLabelSide, int width, int height) {
			...
			for(int i = 0; i < tickLabelPositions.size(); i++) {
				...
				if(scale.isMinorTicksVisible()) {
					if(i > 0) {
						...
						if(i == 1 && (tickLabelPositions.get(1) - tickLabelPositions.get(0)) < scale.getScaleTickLabels().getGridStepInPixel()) {
						...
						else if(i == tickLabelPositions.size() - 1 && (tickLabelPositions.get(i) - tickLabelPositions.get(i - 1)) < scale.getScaleTickLabels().getGridStepInPixel()) {
							...
							for(int j = 0; j < minorTicksNumber; j++) {
								x = tickLabelPositions.get(i - 1) + (tickLabelPositions.get(i) - tickLabelPositions.get(i - 1)) * j / minorTicksNumber;
								drawXMinorTicks(gc, tickLabelSide, x, y);
							}
						}
					}
	 ...
	 *            the graphics context
	 */
	private void drawYTickMarks(Graphics gc, ArrayList<Integer> tickLabelPositions, LabelSide tickLabelSide, int width, int height) {
				...
				if(scale.isMinorTicksVisible()) {
					if(i > 0) {
						...
						if(i == 1 && (tickLabelPositions.get(1) - tickLabelPositions.get(0)) < scale.getScaleTickLabels().getGridStepInPixel()) {
							...
							for(int j = 0; j < minorTicksNumber; j++) {
								y = height - tickLabelPositions.get(i - 1) - (tickLabelPositions.get(i) - tickLabelPositions.get(i - 1)) * j / minorTicksNumber;
