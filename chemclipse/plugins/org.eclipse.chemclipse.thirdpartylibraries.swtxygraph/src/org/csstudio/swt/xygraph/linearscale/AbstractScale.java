...
public abstract class AbstractScale extends Figure {
	...
	public String format(Object obj, boolean minOrMaxDate) {
		...
		if(isDateEnabled()) {
			if(autoFormat || formatPattern == null || formatPattern.equals("") || formatPattern.equals(default_decimal_format) || formatPattern.equals(DEFAULT_ENGINEERING_FORMAT)) {
	 ...
	 *            if true, the start and end value of the range
	...
	public void setRange(double lower, double upper) {
		...
		if(formatPattern.equals(default_decimal_format) || formatPattern.equals(DEFAULT_ENGINEERING_FORMAT)) {
			if((max != 0 && Math.abs(Math.log10(Math.abs(max))) >= ENGINEERING_LIMIT) || (min != 0 && Math.abs(Math.log10(Math.abs(min))) >= ENGINEERING_LIMIT))
	 ...
	 * 
	 * @param timeUnit
	 *            the timeUnit to set. It should be one of: <tt>Calendar.MILLISECOND</tt>, <tt>Calendar.SECOND</tt>, <tt>Calendar.MINUTE</tt>, <tt>Calendar.HOUR_OF_DAY</tt>, <tt>Calendar.DATE</tt>, <tt>Calendar.MONTH</tt>, <tt>Calendar.YEAR</tt>.
	 * @see Calendar
	 */
