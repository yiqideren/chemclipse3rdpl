...
public class XYGraphToolbar extends Figure {
	...
	private void addUndoRedoButtons() {
		...
		// undo button
		final GrayableButton undoButton = new GrayableButton(XYGraphMediaFactory.getInstance().getImage("images/Undo.png"), //$NON-NLS-1$
		...
		// redo button
		final GrayableButton redoButton = new GrayableButton(XYGraphMediaFactory.getInstance().getImage("images/Redo.png"),//$NON-NLS-1$
