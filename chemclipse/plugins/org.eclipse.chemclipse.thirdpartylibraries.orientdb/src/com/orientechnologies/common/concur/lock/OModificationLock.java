...
public class OModificationLock {
	...
	/**
	 * After this method finished it's execution, all threads that are going to perform data modifications in storage should wait till {@link #allowModifications()} method will be called. This method will wait till all ongoing modifications will be finished.
	 */
	 ...
	 *            If <code>true</code> {@link OModificationOperationProhibitedException} exception will be thrown on {@link #requestModificationLock()} call.
	 */
