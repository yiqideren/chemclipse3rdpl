...
public final class OThreadCountersHashTable implements OOrientStartupListener, OOrientShutdownListener {
	...
	private static HashEntry searchInTables(Thread thread, int[] hashCodes, AtomicReference<EntryHolder>[] tables) {
		...
		while(true) {
			...
			if(!checkCounter(firstEntryHolderRnd1.counter, secondEntryHolderRnd1.counter, firstEntryHolderRnd2.counter, secondEntryHolderRnd2.counter)) {
				return null;
			}
		}
	}
	...
	static final class HashEntry {
		...
		private volatile long p0 = 0, p1 = 1, p2 = 2, p3 = 3, p4 = 4, p5 = 5,
				p6 = 6, p7 = 7;
		private volatile long threadCounter = 0;
		private volatile long p8 = 0, p9 = 1, p10 = 2, p11 = 3, p12 = 4,
				p13 = 5, p14 = 6;
		...
		public String toString() {
			...
			modCounters();
			return "HashEntry{" + "thread=" + thread + ", hashCodes=" + Arrays.toString(hashCodes) + ", p0=" + p0 + ", p1=" + p1 + ", p2=" + p2 + ", p3=" + p3 + ", p4=" + p4 + ", p5=" + p5 + ", p6=" + p6 + ", p7=" + p7 + ", threadCounter=" + threadCounter + ", p8=" + p8 + ", p9=" + p9 + ", p10=" + p10 + ", p11=" + p11 + ", p12=" + p12 + ", p13=" + p13 + ", p14=" + p14 + '}';
		}
