...
public class OBooleanSerializer implements OBinarySerializer<Boolean> {
	...
	@Override
	public void serializeInDirectMemoryObject(final Boolean object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {

		pointer.setByte(offset, object.booleanValue() ? (byte)1 : 0);
	}

	public void serializeInDirectMemory(final boolean object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
