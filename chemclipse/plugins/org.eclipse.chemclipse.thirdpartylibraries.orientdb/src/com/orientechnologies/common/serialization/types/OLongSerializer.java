...
public class OLongSerializer implements OBinarySerializer<Long> {
	...
	public long deserializeLiteral(final byte[] stream, final int startPosition) {
		...
		return ((0xff & stream[startPosition + 7]) | (0xff & stream[startPosition + 6]) << 8 | (0xff & stream[startPosition + 5]) << 16 | (long)(0xff & stream[startPosition + 4]) << 24 | (long)(0xff & stream[startPosition + 3]) << 32 | (long)(0xff & stream[startPosition + 2]) << 40 | (long)(0xff & stream[startPosition + 1]) << 48 | (long)(0xff & stream[startPosition]) << 56);
	}
	...
	@Override
	public void serializeInDirectMemoryObject(final Long object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
	...
	public void serializeInDirectMemory(final long object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
