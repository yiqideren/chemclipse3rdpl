...
public class ODecimalSerializer implements OBinarySerializer<BigDecimal> {
	...
	public int getObjectSize(byte[] stream, int startPosition) {
		...
		final int size = OIntegerSerializer.INT_SIZE + OBinaryTypeSerializer.INSTANCE.getObjectSize(stream, startPosition + OIntegerSerializer.INT_SIZE);
		return size;
	}
	...
	public int getObjectSizeNative(final byte[] stream, final int startPosition) {
		...
		final int size = OIntegerSerializer.INT_SIZE + OBinaryTypeSerializer.INSTANCE.getObjectSizeNative(stream, startPosition + OIntegerSerializer.INT_SIZE);
		return size;
	}
	...
	public int getObjectSizeInDirectMemory(ODirectMemoryPointer pointer, long offset) {
		...
		final int size = OIntegerSerializer.INT_SIZE + OBinaryTypeSerializer.INSTANCE.getObjectSizeInDirectMemory(pointer, offset + OIntegerSerializer.INT_SIZE);
		return size;
	}
	...
	public int getObjectSizeInDirectMemory(OWALChangesTree.PointerWrapper wrapper, long offset) {
		...
		final int size = OIntegerSerializer.INT_SIZE + OBinaryTypeSerializer.INSTANCE.getObjectSizeInDirectMemory(wrapper, offset + OIntegerSerializer.INT_SIZE);
		return size;
	}
