...
public class OUUIDSerializer implements OBinarySerializer<UUID> {
	...
	public void serializeNativeObject(final UUID object, final byte[] stream, final int startPosition, final Object... hints) {
		...
		OLongSerializer.INSTANCE.serializeNative(object.getLeastSignificantBits(), stream, startPosition + OLongSerializer.LONG_SIZE, hints);
	}
	...
	public void serializeInDirectMemoryObject(UUID object, ODirectMemoryPointer pointer, long offset, Object... hints) {
		...
		OLongSerializer.INSTANCE.serializeInDirectMemory(object.getLeastSignificantBits(), pointer, offset + OLongSerializer.LONG_SIZE, hints);
	}
	...
	public UUID deserializeFromDirectMemoryObject(final ODirectMemoryPointer pointer, final long offset) {
		...
		final long leastSignificantBits = OLongSerializer.INSTANCE.deserializeFromDirectMemory(pointer, offset + OLongSerializer.LONG_SIZE);
		return new UUID(mostSignificantBits, leastSignificantBits);
	}
	...
	public UUID deserializeFromDirectMemoryObject(OWALChangesTree.PointerWrapper wrapper, long offset) {
		...
		final long leastSignificantBits = OLongSerializer.INSTANCE.deserializeFromDirectMemory(wrapper, offset + OLongSerializer.LONG_SIZE);
		return new UUID(mostSignificantBits, leastSignificantBits);
	}
