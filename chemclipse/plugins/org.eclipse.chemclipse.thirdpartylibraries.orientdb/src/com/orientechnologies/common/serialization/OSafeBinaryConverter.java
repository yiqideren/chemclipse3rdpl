...
public class OSafeBinaryConverter implements OBinaryConverter {
	...
	private static long bytes2LongLittleEndian(final byte[] b, final int offset) {
		...
		return ((0xff & b[offset]) | (0xff & b[offset + 1]) << 8 | (0xff & b[offset + 2]) << 16 | (long)(0xff & b[offset + 3]) << 24 | (long)(0xff & b[offset + 4]) << 32 | (long)(0xff & b[offset + 5]) << 40 | (long)(0xff & b[offset + 6]) << 48 | (long)(0xff & b[offset + 7]) << 56);
	}
}
