...
public class OIntegerSerializer implements OBinarySerializer<Integer> {
	...
	@Override
	public void serializeInDirectMemoryObject(final Integer object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
	...
	public void serializeInDirectMemory(final int object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
