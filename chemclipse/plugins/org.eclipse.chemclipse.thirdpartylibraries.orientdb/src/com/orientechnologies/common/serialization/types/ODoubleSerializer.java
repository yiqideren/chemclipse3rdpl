...
public class ODoubleSerializer implements OBinarySerializer<Double> {
	...
	@Override
	public void serializeInDirectMemoryObject(final Double object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {

		pointer.setLong(offset, Double.doubleToLongBits(object));
	}

	public void serializeInDirectMemory(final double object, final ODirectMemoryPointer pointer, final long offset, final Object... hints) {
