...
public class OStorageConfigurationSegment extends OStorageConfiguration {
	...
	public OStorageConfigurationSegment(final OLocalPaginatedStorage iStorage) throws IOException {
		...
		super(iStorage);
		segment = new OSingleFileSegment((OLocalPaginatedStorage)storage, new OStorageFileConfiguration(null, getDirectory() + "/database.ocf", "classic", fileTemplate.maxSize, fileTemplate.fileIncrementSize));
	}
