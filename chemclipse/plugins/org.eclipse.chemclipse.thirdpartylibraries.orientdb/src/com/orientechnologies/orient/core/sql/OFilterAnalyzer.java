...
public class OFilterAnalyzer {
	...
	public List<List<OIndexSearchResult>> analyzeMainCondition(OSQLFilterCondition condition, final OClass schemaClass, OCommandContext context) {

		return analyzeOrFilterBranch(schemaClass, condition, context);
	}

	private List<List<OIndexSearchResult>> analyzeOrFilterBranch(final OClass iSchemaClass, OSQLFilterCondition condition, OCommandContext iContext) {
	...
	private OIndexSearchResult analyzeFilterBranch(final OClass iSchemaClass, OSQLFilterCondition condition, final List<OIndexSearchResult> iIndexSearchResults, OCommandContext iContext) {
	...
	private OIndexSearchResult analyzeIndexMethod(OClass iSchemaClass, OSQLFilterCondition condition, List<OIndexSearchResult> iIndexSearchResults) {
	...
	private boolean checkIndexExistence(final OClass iSchemaClass, final OIndexSearchResult result) {
		...
		return iSchemaClass.areIndexed(result.fields()) && (!result.lastField.isLong() || checkIndexChainExistence(iSchemaClass, result));
	}
