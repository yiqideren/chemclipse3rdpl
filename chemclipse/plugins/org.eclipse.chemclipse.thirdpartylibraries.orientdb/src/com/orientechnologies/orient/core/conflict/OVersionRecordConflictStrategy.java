...
public class OVersionRecordConflictStrategy implements ORecordConflictStrategy {
	...
	@Override
	public byte[] onUpdate(OStorage storage, final byte iRecordType, final ORecordId rid, final ORecordVersion iRecordVersion, final byte[] iRecordContent, final ORecordVersion iDatabaseVersion) {
