...
/**
 * Abstract class to extend to build Custom SQL Functions. Extend it and register it with: <code>OSQLParser.getInstance().registerStatelessFunction()</code> or <code>OSQLParser.getInstance().registerStatefullFunction()</code> to being used by the SQL engine.
 * 
