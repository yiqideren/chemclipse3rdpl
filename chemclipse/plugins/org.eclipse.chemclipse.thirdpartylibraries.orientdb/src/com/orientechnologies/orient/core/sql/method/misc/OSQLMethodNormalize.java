...
public class OSQLMethodNormalize extends OAbstractSQLMethod {
	...
	public Object execute(Object iThis, OIdentifiable iCurrentRecord, OCommandContext iContext, Object ioResult, Object[] iParams) {
		...
		if(ioResult != null) {
			final Normalizer.Form form = iParams != null && iParams.length > 0 ? Normalizer.Form.valueOf(OStringSerializerHelper.getStringContent(iParams[0].toString())) : Normalizer.Form.NFD;
