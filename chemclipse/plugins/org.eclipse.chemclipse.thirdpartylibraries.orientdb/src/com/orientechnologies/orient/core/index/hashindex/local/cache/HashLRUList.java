...
class HashLRUList implements LRUList {
	...
	public OCacheEntry get(long fileId, long pageIndex) {
		...
		while(lruEntry != null && (lruEntry.hashCode != hashCode || lruEntry.cacheEntry.pageIndex != pageIndex || lruEntry.cacheEntry.fileId != fileId))
	...
	public OCacheEntry remove(long fileId, long pageIndex) {
		...
		while(lruEntry != null && (lruEntry.hashCode != hashCode || lruEntry.cacheEntry.fileId != fileId || lruEntry.cacheEntry.pageIndex != pageIndex)) {
			prevEntry = lruEntry;
			lruEntry = lruEntry.next;
		}
		if(lruEntry == null)
