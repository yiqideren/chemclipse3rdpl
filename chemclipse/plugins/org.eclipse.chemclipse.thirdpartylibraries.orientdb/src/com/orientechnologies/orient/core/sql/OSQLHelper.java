...
public class OSQLHelper {
	...
	public static Object parseValue(final OSQLPredicate iSQLFilter, final OBaseParser iCommand, final String iWord, final OCommandContext iContext) {
	...
	public static Object resolveFieldValue(final ODocument iDocument, final String iFieldName, final Object iFieldValue, final OCommandParameters iArguments, final OCommandContext iContext) {
	...
	public static ODocument bindParameters(final ODocument iDocument, final Map<String, Object> iFields, final OCommandParameters iArguments, final OCommandContext iContext) {
