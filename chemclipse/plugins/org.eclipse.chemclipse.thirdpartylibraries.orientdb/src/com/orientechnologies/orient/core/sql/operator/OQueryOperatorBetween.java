...
public class OQueryOperatorBetween extends OQueryOperatorEqualityNotNulls {
	...
	protected boolean evaluateExpression(final OIdentifiable iRecord, final OSQLFilterCondition condition, final Object left, final Object right, OCommandContext iContext) {
