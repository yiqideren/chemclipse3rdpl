...
public class OPhysicalPosition implements OSerializableStream, Externalizable {
	...
	public static int binarySize() {
		...
		binarySize = OBinaryProtocol.SIZE_LONG + OBinaryProtocol.SIZE_BYTE + OVersionFactory.instance().getVersionSize() + OBinaryProtocol.SIZE_INT;
		return binarySize;
	}
	...
	public boolean equals(Object obj) {
		...
		return clusterPosition == other.clusterPosition && recordType == other.recordType && recordVersion.equals(other.recordVersion) && recordSize == other.recordSize;
	}
