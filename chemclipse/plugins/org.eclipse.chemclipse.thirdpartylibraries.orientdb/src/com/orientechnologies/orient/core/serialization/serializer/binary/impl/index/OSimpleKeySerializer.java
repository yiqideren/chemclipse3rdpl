...
public class OSimpleKeySerializer<T extends Comparable<?>> implements OBinarySerializer<T> {
	...
	public int getObjectSizeInDirectMemory(ODirectMemoryPointer pointer, long offset) {
		...
		init(serializerId);
		return OBinarySerializerFactory.TYPE_IDENTIFIER_SIZE + binarySerializer.getObjectSizeInDirectMemory(pointer, OBinarySerializerFactory.TYPE_IDENTIFIER_SIZE + offset);
	}
	...
	public int getObjectSizeInDirectMemory(OWALChangesTree.PointerWrapper wrapper, long offset) {
		...
		init(serializerId);
		return OBinarySerializerFactory.TYPE_IDENTIFIER_SIZE + binarySerializer.getObjectSizeInDirectMemory(wrapper, OBinarySerializerFactory.TYPE_IDENTIFIER_SIZE + offset);
	}
