...
public class ODatabaseExport extends ODatabaseImpExpAbstract {
	...
	public ODatabaseExport(final ODatabaseDocumentInternal iDatabase, final String iFileName, final OCommandOutputListener iListener) throws IOException {
	...
	public ODatabaseExport(final ODatabaseDocumentInternal iDatabase, final OutputStream iOutputStream, final OCommandOutputListener iListener) throws IOException {
