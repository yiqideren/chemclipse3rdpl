...
public class OMVRBTreeStorage<K, V> extends OMVRBTreePersistent<K, V> {
	...
	public OMVRBTreeStorage(final OAbstractPaginatedStorage iStorage, String iClusterName, final OBinarySerializer<K> iKeySerializer, final OStreamSerializer iValueSerializer) {
