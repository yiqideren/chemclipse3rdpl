...
public class OStoragePaginatedClusterConfiguration implements OStorageClusterConfiguration {
	...
	public OStoragePaginatedClusterConfiguration(final OStorageConfiguration root, final int id, final String name, final String location, final boolean useWal, final float recordOverflowGrowFactor, final float recordGrowFactor, final String compression, final String conflictStrategy, final STATUS iStatus) {
