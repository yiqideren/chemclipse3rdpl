...
public class OStorageFileConfiguration implements Serializable {
	...
	public OStorageFileConfiguration(final OStorageSegmentConfiguration iParent, final String iPath, final String iType, final String iMaxSize, String iIncrementSize) {
