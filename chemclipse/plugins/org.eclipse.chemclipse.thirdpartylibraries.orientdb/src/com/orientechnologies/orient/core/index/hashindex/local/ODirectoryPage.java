...
public class ODirectoryPage extends ODurablePage {
	...
	public static final int NODES_PER_PAGE = (OGlobalConfiguration.DISK_CACHE_PAGE_SIZE.getValueAsInteger() * 1024 - ITEMS_OFFSET) / OHashTableDirectory.BINARY_LEVEL_SIZE;
	...
	public void setPointer(int localNodeIndex, int index, long pointer) throws IOException {
		...
		int offset = getItemsOffset() + (localNodeIndex * OHashTableDirectory.BINARY_LEVEL_SIZE + 3 * OByteSerializer.BYTE_SIZE) + index * OHashTableDirectory.ITEM_SIZE;
