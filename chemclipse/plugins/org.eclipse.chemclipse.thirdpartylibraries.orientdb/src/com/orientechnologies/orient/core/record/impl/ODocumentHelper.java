...
public class ODocumentHelper {
		...
		if(function.startsWith("SIZE("))
			...
			if(function.startsWith("CHARAT("))
				...
				if(args.size() == 1)
					...
					result = currentValue.toString().indexOf(OStringSerializerHelper.getStringContent(args.get(0)), Integer.parseInt(args.get(1)));
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static boolean hasSameContentOf(final ODocument iCurrent, final ODatabaseDocumentInternal iMyDb, final ODocument iOther, final ODatabaseDocumentInternal iOtherDb, RIDMapper ridMapper) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static boolean hasSameContentOf(final ODocument iCurrent, final ODatabaseDocumentInternal iMyDb, final ODocument iOther, final ODatabaseDocumentInternal iOtherDb, RIDMapper ridMapper, final boolean iCheckAlsoIdentity) {
