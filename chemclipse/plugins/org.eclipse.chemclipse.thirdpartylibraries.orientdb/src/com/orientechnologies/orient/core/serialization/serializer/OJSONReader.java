...
public class OJSONReader {
	...
	public String readString(final char[] iUntil, final boolean iInclude, final char[] iJumpChars, final char[] iSkipChars) throws IOException, ParseException {
	...
	public OJSONReader readNext(final char[] iUntil, final boolean iInclude, final char[] iJumpChars, final char[] iSkipChars) throws IOException, ParseException {
