...
public class ORecordIteratorCluster<REC extends ORecord> extends OIdentifiableIterator<REC> {
	...
	public ORecordIteratorCluster(final ODatabaseDocumentInternal iDatabase, final ODatabaseDocumentTx iLowLevelDatabase, final int iClusterId, final boolean iUseCache) {

		this(iDatabase, iLowLevelDatabase, iClusterId, ORID.CLUSTER_POS_INVALID, ORID.CLUSTER_POS_INVALID, iUseCache, false, OStorage.LOCKING_STRATEGY.DEFAULT);
	}

	public ORecordIteratorCluster(final ODatabaseDocumentInternal iDatabase, final ODatabaseDocumentTx iLowLevelDatabase, final int iClusterId, final long firstClusterEntry, final long lastClusterEntry, final boolean iUseCache) {

		this(iDatabase, iLowLevelDatabase, iClusterId, firstClusterEntry, lastClusterEntry, iUseCache, false, OStorage.LOCKING_STRATEGY.NONE);
	}

	@Deprecated
	public ORecordIteratorCluster(final ODatabaseDocumentInternal iDatabase, final ODatabaseDocumentTx iLowLevelDatabase, final int iClusterId, final long firstClusterEntry, final long lastClusterEntry, final boolean iUseCache, final boolean iterateThroughTombstones, final OStorage.LOCKING_STRATEGY iLockingStrategy) {
