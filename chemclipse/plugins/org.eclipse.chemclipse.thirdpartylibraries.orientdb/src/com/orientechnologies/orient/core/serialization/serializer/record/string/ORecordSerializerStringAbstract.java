...
public abstract class ORecordSerializerStringAbstract implements ORecordSerializer, Serializable {
	...
	public static void fieldTypeToString(final StringBuilder iBuffer, OType iType, final Object iValue) {
		...
		switch(iType) {
			...
			case LINK:
				...
				break;
			case EMBEDDEDSET:
				ORecordSerializerSchemaAware2CSV.INSTANCE.embeddedCollectionToStream(ODatabaseRecordThreadLocal.INSTANCE.getIfDefined(), null, iBuffer, null, null, iValue, null, true, true);
				...
				break;
			case EMBEDDEDLIST:
				ORecordSerializerSchemaAware2CSV.INSTANCE.embeddedCollectionToStream(ODatabaseRecordThreadLocal.INSTANCE.getIfDefined(), null, iBuffer, null, null, iValue, null, true, false);
	...
	public StringBuilder toString(final ORecord iRecord, final String iFormat) {
		...
		return toString(iRecord, new StringBuilder(1024), iFormat, ODatabaseRecordThreadLocal.INSTANCE.get(), OSerializationSetThreadLocal.INSTANCE.get(), false, true);
	}

	public StringBuilder toString(final ORecord iRecord, final String iFormat, final boolean autoDetectCollectionType) {

		return toString(iRecord, new StringBuilder(1024), iFormat, ODatabaseRecordThreadLocal.INSTANCE.get(), OSerializationSetThreadLocal.INSTANCE.get(), false, autoDetectCollectionType);
	}
	...
	protected abstract StringBuilder toString(final ORecord iRecord, final StringBuilder iOutput, final String iFormat, final OUserObject2RecordHandler iObjHandler, final Map<ODocument, Boolean> iMarshalledRecords, boolean iOnlyDelta, boolean autoDetectCollectionType);
}
