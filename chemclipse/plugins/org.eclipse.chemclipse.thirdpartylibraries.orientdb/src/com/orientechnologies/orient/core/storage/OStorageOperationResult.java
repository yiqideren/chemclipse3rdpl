 ...
 * Flag {@code isMoved == true} indicates that operation has been executed on local OrientDB server node, {@code isMoved == false} indicates that operation has been executed on remote OrientDB node. This information will help to maintain local indexes and
