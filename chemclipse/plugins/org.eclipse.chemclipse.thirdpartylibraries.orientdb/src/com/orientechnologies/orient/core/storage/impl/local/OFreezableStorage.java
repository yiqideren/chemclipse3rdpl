...
public interface OFreezableStorage {
	 ...
	 *            If <code>true</code> {@link com.orientechnologies.common.concur.lock.OModificationOperationProhibitedException} exception will be thrown on call of methods that requires storage modification. Otherwise other threads will wait for {@link #release()} method call.
	 */
