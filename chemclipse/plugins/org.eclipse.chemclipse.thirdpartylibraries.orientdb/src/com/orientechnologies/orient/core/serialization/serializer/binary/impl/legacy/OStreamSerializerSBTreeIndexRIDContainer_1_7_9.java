...
public class OStreamSerializerSBTreeIndexRIDContainer_1_7_9 implements OStreamSerializer, OBinarySerializer<OIndexRIDContainer> {
	...
	public static final int SBTREE_ROOTINDEX_OFFSET = EMBEDDED_OFFSET + OBooleanSerializer.BOOLEAN_SIZE;
	public static final int SBTREE_ROOTOFFSET_OFFSET = SBTREE_ROOTINDEX_OFFSET + OLongSerializer.LONG_SIZE;
	public static final int EMBEDDED_SIZE_OFFSET = EMBEDDED_OFFSET + OBooleanSerializer.BOOLEAN_SIZE;
	...
	public static final int SBTREE_CONTAINER_SIZE = OBooleanSerializer.BOOLEAN_SIZE + 2 * OLongSerializer.LONG_SIZE + OIntegerSerializer.INT_SIZE;
