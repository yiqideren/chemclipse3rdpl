...
public class ORemoteFetchContext implements OFetchContext {
	...
	public void onBeforeDocument(ODocument iRecord, final ODocument iDocument, String iFieldName, final Object iUserObject) throws OFetchException {
	...
	public void onAfterDocument(ODocument iRootRecord, final ODocument iDocument, String iFieldName, final Object iUserObject) throws OFetchException {
