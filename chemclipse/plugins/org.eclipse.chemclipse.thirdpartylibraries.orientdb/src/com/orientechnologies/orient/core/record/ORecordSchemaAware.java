...
public interface ORecordSchemaAware {
	 ...
	 * record id to record) or need expressly a conversion between types.
	 * 
	 * @param iFieldName
	 *            Field name
	 * @param iType
	...
	/**
	 * Validates the record against the schema constraints if defined. If the record breaks the validation rules, then a {@link OValidationException} exception is thrown.
	 * 
