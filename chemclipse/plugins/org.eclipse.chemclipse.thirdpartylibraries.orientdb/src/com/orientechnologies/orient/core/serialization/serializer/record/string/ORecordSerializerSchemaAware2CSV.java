...
public class ORecordSerializerSchemaAware2CSV extends ORecordSerializerCSVAbstract {
	...
	@Override
	protected StringBuilder toString(ORecord iRecord, final StringBuilder iOutput, final String iFormat, OUserObject2RecordHandler iObjHandler, final Map<ODocument, Boolean> iMarshalledRecords, final boolean iOnlyDelta, final boolean autoDetectCollectionType) {
