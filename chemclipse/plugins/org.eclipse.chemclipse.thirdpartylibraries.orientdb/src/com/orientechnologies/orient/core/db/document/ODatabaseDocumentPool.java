...
/**
 * @deprecated use {@link com.orientechnologies.orient.core.db.OPartitionedDatabasePool} or {@link com.orientechnologies.orient.core.db.OPartitionedDatabasePoolFactory} instead.
 */
@Deprecated
public class ODatabaseDocumentPool extends ODatabasePoolBase<ODatabaseDocumentTx> {
	...
	protected ODatabaseDocumentTx createResource(Object owner, String iDatabaseName, Object... iAdditionalArgs) {
		...
		return new ODatabaseDocumentTxPooled((ODatabaseDocumentPool)owner, iDatabaseName, (String)iAdditionalArgs[0], (String)iAdditionalArgs[1]);
	}
}
