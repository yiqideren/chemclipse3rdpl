...
public class ORecordIteratorClusters<REC extends ORecord> extends OIdentifiableIterator<REC> {
	...
	public ORecordIteratorClusters(final ODatabaseDocumentInternal iDatabase, final ODatabaseDocumentInternal iLowLevelDatabase, final int[] iClusterIds, final boolean iUseCache) {
	...
	@Deprecated
	protected ORecordIteratorClusters(final ODatabaseDocumentInternal iDatabase, final ODatabaseDocumentInternal iLowLevelDatabase, final boolean iUseCache, final boolean iterateThroughTombstones, final OStorage.LOCKING_STRATEGY iLockingStrategy) {
	...
	public String toString() {
		...
		return String.format("ORecordIteratorCluster.clusters(%s).currentRecord(%s).range(%s-%s)", Arrays.toString(clusterIds), currentRecord, beginRange, endRange);
	}
