...
public class ORecordLazyList extends ORecordTrackedList implements ORecordLazyMultiValue {
	...
	public boolean add(OIdentifiable e) {
		...
		if(e != null)
			if((ridOnly || contentType == MULTIVALUE_CONTENT_TYPE.ALL_RIDS || OGlobalConfiguration.LAZYSET_WORK_ON_STREAM.getValueAsBoolean()) && e.getIdentity().isPersistent() && (e instanceof ODocument && !((ODocument)e).isDirty()))
