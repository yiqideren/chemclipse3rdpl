...
class HashLRUList implements LRUList {
	...
	public OCacheEntry get(long fileId, long pageIndex) {
		...
		while(lruEntry != null && (lruEntry.hashCode != hashCode || lruEntry.cacheEntry.getPageIndex() != pageIndex || lruEntry.cacheEntry.getFileId() != fileId))
	...
	public OCacheEntry remove(long fileId, long pageIndex) {
		...
		while(lruEntry != null && (lruEntry.hashCode != hashCode || lruEntry.cacheEntry.getFileId() != fileId || lruEntry.cacheEntry.getPageIndex() != pageIndex)) {
			prevEntry = lruEntry;
			lruEntry = lruEntry.next;
		}
		if(lruEntry == null)
	...
	public OCacheEntry removeLRU() {
		...
		while(entryToRemove != null && (entryToRemove.cacheEntry.getCachePointer() != null && entryToRemove.cacheEntry.getUsagesCount() != 0)) {
