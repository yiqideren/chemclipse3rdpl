...
public abstract class OQueryTargetOperator extends OQueryOperator {
	...
	public abstract Collection<OIdentifiable> filterRecords(final ODatabase<?> iRecord, final List<String> iTargetClasses, final OSQLFilterCondition iCondition, final Object iLeft, final Object iRight);
