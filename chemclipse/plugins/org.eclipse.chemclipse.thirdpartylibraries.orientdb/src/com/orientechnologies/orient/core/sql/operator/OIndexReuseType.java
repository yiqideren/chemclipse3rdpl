...
public enum OIndexReuseType {
	...
	NO_INDEX,
	/**
	 * Result of execution of this operator can be replaced by call to one of {@link com.orientechnologies.orient.core.index.OIndex} methods.
	 */
	INDEX_METHOD,
	/**
	 * Result of execution of this operator can be replaced by call to one of {@link com.orientechnologies.orient.core.index.OIndex} methods depending on user implementation.
	 */
	INDEX_OPERATOR
}
