...
public class OSecurityManager {
	...
	public static String digest2String(final String iInput, String iAlgorithm) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	public synchronized byte[] digest(final String iInput) {
		...
		try {
			...
			OLogManager.instance().error(this, "The requested encoding is not supported: cannot execute security checks", e, OConfigurationException.class);
		}
		return null;
	}
