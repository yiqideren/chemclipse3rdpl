 ...
 * <li>v2.3.2 - Reduced memory footprint! Finally refined the "guessing" of how big the final encoded data will be so that the code does not have to create two output arrays: an oversized initial one and then a final, exact-sized one. Big win when using the {@link #encodeBytesToBytes(byte[])} family of methods (and not using the gzip options which uses a different mechanism with streams and stuff).</li>
 ...
 * <li>v1.5 - Output stream pases on flush() command but does not do anything itself. This helps when using GZIP streams. Added the ability to GZip-compress objects before encoding them.</li>
