...
public class OComposableProcessor extends OConfigurableStatefulFactory<String, OProcessorBlock> implements OProcessor {
	...
	public Object process(final OProcessorBlock iParent, final String iType, final ODocument iContent, final OCommandContext iContext, final ODocument iOutput, final boolean iReadOnly) {
