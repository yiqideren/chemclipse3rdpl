...
public abstract class OChannel extends OListenerManger<OChannelListener> {
	...
	static {
		...
		PROFILER.registerHookValue(profilerMetric + ".transmittedBytes", "Bytes transmitted to all the network channels", METRIC_TYPE.SIZE, new OProfilerHookValue() {
		...
		PROFILER.registerHookValue(profilerMetric + ".receivedBytes", "Bytes received from all the network channels", METRIC_TYPE.SIZE, new OProfilerHookValue() {
		...
		PROFILER.registerHookValue(profilerMetric + ".flushes", "Number of times the network channels have been flushed", METRIC_TYPE.COUNTER, new OProfilerHookValue() {
