...
public class OServerAdmin {
	...
	public synchronized OServerAdmin connect(final String iUserName, final String iUserPassword) throws IOException {
		...
		try {
			...
			OLogManager.instance().error(this, "Cannot connect to the remote server/database '%s'", e, OStorageException.class, storage.getURL());
	 ...
	 * @throws IOException
	 */
	public synchronized OServerAdmin createDatabase(final String iDatabaseName, final String iDatabaseType, String iStorageMode) throws IOException {
