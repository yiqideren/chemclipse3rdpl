...
public class OObjectLazyIterator<TYPE> implements Iterator<TYPE>, Serializable {
	...
	public OObjectLazyIterator(final ODatabasePojoAbstract<TYPE> database, final ProxyObject iSourceRecord, final Iterator<? extends Object> iIterator, final boolean iConvertToRecord, boolean iOrphanRemoval) {
