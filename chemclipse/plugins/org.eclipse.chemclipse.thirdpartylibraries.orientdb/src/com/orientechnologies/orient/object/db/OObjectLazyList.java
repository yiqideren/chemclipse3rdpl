...
public class OObjectLazyList<TYPE> extends ArrayList<TYPE> implements OLazyObjectListInterface<TYPE>, OObjectLazyMultivalueElement<List<TYPE>>, Serializable {
	...
	public OObjectLazyList(final Object iSourceRecord, final List<OIdentifiable> iRecordList, final Collection<? extends TYPE> iSourceList, final boolean orphanRemoval) {
