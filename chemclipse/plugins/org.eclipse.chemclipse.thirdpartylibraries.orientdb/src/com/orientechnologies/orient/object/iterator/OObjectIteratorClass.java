...
public class OObjectIteratorClass<T> implements OObjectIteratorClassInterface<T> {
	...
	public OObjectIteratorClass(final OObjectDatabaseTx iDatabase, final ODatabaseDocumentTx iUnderlyingDatabase, final String iClusterName, final boolean iPolymorphic) {

		database = iDatabase;
		underlying = new ORecordIteratorClass<ODocument>(iDatabase.getUnderlying(), iUnderlyingDatabase, iClusterName, iPolymorphic, true, false);
	}
