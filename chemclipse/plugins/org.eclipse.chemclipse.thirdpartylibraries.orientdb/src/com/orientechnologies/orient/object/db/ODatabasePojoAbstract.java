...
public abstract class ODatabasePojoAbstract<T extends Object> extends ODatabaseWrapperAbstract<ODatabaseDocumentTx, T> implements ODatabaseSchemaAware<T>, ODatabaseInternal<T> {
