...
public class OObjectEnumLazyMap<TYPE extends Enum> extends HashMap<Object, Object> implements Serializable, OObjectLazyEnumSerializer<Map<Object, Object>> {
	...
	public OObjectEnumLazyMap(final Class<Enum> iEnumClass, final ORecord iSourceRecord, final Map<Object, Object> iRecordMap, final Map<Object, Object> iSourceMap) {
